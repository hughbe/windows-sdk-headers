...
{
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_System_RemoteDesktop_Provider_ICloudPCDisplayInfo<D>::Name() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::RemoteDesktop::Provider::ICloudPCDisplayInfo)->get_Name(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Provider_ICloudPCDisplayInfo<D>::Name(param::hstring const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::RemoteDesktop::Provider::ICloudPCDisplayInfo)->put_Name(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::System::RemoteDesktop::Provider::CloudPCDisplayInfo) consume_Windows_System_RemoteDesktop_Provider_ICloudPCDisplayInfoFactory<D>::CreateInstance(param::hstring const& name) const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::System::RemoteDesktop::Provider::CloudPCDisplayInfo) consume_Windows_System_RemoteDesktop_Provider_ICloudPCHostService<D>::DisplayInfo() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::RemoteDesktop::Provider::ICloudPCHostService)->get_DisplayInfo(&value));
        return winrt::Windows::System::RemoteDesktop::Provider::CloudPCDisplayInfo{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Provider_ICloudPCHostService<D>::DisplayInfo(winrt::Windows::System::RemoteDesktop::Provider::CloudPCDisplayInfo const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::RemoteDesktop::Provider::ICloudPCHostService)->put_DisplayInfo(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Provider_ICloudPCHostService<D>::SwitchToCloudPC() const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::RemoteDesktop::Provider::ICloudPCHostService)->SwitchToCloudPC());
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_System_RemoteDesktop_Provider_ICloudPCHostService<D>::SwitchToLocalPC(winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Provider_ICloudPCHostService<D>::SwitchToLocalPC(winrt::event_token const& token) const noexcept
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::System::RemoteDesktop::Provider::CloudPCHostService) consume_Windows_System_RemoteDesktop_Provider_ICloudPCHostServiceStatics<D>::GetForWindow(winrt::Windows::UI::WindowId const& windowId) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::System::RemoteDesktop::Provider::CloudPCDisplayInfo) consume_Windows_System_RemoteDesktop_Provider_IRemoteDesktopConnectionInfo2<D>::DisplayInfo() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Provider_IRemoteDesktopConnectionInfo2<D>::DisplayInfo(winrt::Windows::System::RemoteDesktop::Provider::CloudPCDisplayInfo const& value) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_System_RemoteDesktop_Provider_IRemoteDesktopConnectionInfo2<D>::SwitchToCloudPC(winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Provider_IRemoteDesktopConnectionInfo2<D>::SwitchToCloudPC(winrt::event_token const& token) const noexcept
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteDesktop_Provider_IRemoteDesktopConnectionInfo2<D>::SwitchToLocalPC() const
    {
