...
{
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteSystems_Availability_IRemoteSystemAvailabilityStatics<D>::EnableCloudPC(param::hstring const& displayName, param::hstring const& cloudPCId) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_System_RemoteSystems_Availability_IRemoteSystemAvailabilityStatics<D>::DisableCloudPC(param::hstring const& cloudPCId) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_System_RemoteSystems_Availability_IRemoteSystemAvailabilityStatics<D>::IsCloudPCEnabled(param::hstring const& cloudPCId) const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_System_RemoteSystems_Availability_IRemoteSystemAvailabilityStatics<D>::IsIntegratedCloudPCSwitchEnabled() const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_System_RemoteSystems_Availability_IRemoteSystemAvailabilityStatics<D>::GetAllEnabledCloudPCIds() const
    {
        void* result{};
