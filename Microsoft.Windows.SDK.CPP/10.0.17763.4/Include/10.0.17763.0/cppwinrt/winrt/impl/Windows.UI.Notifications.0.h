...
template <> struct consume<Windows::UI::Notifications::IScheduledToastNotification4> { template <typename D> using type = consume_Windows_UI_Notifications_IScheduledToastNotification4<D>; };
