...
template <> struct name<Windows::UI::ApplicationSettings::IAccountsSettingsPaneCommandsRequestedEventArgs2>{ static constexpr auto & value{ L"Windows.UI.ApplicationSettings.IAccountsSettingsPaneCommandsRequestedEventArgs2" }; };
...
template <> struct name<Windows::UI::ApplicationSettings::IAccountsSettingsPaneStatics3>{ static constexpr auto & value{ L"Windows.UI.ApplicationSettings.IAccountsSettingsPaneStatics3" }; };
...
template <> struct consume<Windows::UI::ApplicationSettings::IAccountsSettingsPaneCommandsRequestedEventArgs2> { template <typename D> using type = consume_Windows_UI_ApplicationSettings_IAccountsSettingsPaneCommandsRequestedEventArgs2<D>; };
...
template <> struct consume<Windows::UI::ApplicationSettings::IAccountsSettingsPaneStatics3> { template <typename D> using type = consume_Windows_UI_ApplicationSettings_IAccountsSettingsPaneStatics3<D>; };
