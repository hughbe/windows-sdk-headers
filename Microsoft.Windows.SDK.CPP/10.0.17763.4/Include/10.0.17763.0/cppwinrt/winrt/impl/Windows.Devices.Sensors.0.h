...
template <> struct name<Windows::Devices::Sensors::IHingeAngleReading>{ static constexpr auto & value{ L"Windows.Devices.Sensors.IHingeAngleReading" }; };
template <> struct name<Windows::Devices::Sensors::IHingeAngleSensor>{ static constexpr auto & value{ L"Windows.Devices.Sensors.IHingeAngleSensor" }; };
template <> struct name<Windows::Devices::Sensors::IHingeAngleSensorReadingChangedEventArgs>{ static constexpr auto & value{ L"Windows.Devices.Sensors.IHingeAngleSensorReadingChangedEventArgs" }; };
template <> struct name<Windows::Devices::Sensors::IHingeAngleSensorStatics>{ static constexpr auto & value{ L"Windows.Devices.Sensors.IHingeAngleSensorStatics" }; };
...
template <> struct name<Windows::Devices::Sensors::ISimpleOrientationSensorStatics2>{ static constexpr auto & value{ L"Windows.Devices.Sensors.ISimpleOrientationSensorStatics2" }; };
...
template <> struct name<Windows::Devices::Sensors::HingeAngleReading>{ static constexpr auto & value{ L"Windows.Devices.Sensors.HingeAngleReading" }; };
template <> struct name<Windows::Devices::Sensors::HingeAngleSensor>{ static constexpr auto & value{ L"Windows.Devices.Sensors.HingeAngleSensor" }; };
template <> struct name<Windows::Devices::Sensors::HingeAngleSensorReadingChangedEventArgs>{ static constexpr auto & value{ L"Windows.Devices.Sensors.HingeAngleSensorReadingChangedEventArgs" }; };
...
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometer>{ static constexpr guid value{ 0xDF184548,0x2711,0x4DA7,{ 0x80,0x98,0x4B,0x82,0x20,0x5D,0x3C,0x7D } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometer2>{ static constexpr guid value{ 0xE8F092EE,0x4964,0x401A,{ 0xB6,0x02,0x22,0x0D,0x71,0x53,0xC6,0x0A } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometer3>{ static constexpr guid value{ 0x87E0022A,0xED80,0x49EB,{ 0xBF,0x8A,0xA4,0xEA,0x31,0xE5,0xCD,0x84 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometer4>{ static constexpr guid value{ 0x1D373C4F,0x42D3,0x45B2,{ 0x81,0x44,0xAB,0x7F,0xB6,0x65,0xEB,0x59 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerDeviceId>{ static constexpr guid value{ 0x7EAC64A9,0x97D5,0x446D,{ 0xAB,0x5A,0x91,0x7D,0xF9,0xB9,0x6A,0x2C } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerReading>{ static constexpr guid value{ 0xB9FE7ACB,0xD351,0x40AF,{ 0x8B,0xB6,0x7A,0xA9,0xAE,0x64,0x1F,0xB7 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerReading2>{ static constexpr guid value{ 0x0A864AA2,0x15AE,0x4A40,{ 0xBE,0x55,0xDB,0x58,0xD7,0xDE,0x73,0x89 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerReadingChangedEventArgs>{ static constexpr guid value{ 0x0095C65B,0xB6AC,0x475A,{ 0x9F,0x44,0x8B,0x32,0xD3,0x5A,0x3F,0x25 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerShakenEventArgs>{ static constexpr guid value{ 0x95FF01D1,0x4A28,0x4F35,{ 0x98,0xE8,0x81,0x78,0xAA,0xE4,0x08,0x4A } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerStatics>{ static constexpr guid value{ 0xA5E28B74,0x5A87,0x4A2D,{ 0xBE,0xCC,0x0F,0x90,0x6E,0xA0,0x61,0xDD } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerStatics2>{ static constexpr guid value{ 0xC4C4842F,0xD86B,0x4685,{ 0xB2,0xD7,0x33,0x96,0xF7,0x98,0xD5,0x7B } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAccelerometerStatics3>{ static constexpr guid value{ 0x9DE218CF,0x455D,0x4CF3,{ 0x82,0x00,0x70,0xE1,0x41,0x03,0x40,0xF8 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IActivitySensor>{ static constexpr guid value{ 0xCD7A630C,0xFB5F,0x48EB,{ 0xB0,0x9B,0xA2,0x70,0x8D,0x1C,0x61,0xEF } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IActivitySensorReading>{ static constexpr guid value{ 0x85125A96,0x1472,0x40A2,{ 0xB2,0xAE,0xE1,0xEF,0x29,0x22,0x6C,0x78 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IActivitySensorReadingChangeReport>{ static constexpr guid value{ 0x4F3C2915,0xD93B,0x47BD,{ 0x96,0x0A,0xF2,0x0F,0xB2,0xF3,0x22,0xB9 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IActivitySensorReadingChangedEventArgs>{ static constexpr guid value{ 0xDE386717,0xAEB6,0x4EC7,{ 0x94,0x6A,0xD9,0xCC,0x19,0xB9,0x51,0xEC } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IActivitySensorStatics>{ static constexpr guid value{ 0xA71E0E9D,0xEE8B,0x45D1,{ 0xB2,0x5B,0x08,0xCC,0x0D,0xF9,0x2A,0xB6 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IActivitySensorTriggerDetails>{ static constexpr guid value{ 0x2C9E6612,0xB9CA,0x4677,{ 0xB2,0x63,0x24,0x32,0x97,0xF7,0x9D,0x3A } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAltimeter>{ static constexpr guid value{ 0x72F057FD,0x8F04,0x49F1,{ 0xB4,0xA7,0xF4,0xE3,0x63,0xB7,0x01,0xA2 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAltimeter2>{ static constexpr guid value{ 0xC9471BF9,0x2ADD,0x48F5,{ 0x9F,0x08,0x3D,0x0C,0x76,0x60,0xD9,0x38 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAltimeterReading>{ static constexpr guid value{ 0xFBE8EF73,0x7F5E,0x48C8,{ 0xAA,0x1A,0xF1,0xF3,0xBE,0xFC,0x11,0x44 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAltimeterReading2>{ static constexpr guid value{ 0x543A1BD9,0x6D0B,0x42B2,{ 0xBD,0x69,0xBC,0x8F,0xAE,0x0F,0x78,0x2C } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAltimeterReadingChangedEventArgs>{ static constexpr guid value{ 0x7069D077,0x446D,0x47F7,{ 0x99,0x8C,0xEB,0xC2,0x3B,0x45,0xE4,0xA2 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IAltimeterStatics>{ static constexpr guid value{ 0x9EB4D7C3,0xE5AC,0x47CE,{ 0x8E,0xEF,0xD3,0x71,0x81,0x68,0xC0,0x1F } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IBarometer>{ static constexpr guid value{ 0x934475A8,0x78BF,0x452F,{ 0xB0,0x17,0xF0,0x20,0x9C,0xE6,0xDA,0xB4 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IBarometer2>{ static constexpr guid value{ 0x32BCC418,0x3EEB,0x4D04,{ 0x95,0x74,0x76,0x33,0xA8,0x78,0x1F,0x9F } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IBarometerReading>{ static constexpr guid value{ 0xF5B9D2E6,0x1DF6,0x4A1A,{ 0xA7,0xAD,0x32,0x1D,0x4F,0x5D,0xB2,0x47 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IBarometerReading2>{ static constexpr guid value{ 0x85A244EB,0x90C5,0x4875,{ 0x89,0x1C,0x38,0x65,0xB4,0xC3,0x57,0xE7 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IBarometerReadingChangedEventArgs>{ static constexpr guid value{ 0x3D84945F,0x037B,0x404F,{ 0x9B,0xBB,0x62,0x32,0xD6,0x95,0x43,0xC3 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IBarometerStatics>{ static constexpr guid value{ 0x286B270A,0x02E3,0x4F86,{ 0x84,0xFC,0xFD,0xD8,0x92,0xB5,0x94,0x0F } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IBarometerStatics2>{ static constexpr guid value{ 0x8FC6B1E7,0x95FF,0x44AC,{ 0x87,0x8E,0xD6,0x5C,0x83,0x08,0xC3,0x4C } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompass>{ static constexpr guid value{ 0x292FFA94,0x1B45,0x403C,{ 0xBA,0x06,0xB1,0x06,0xDB,0xA6,0x9A,0x64 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompass2>{ static constexpr guid value{ 0x36F26D09,0xC7D7,0x434F,{ 0xB4,0x61,0x97,0x9D,0xDF,0xC2,0x32,0x2F } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompass3>{ static constexpr guid value{ 0xA424801B,0xC5EA,0x4D45,{ 0xA0,0xEC,0x4B,0x79,0x1F,0x04,0x1A,0x89 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompassDeviceId>{ static constexpr guid value{ 0xD181CA29,0xB085,0x4B1D,{ 0x87,0x0A,0x4F,0xF5,0x7B,0xA7,0x4F,0xD4 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompassReading>{ static constexpr guid value{ 0x82911128,0x513D,0x4DC9,{ 0xB7,0x81,0x5E,0xED,0xFB,0xF0,0x2D,0x0C } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompassReading2>{ static constexpr guid value{ 0xB13A661E,0x51BB,0x4A12,{ 0xBE,0xDD,0xAD,0x47,0xFF,0x87,0xD2,0xE8 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompassReadingChangedEventArgs>{ static constexpr guid value{ 0x8F1549B0,0xE8BC,0x4C7E,{ 0xB0,0x09,0x4E,0x41,0xDF,0x13,0x70,0x72 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompassReadingHeadingAccuracy>{ static constexpr guid value{ 0xE761354E,0x8911,0x40F7,{ 0x9E,0x16,0x6E,0xCC,0x7D,0xAE,0xC5,0xDE } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompassStatics>{ static constexpr guid value{ 0x9ABC97DF,0x56EC,0x4C25,{ 0xB5,0x4D,0x40,0xA6,0x8B,0xB5,0xB2,0x69 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ICompassStatics2>{ static constexpr guid value{ 0x0ACE0EAD,0x3BAA,0x4990,{ 0x9C,0xE4,0xBE,0x09,0x13,0x75,0x4E,0xD2 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometer>{ static constexpr guid value{ 0xFDB9A9C4,0x84B1,0x4CA2,{ 0x97,0x63,0x9B,0x58,0x95,0x06,0xC7,0x0C } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometer2>{ static constexpr guid value{ 0x63DF2443,0x8CE8,0x41C3,{ 0xAC,0x44,0x86,0x98,0x81,0x0B,0x55,0x7F } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometer3>{ static constexpr guid value{ 0x5D6F88D5,0x8FBC,0x4484,{ 0x91,0x4B,0x52,0x8A,0xDF,0xD9,0x47,0xB1 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometerDeviceId>{ static constexpr guid value{ 0x1EE5E978,0x89A2,0x4275,{ 0x9E,0x95,0x71,0x26,0xF4,0x70,0x87,0x60 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometerReading>{ static constexpr guid value{ 0xB3D6DE5C,0x1EE4,0x456F,{ 0x9D,0xE7,0xE2,0x49,0x3B,0x5C,0x8E,0x03 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometerReading2>{ static constexpr guid value{ 0x16AFE13C,0x2B89,0x44BB,{ 0x82,0x2B,0xD1,0xE1,0x55,0x6F,0xF0,0x9B } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometerReadingChangedEventArgs>{ static constexpr guid value{ 0x0FDF1895,0x6F9E,0x42CE,{ 0x8D,0x58,0x38,0x8C,0x0A,0xB8,0x35,0x6D } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometerStatics>{ static constexpr guid value{ 0x83B6E7C9,0xE49D,0x4B39,{ 0x86,0xE6,0xCD,0x55,0x4B,0xE4,0xC5,0xC1 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IGyrometerStatics2>{ static constexpr guid value{ 0xEF83F7A1,0xD700,0x4204,{ 0x96,0x13,0x79,0xC6,0xB1,0x61,0xDF,0x4E } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IHingeAngleReading>{ static constexpr guid value{ 0xA3CD45B9,0x1BF1,0x4F65,{ 0xA7,0x04,0xE2,0xDA,0x04,0xF1,0x82,0xC0 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IHingeAngleSensor>{ static constexpr guid value{ 0xE9D3BE02,0xBFDF,0x437F,{ 0x8C,0x29,0x88,0xC7,0x73,0x93,0xD3,0x09 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IHingeAngleSensorReadingChangedEventArgs>{ static constexpr guid value{ 0x24D9558B,0xFAD0,0x42B8,{ 0xA8,0x54,0x78,0x92,0x30,0x49,0xA1,0xBA } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IHingeAngleSensorStatics>{ static constexpr guid value{ 0xB7B63910,0xFBB1,0x4123,{ 0x89,0xCE,0x4E,0xA3,0x4E,0xB0,0xDF,0xCA } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometer>{ static constexpr guid value{ 0x2648CA6F,0x2286,0x406F,{ 0x91,0x61,0xF0,0xC4,0xBD,0x80,0x6E,0xBF } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometer2>{ static constexpr guid value{ 0x029F3393,0x28B2,0x45F8,{ 0xBB,0x16,0x61,0xE8,0x6A,0x7F,0xAE,0x6E } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometer3>{ static constexpr guid value{ 0x3A095004,0xD765,0x4384,{ 0xA3,0xD7,0x02,0x83,0xF3,0xAB,0xE6,0xAE } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerDeviceId>{ static constexpr guid value{ 0x01E91982,0x41FF,0x4406,{ 0xAE,0x83,0x62,0x21,0x0F,0xF1,0x6F,0xE3 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerReading>{ static constexpr guid value{ 0x9F44F055,0xB6F6,0x497F,{ 0xB1,0x27,0x1A,0x77,0x5E,0x50,0x14,0x58 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerReading2>{ static constexpr guid value{ 0x4F164781,0xE90B,0x4658,{ 0x89,0x15,0x01,0x03,0xE0,0x8A,0x80,0x5A } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerReadingChangedEventArgs>{ static constexpr guid value{ 0x4AE91DC1,0xE7EB,0x4938,{ 0x85,0x11,0xAE,0x0D,0x6B,0x44,0x04,0x38 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerReadingYawAccuracy>{ static constexpr guid value{ 0xB453E880,0x1FE3,0x4986,{ 0xA2,0x57,0xE6,0xEC,0xE2,0x72,0x39,0x49 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerStatics>{ static constexpr guid value{ 0xF22EC551,0x9C30,0x453A,{ 0x8B,0x49,0x3C,0x3E,0xEB,0x33,0xCB,0x61 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerStatics2>{ static constexpr guid value{ 0x043F9775,0x6A1E,0x499C,{ 0x86,0xE0,0x63,0x8C,0x1A,0x86,0x4B,0x00 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerStatics3>{ static constexpr guid value{ 0xBD9A4280,0xB91A,0x4829,{ 0x93,0x92,0xAB,0xC0,0xB6,0xBD,0xF2,0xB4 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IInclinometerStatics4>{ static constexpr guid value{ 0xE8BA96F9,0x6E85,0x4A83,{ 0xAE,0xD0,0xD7,0xCD,0xCC,0x98,0x56,0xC8 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensor>{ static constexpr guid value{ 0xF84C0718,0x0C54,0x47AE,{ 0x92,0x2E,0x78,0x9F,0x57,0xFB,0x03,0xA0 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensor2>{ static constexpr guid value{ 0x486B24E8,0xA94C,0x4090,{ 0x8F,0x48,0x09,0xF7,0x82,0xA9,0xF7,0xD5 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensorDeviceId>{ static constexpr guid value{ 0x7FEE49F8,0x0AFB,0x4F51,{ 0x87,0xF0,0x6C,0x26,0x37,0x5C,0xE9,0x4F } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensorReading>{ static constexpr guid value{ 0xFFDF6300,0x227C,0x4D2B,{ 0xB3,0x02,0xFC,0x01,0x42,0x48,0x5C,0x68 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensorReading2>{ static constexpr guid value{ 0xB7512185,0x44A3,0x44C9,{ 0x81,0x90,0x9E,0xF6,0xDE,0x0A,0x8A,0x74 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensorReadingChangedEventArgs>{ static constexpr guid value{ 0xA3A2F4CF,0x258B,0x420C,{ 0xB8,0xAB,0x8E,0xDD,0x60,0x1E,0xCF,0x50 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensorStatics>{ static constexpr guid value{ 0x45DB8C84,0xC3A8,0x471E,{ 0x9A,0x53,0x64,0x57,0xFA,0xD8,0x7C,0x0E } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ILightSensorStatics2>{ static constexpr guid value{ 0x0EC0A650,0xDDC6,0x40AB,{ 0xAC,0xE3,0xEC,0x33,0x59,0xD4,0x2C,0x51 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometer>{ static constexpr guid value{ 0x484F626E,0xD3C9,0x4111,{ 0xB3,0xF6,0x2C,0xF1,0xFA,0xA4,0x18,0xD5 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometer2>{ static constexpr guid value{ 0xB4656C85,0x26F6,0x444B,{ 0xA9,0xE2,0xA2,0x3F,0x96,0x6C,0xD3,0x68 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometer3>{ static constexpr guid value{ 0xBE93DB7C,0xA625,0x48EF,{ 0xAC,0xF7,0xFA,0xC1,0x04,0x83,0x26,0x71 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometerDeviceId>{ static constexpr guid value{ 0x58B498C2,0x7E4B,0x404C,{ 0x9F,0xC5,0x5D,0xE8,0xB4,0x0E,0xBA,0xE3 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometerReading>{ static constexpr guid value{ 0x0C2CC40D,0xEBFD,0x4E5C,{ 0xBB,0x11,0xAF,0xC2,0x9B,0x3C,0xAE,0x61 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometerReading2>{ static constexpr guid value{ 0xD4C95C61,0x61D9,0x404B,{ 0xA3,0x28,0x06,0x6F,0x17,0x7A,0x14,0x09 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometerReadingChangedEventArgs>{ static constexpr guid value{ 0x17EAE872,0x2EB9,0x4EE7,{ 0x8A,0xD0,0x31,0x27,0x53,0x7D,0x94,0x9B } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometerStatics>{ static constexpr guid value{ 0x853C64CC,0x0698,0x4DDA,{ 0xA6,0xDF,0x9C,0xB9,0xCC,0x4A,0xB4,0x0A } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IMagnetometerStatics2>{ static constexpr guid value{ 0x2C0819F0,0xFFC6,0x4F89,{ 0xA0,0x6F,0x18,0xFA,0x10,0x79,0x29,0x33 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensor>{ static constexpr guid value{ 0x5E354635,0xCF6B,0x4C63,{ 0xAB,0xD8,0x10,0x25,0x2B,0x0B,0xF6,0xEC } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensor2>{ static constexpr guid value{ 0x0D924CF9,0x2F1F,0x49C9,{ 0x80,0x42,0x4A,0x18,0x13,0xD6,0x77,0x60 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensor3>{ static constexpr guid value{ 0x2CCE578D,0x646B,0x48C5,{ 0xB7,0xEE,0x44,0xFD,0xC4,0xC6,0xAA,0xFD } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorDeviceId>{ static constexpr guid value{ 0x5A69B648,0x4C29,0x49EC,{ 0xB2,0x8F,0xEA,0x1D,0x11,0x7B,0x66,0xF0 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorReading>{ static constexpr guid value{ 0x4756C993,0x6595,0x4897,{ 0xBC,0xC6,0xD5,0x37,0xEE,0x75,0x75,0x64 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorReading2>{ static constexpr guid value{ 0x00576E5F,0x49F8,0x4C05,{ 0x9E,0x07,0x24,0xFA,0xC7,0x94,0x08,0xC3 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorReadingChangedEventArgs>{ static constexpr guid value{ 0x012C1186,0xC3BA,0x46BC,{ 0xAE,0x65,0x7A,0x98,0x99,0x6C,0xBF,0xB8 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorReadingYawAccuracy>{ static constexpr guid value{ 0xD1AC9824,0x3F5A,0x49A2,{ 0xBC,0x7B,0x11,0x80,0xBC,0x38,0xCD,0x2B } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorStatics>{ static constexpr guid value{ 0x10EF8712,0xFB4C,0x428A,{ 0x89,0x8B,0x27,0x65,0xE4,0x09,0xE6,0x69 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorStatics2>{ static constexpr guid value{ 0x59DA0D0B,0xD40A,0x4C71,{ 0x92,0x76,0x8A,0x27,0x2A,0x0A,0x66,0x19 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorStatics3>{ static constexpr guid value{ 0xD82CE920,0x2777,0x40FF,{ 0x9F,0x59,0xD6,0x54,0xB0,0x85,0xF1,0x2F } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IOrientationSensorStatics4>{ static constexpr guid value{ 0xA67FEB55,0x2C85,0x4B28,{ 0xA0,0xFE,0x58,0xC4,0xB2,0x04,0x95,0xF5 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IPedometer>{ static constexpr guid value{ 0x9A1E013D,0x3D98,0x45F8,{ 0x89,0x20,0x8E,0x4E,0xCA,0xCA,0x5F,0x97 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IPedometer2>{ static constexpr guid value{ 0xE5A406DF,0x2B81,0x4ADD,{ 0xB2,0xFF,0x77,0xAB,0x6C,0x98,0xBA,0x19 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IPedometerDataThresholdFactory>{ static constexpr guid value{ 0xCBAD8F50,0x7A54,0x466B,{ 0x90,0x10,0x77,0xA1,0x62,0xFC,0xA5,0xD7 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IPedometerReading>{ static constexpr guid value{ 0x2245DCF4,0xA8E1,0x432F,{ 0x89,0x6A,0xBE,0x0D,0xD9,0xB0,0x2D,0x24 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IPedometerReadingChangedEventArgs>{ static constexpr guid value{ 0xF855E47E,0xABBC,0x4456,{ 0x86,0xA8,0x25,0xCF,0x2B,0x33,0x37,0x42 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IPedometerStatics>{ static constexpr guid value{ 0x82980A2F,0x4083,0x4DFB,{ 0xB4,0x11,0x93,0x8E,0xA0,0xF4,0xB9,0x46 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IPedometerStatics2>{ static constexpr guid value{ 0x79F5C6BB,0xCE0E,0x4133,{ 0xB4,0x7E,0x86,0x27,0xEA,0x72,0xF6,0x77 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IProximitySensor>{ static constexpr guid value{ 0x54C076B8,0xECFB,0x4944,{ 0xB9,0x28,0x74,0xFC,0x50,0x4D,0x47,0xEE } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IProximitySensorDataThresholdFactory>{ static constexpr guid value{ 0x905AC121,0x6D27,0x4AD3,{ 0x9D,0xB5,0x64,0x67,0xF2,0xA5,0xAD,0x9D } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IProximitySensorReading>{ static constexpr guid value{ 0x71228D59,0x132D,0x4D5F,{ 0x8F,0xF9,0x2F,0x0D,0xB8,0x75,0x1C,0xED } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IProximitySensorReadingChangedEventArgs>{ static constexpr guid value{ 0xCFC2F366,0xC3E8,0x40FD,{ 0x8C,0xC3,0x67,0xE2,0x89,0x00,0x49,0x38 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IProximitySensorStatics>{ static constexpr guid value{ 0x29186649,0x6269,0x4E57,{ 0xA5,0xAD,0x82,0xBE,0x80,0x81,0x33,0x92 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::IProximitySensorStatics2>{ static constexpr guid value{ 0xCBF473AE,0xE9CA,0x422F,{ 0xAD,0x67,0x4C,0x3D,0x25,0xDF,0x35,0x0C } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISensorDataThreshold>{ static constexpr guid value{ 0x54DAEC61,0xFE4B,0x4E07,{ 0xB2,0x60,0x3A,0x4C,0xDF,0xBE,0x39,0x6E } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISensorDataThresholdTriggerDetails>{ static constexpr guid value{ 0x9106F1B7,0xE88D,0x48B1,{ 0xBC,0x90,0x61,0x9C,0x7B,0x34,0x93,0x91 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISensorQuaternion>{ static constexpr guid value{ 0xC9C5C827,0xC71C,0x46E7,{ 0x9D,0xA3,0x36,0xA1,0x93,0xB2,0x32,0xBC } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISensorRotationMatrix>{ static constexpr guid value{ 0x0A3D5A67,0x22F4,0x4392,{ 0x95,0x38,0x65,0xD0,0xBD,0x06,0x4A,0xA6 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISimpleOrientationSensor>{ static constexpr guid value{ 0x5FF53856,0x214A,0x4DEE,{ 0xA3,0xF9,0x61,0x6F,0x1A,0xB0,0x6F,0xFD } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISimpleOrientationSensor2>{ static constexpr guid value{ 0xA277A798,0x8870,0x453E,{ 0x8B,0xD6,0xB8,0xF5,0xD8,0xD7,0x94,0x1B } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISimpleOrientationSensorDeviceId>{ static constexpr guid value{ 0xFBC00ACB,0x3B76,0x41F6,{ 0x80,0x91,0x30,0xEF,0xE6,0x46,0xD3,0xCF } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISimpleOrientationSensorOrientationChangedEventArgs>{ static constexpr guid value{ 0xBCD5C660,0x23D4,0x4B4C,{ 0xA2,0x2E,0xBA,0x81,0xAD,0xE0,0xC6,0x01 } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISimpleOrientationSensorStatics>{ static constexpr guid value{ 0x72ED066F,0x70AA,0x40C6,{ 0x9B,0x1B,0x34,0x33,0xF7,0x45,0x9B,0x4E } }; };
template <> struct guid_storage<Windows::Devices::Sensors::ISimpleOrientationSensorStatics2>{ static constexpr guid value{ 0x848F9C7F,0xB138,0x4E11,{ 0x89,0x10,0xA2,0xA2,0xA3,0xB5,0x6D,0x83 } }; };
...
template <> struct abi<Windows::Devices::Sensors::IAccelerometer>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL add_Shaken(void* handler, winrt::event_token* token) noexcept = 0;
    virtual int32_t WINRT_CALL remove_Shaken(winrt::event_token token) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IAccelerometer2>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL put_ReadingTransform(Windows::Graphics::Display::DisplayOrientations value) noexcept = 0;
    virtual int32_t WINRT_CALL get_ReadingTransform(Windows::Graphics::Display::DisplayOrientations* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_ReadingType(Windows::Devices::Sensors::AccelerometerReadingType* type) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Sensors::IAccelerometerReading>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL get_AccelerationX(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AccelerationY(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AccelerationZ(double* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL GetDefaultWithAccelerometerReadingType(Windows::Devices::Sensors::AccelerometerReadingType readingType, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Sensors::IAccelerometerStatics3>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL GetDeviceSelector(Windows::Devices::Sensors::AccelerometerReadingType readingType, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IActivitySensor>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetCurrentReadingAsync(void** result) noexcept = 0;
    virtual int32_t WINRT_CALL get_SubscribedActivities(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_PowerInMilliwatts(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_DeviceId(void** value) noexcept = 0;
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_Activity(Windows::Devices::Sensors::ActivityType* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_Confidence(Windows::Devices::Sensors::ActivitySensorReadingConfidence* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Sensors::IActivitySensorStatics>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL GetSystemHistoryAsync(Windows::Foundation::DateTime fromTime, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetSystemHistoryWithDurationAsync(Windows::Foundation::DateTime fromTime, Windows::Foundation::TimeSpan duration, void** result) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AltitudeChangeInMeters(double* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_StationPressureInHectopascals(double* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_HeadingMagneticNorth(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_HeadingTrueNorth(void** value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_HeadingAccuracy(Windows::Devices::Sensors::MagnetometerAccuracy* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AngularVelocityX(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AngularVelocityY(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AngularVelocityZ(double* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Sensors::IHingeAngleReading>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AngleInDegrees(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_Properties(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IHingeAngleSensor>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetCurrentReadingAsync(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_DeviceId(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_MinReportThresholdInDegrees(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_ReportThresholdInDegrees(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL put_ReportThresholdInDegrees(double value) noexcept = 0;
    virtual int32_t WINRT_CALL add_ReadingChanged(void* handler, winrt::event_token* token) noexcept = 0;
    virtual int32_t WINRT_CALL remove_ReadingChanged(winrt::event_token token) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IHingeAngleSensorReadingChangedEventArgs>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_Reading(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IHingeAngleSensorStatics>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetDeviceSelector(void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetDefaultAsync(void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetRelatedToAdjacentPanelsAsync(void* firstPanelId, void* secondPanelId, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL FromIdAsync(void* deviceId, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Sensors::IInclinometer2>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL put_ReadingTransform(Windows::Graphics::Display::DisplayOrientations value) noexcept = 0;
    virtual int32_t WINRT_CALL get_ReadingTransform(Windows::Graphics::Display::DisplayOrientations* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_ReadingType(Windows::Devices::Sensors::SensorReadingType* type) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_PitchDegrees(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_RollDegrees(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_YawDegrees(float* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_YawAccuracy(Windows::Devices::Sensors::MagnetometerAccuracy* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL GetDefaultForRelativeReadings(void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IInclinometerStatics3>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetDefaultWithSensorReadingType(Windows::Devices::Sensors::SensorReadingType sensorReadingtype, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IInclinometerStatics4>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetDeviceSelector(Windows::Devices::Sensors::SensorReadingType readingType, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL FromIdAsync(void* deviceId, void** operation) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_IlluminanceInLux(float* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_MagneticFieldX(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_MagneticFieldY(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_MagneticFieldZ(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_DirectionalAccuracy(Windows::Devices::Sensors::MagnetometerAccuracy* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_RotationMatrix(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_Quaternion(void** value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL GetDefaultWithSensorReadingType(Windows::Devices::Sensors::SensorReadingType sensorReadingtype, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetDefaultWithSensorReadingTypeAndSensorOptimizationGoal(Windows::Devices::Sensors::SensorReadingType sensorReadingType, Windows::Devices::Sensors::SensorOptimizationGoal optimizationGoal, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IOrientationSensorStatics4>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetDeviceSelector(Windows::Devices::Sensors::SensorReadingType readingType, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetDeviceSelectorWithSensorReadingTypeAndSensorOptimizationGoal(Windows::Devices::Sensors::SensorReadingType readingType, Windows::Devices::Sensors::SensorOptimizationGoal optimizationGoal, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL FromIdAsync(void* deviceId, void** operation) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL GetCurrentReadings(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IPedometerDataThresholdFactory>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL Create(void* sensor, int32_t stepGoal, void** threshold) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IPedometerReading>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_StepKind(Windows::Devices::Sensors::PedometerStepKind* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_CumulativeSteps(int32_t* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_CumulativeStepsDuration(Windows::Foundation::TimeSpan* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Sensors::IPedometerStatics>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL GetDeviceSelector(void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetSystemHistoryAsync(Windows::Foundation::DateTime fromTime, void** operation) noexcept = 0;
    virtual int32_t WINRT_CALL GetSystemHistoryWithDurationAsync(Windows::Foundation::DateTime fromTime, Windows::Foundation::TimeSpan duration, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IPedometerStatics2>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetReadingsFromTriggerDetails(void* triggerDetails, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IProximitySensor>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_DeviceId(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_MaxDistanceInMillimeters(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_MinDistanceInMillimeters(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL GetCurrentReading(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL add_ReadingChanged(void* handler, winrt::event_token* token) noexcept = 0;
    virtual int32_t WINRT_CALL remove_ReadingChanged(winrt::event_token token) noexcept = 0;
    virtual int32_t WINRT_CALL CreateDisplayOnOffController(void** controller) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IProximitySensorDataThresholdFactory>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL Create(void* sensor, void** threshold) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::IProximitySensorReading>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_IsDetected(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_DistanceInMillimeters(void** value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL GetDeviceSelector(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL FromId(void* sensorId, void** result) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_DeviceId(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_SensorType(Windows::Devices::Sensors::SensorType* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::ISensorQuaternion>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_W(float* value) noexcept = 0;
...
{
    virtual int32_t WINRT_CALL get_M11(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M12(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M13(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M21(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M22(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M23(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M31(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M32(float* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_M33(float* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Sensors::ISimpleOrientationSensor>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetCurrentOrientation(Windows::Devices::Sensors::SimpleOrientation* value) noexcept = 0;
...
{
    virtual int32_t WINRT_CALL get_Timestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_Orientation(Windows::Devices::Sensors::SimpleOrientation* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Sensors::ISimpleOrientationSensorStatics2>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetDeviceSelector(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL FromIdAsync(void* deviceId, void** result) noexcept = 0;
};};
...
template <> struct consume<Windows::Devices::Sensors::IHingeAngleReading> { template <typename D> using type = consume_Windows_Devices_Sensors_IHingeAngleReading<D>; };
...
template <> struct consume<Windows::Devices::Sensors::IHingeAngleSensor> { template <typename D> using type = consume_Windows_Devices_Sensors_IHingeAngleSensor<D>; };
...
template <> struct consume<Windows::Devices::Sensors::IHingeAngleSensorReadingChangedEventArgs> { template <typename D> using type = consume_Windows_Devices_Sensors_IHingeAngleSensorReadingChangedEventArgs<D>; };
...
template <> struct consume<Windows::Devices::Sensors::IHingeAngleSensorStatics> { template <typename D> using type = consume_Windows_Devices_Sensors_IHingeAngleSensorStatics<D>; };
...
template <> struct consume<Windows::Devices::Sensors::ISimpleOrientationSensorStatics2> { template <typename D> using type = consume_Windows_Devices_Sensors_ISimpleOrientationSensorStatics2<D>; };
