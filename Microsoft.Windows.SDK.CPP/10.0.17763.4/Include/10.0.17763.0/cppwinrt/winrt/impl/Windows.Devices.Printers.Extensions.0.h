...
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrint3DWorkflow>{ static constexpr guid value{ 0xC56F74BD,0x3669,0x4A66,{ 0xAB,0x42,0xC8,0x15,0x19,0x30,0xCD,0x34 } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrint3DWorkflow2>{ static constexpr guid value{ 0xA2A6C54F,0x8AC1,0x4918,{ 0x97,0x41,0xE3,0x4F,0x30,0x04,0x23,0x9E } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrint3DWorkflowPrintRequestedEventArgs>{ static constexpr guid value{ 0x19F8C858,0x5AC8,0x4B55,{ 0x8A,0x5F,0xE6,0x15,0x67,0xDA,0xFB,0x4D } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrint3DWorkflowPrinterChangedEventArgs>{ static constexpr guid value{ 0x45226402,0x95FC,0x4847,{ 0x93,0xB3,0x13,0x4D,0xBF,0x5C,0x60,0xF7 } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrintExtensionContextStatic>{ static constexpr guid value{ 0xE70D9FC1,0xFF79,0x4AA4,{ 0x8C,0x9B,0x0C,0x93,0xAE,0xDF,0xDE,0x8A } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrintNotificationEventDetails>{ static constexpr guid value{ 0xE00E4C8A,0x4828,0x4DA1,{ 0x8B,0xB8,0x86,0x72,0xDF,0x85,0x15,0xE7 } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrintTaskConfiguration>{ static constexpr guid value{ 0xE3C22451,0x3AA4,0x4885,{ 0x92,0x40,0x31,0x1F,0x5F,0x8F,0xBE,0x9D } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrintTaskConfigurationSaveRequest>{ static constexpr guid value{ 0xEEAF2FCB,0x621E,0x4B62,{ 0xAC,0x77,0xB2,0x81,0xCC,0xE0,0x8D,0x60 } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrintTaskConfigurationSaveRequestedDeferral>{ static constexpr guid value{ 0xE959D568,0xF729,0x44A4,{ 0x87,0x1D,0xBD,0x06,0x28,0x69,0x6A,0x33 } }; };
template <> struct guid_storage<Windows::Devices::Printers::Extensions::IPrintTaskConfigurationSaveRequestedEventArgs>{ static constexpr guid value{ 0xE06C2879,0x0D61,0x4938,{ 0x91,0xD0,0x96,0xA4,0x5B,0xEE,0x84,0x79 } }; };
...
template <> struct abi<Windows::Devices::Printers::Extensions::IPrint3DWorkflow>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL GetPrintModelPackage(void** printModelPackage) noexcept = 0;
    virtual int32_t WINRT_CALL get_IsPrintReady(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL put_IsPrintReady(bool value) noexcept = 0;
    virtual int32_t WINRT_CALL add_PrintRequested(void* eventHandler, winrt::event_token* eventCookie) noexcept = 0;
    virtual int32_t WINRT_CALL remove_PrintRequested(winrt::event_token eventCookie) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Printers::Extensions::IPrint3DWorkflow2>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL add_PrinterChanged(void* eventHandler, winrt::event_token* eventCookie) noexcept = 0;
    virtual int32_t WINRT_CALL remove_PrinterChanged(winrt::event_token eventCookie) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Printers::Extensions::IPrint3DWorkflowPrintRequestedEventArgs>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_Status(Windows::Devices::Printers::Extensions::Print3DWorkflowStatus* value) noexcept = 0;
    virtual int32_t WINRT_CALL SetExtendedStatus(Windows::Devices::Printers::Extensions::Print3DWorkflowDetail value) noexcept = 0;
    virtual int32_t WINRT_CALL SetSource(void* source) noexcept = 0;
    virtual int32_t WINRT_CALL SetSourceChanged(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Printers::Extensions::IPrint3DWorkflowPrinterChangedEventArgs>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_NewDeviceId(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Printers::Extensions::IPrintExtensionContextStatic>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL FromDeviceId(void* deviceId, void** context) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Printers::Extensions::IPrintNotificationEventDetails>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_PrinterName(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_EventData(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL put_EventData(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Printers::Extensions::IPrintTaskConfiguration>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_PrinterExtensionContext(void** context) noexcept = 0;
    virtual int32_t WINRT_CALL add_SaveRequested(void* eventHandler, winrt::event_token* eventCookie) noexcept = 0;
    virtual int32_t WINRT_CALL remove_SaveRequested(winrt::event_token eventCookie) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Printers::Extensions::IPrintTaskConfigurationSaveRequest>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL Save(void* printerExtensionContext) noexcept = 0;
...
{
    virtual int32_t WINRT_CALL get_Request(void** context) noexcept = 0;
};};
