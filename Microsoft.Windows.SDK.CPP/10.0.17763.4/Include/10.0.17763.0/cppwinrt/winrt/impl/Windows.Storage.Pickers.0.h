...
template <> struct abi<Windows::Storage::Pickers::IFileOpenPicker>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL PickSingleFileAsync(void** pickSingleFileOperation) noexcept = 0;
    virtual int32_t WINRT_CALL PickMultipleFilesAsync(void** pickMultipleFilesOperation) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL ResumePickSingleFileAsync(void** pickSingleFileOperation) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Pickers::IFileOpenPickerWithOperationId>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL PickSingleFileAsync(void* pickerOperationId, void** pickSingleFileOperation) noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Pickers::IFileSavePicker>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL PickSaveFileAsync(void** pickSaveFileOperation) noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Pickers::IFolderPicker>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL put_CommitButtonText(void* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_FileTypeFilter(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL PickSingleFolderAsync(void** pickSingleFolderOperation) noexcept = 0;
};};
