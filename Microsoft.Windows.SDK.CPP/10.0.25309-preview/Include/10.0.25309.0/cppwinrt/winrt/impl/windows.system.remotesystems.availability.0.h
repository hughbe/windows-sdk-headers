...
namespace winrt::impl
{
    ...
    {
        auto EnableCloudPC(param::hstring const& displayName, param::hstring const& cloudPCId) const;
        auto DisableCloudPC(param::hstring const& cloudPCId) const;
        auto IsCloudPCEnabled(param::hstring const& cloudPCId) const;
        auto IsIntegratedCloudPCSwitchEnabled() const;
        auto GetAllEnabledCloudPCIds() const;
    };
