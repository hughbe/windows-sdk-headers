...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Devices_Sensors_IHumanPresenceSensorExtensionPlugin<D>::Initialize(param::hstring const& DeviceId) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Sensors::IHumanPresenceSensorExtensionPlugin)->Initialize(*(void**)(&DeviceId)));
    }
    template <typename D> auto consume_Windows_Devices_Sensors_IHumanPresenceSensorExtensionPlugin<D>::Start() const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Sensors::IHumanPresenceSensorExtensionPlugin)->Start());
    }
    template <typename D> auto consume_Windows_Devices_Sensors_IHumanPresenceSensorExtensionPlugin<D>::ProcessReading(winrt::Windows::Devices::Sensors::HumanPresenceSensorReading const& Reading) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Devices_Sensors_IHumanPresenceSensorExtensionPlugin<D>::ProcessReadingTimeoutExpired(winrt::Windows::Devices::Sensors::HumanPresenceSensorReading const& Reading) const
    {
    ...
    template <typename D> auto consume_Windows_Devices_Sensors_IHumanPresenceSensorExtensionPlugin<D>::Stop() const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Sensors::IHumanPresenceSensorExtensionPlugin)->Stop());
    }
    template <typename D> auto consume_Windows_Devices_Sensors_IHumanPresenceSensorExtensionPlugin<D>::Uninitialize() const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Sensors::IHumanPresenceSensorExtensionPlugin)->Uninitialize());
    }
    template <typename D> auto consume_Windows_Devices_Sensors_IHumanPresenceSensorExtensionPlugin<D>::Reset() const
    {
