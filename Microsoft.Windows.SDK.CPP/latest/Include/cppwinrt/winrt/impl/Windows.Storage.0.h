...
template <> struct name<Windows::Storage::IStorageFolder3>{ static constexpr auto & value{ L"Windows.Storage.IStorageFolder3" }; };
...
template <> struct consume<Windows::Storage::IStorageFolder3> { template <typename D> using type = consume_Windows_Storage_IStorageFolder3<D>; };
