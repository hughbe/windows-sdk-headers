...
template <> struct name<Windows::Services::Maps::IMapRouteDrivingOptions2>{ static constexpr auto & value{ L"Windows.Services.Maps.IMapRouteDrivingOptions2" }; };
...
template <> struct name<Windows::Services::Maps::IPlaceInfoStatics2>{ static constexpr auto & value{ L"Windows.Services.Maps.IPlaceInfoStatics2" }; };
...
struct consume_Windows_Services_Maps_IMapRouteDrivingOptions2
{
    ...
    void DepartureTime(optional<Windows::Foundation::DateTime> const& value) const;
};
template <> struct consume<Windows::Services::Maps::IMapRouteDrivingOptions2> { template <typename D> using type = consume_Windows_Services_Maps_IMapRouteDrivingOptions2<D>; };
