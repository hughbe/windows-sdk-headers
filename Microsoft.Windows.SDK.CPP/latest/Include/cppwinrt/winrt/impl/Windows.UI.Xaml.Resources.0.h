...
template <> struct guid_storage<Windows::UI::Xaml::Resources::ICustomXamlResourceLoader>{ static constexpr guid value{ 0x511A84AB,0x4A88,0x419F,{ 0x85,0x2E,0x54,0x08,0x3B,0x90,0xB0,0x78 } }; };
template <> struct guid_storage<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderFactory>{ static constexpr guid value{ 0x5BFD7E49,0x7886,0x44F3,{ 0x8E,0xD3,0x6F,0xEC,0x04,0x63,0xED,0x69 } }; };
template <> struct guid_storage<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderOverrides>{ static constexpr guid value{ 0xF851E991,0xAF02,0x46E8,{ 0x9A,0xF8,0x42,0x7B,0x7E,0xBF,0xE9,0xF8 } }; };
template <> struct guid_storage<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderStatics>{ static constexpr guid value{ 0x224FF617,0xE4DC,0x4C27,{ 0xAD,0x32,0xDB,0x93,0xD5,0xD0,0xE5,0xDA } }; };
...
{
    virtual int32_t WINRT_CALL GetResource(void* resourceId, void* objectType, void* propertyName, void* propertyType, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderStatics>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL put_Current(void* value) noexcept = 0;
};};
