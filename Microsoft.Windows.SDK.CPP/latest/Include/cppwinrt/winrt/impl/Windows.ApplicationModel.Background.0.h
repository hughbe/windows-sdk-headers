...
template <> struct name<Windows::ApplicationModel::Background::IBackgroundExecutionManagerStatics2>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics2" }; };
...
template <> struct name<Windows::ApplicationModel::Background::ICustomSystemEventTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.ICustomSystemEventTrigger" }; };
template <> struct name<Windows::ApplicationModel::Background::ICustomSystemEventTriggerFactory>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.ICustomSystemEventTriggerFactory" }; };
...
template <> struct name<Windows::ApplicationModel::Background::IStorageLibraryChangeTrackerTriggerFactory>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.IStorageLibraryChangeTrackerTriggerFactory" }; };
...
template <> struct name<Windows::ApplicationModel::Background::MobileBroadbandPcoDataChangeTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.MobileBroadbandPcoDataChangeTrigger" }; };
...
template <> struct name<Windows::ApplicationModel::Background::NetworkOperatorDataUsageTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.NetworkOperatorDataUsageTrigger" }; };
...
template <> struct name<Windows::ApplicationModel::Background::StorageLibraryChangeTrackerTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.StorageLibraryChangeTrackerTrigger" }; };
...
template <> struct name<Windows::ApplicationModel::Background::TetheringEntitlementCheckTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.TetheringEntitlementCheckTrigger" }; };
...
template <> struct name<Windows::ApplicationModel::Background::BackgroundAccessRequestKind>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.BackgroundAccessRequestKind" }; };
...
template <> struct name<Windows::ApplicationModel::Background::CustomSystemEventTriggerRecurrence>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.CustomSystemEventTriggerRecurrence" }; };
...
template <> struct consume<Windows::ApplicationModel::Background::IBackgroundExecutionManagerStatics2> { template <typename D> using type = consume_Windows_ApplicationModel_Background_IBackgroundExecutionManagerStatics2<D>; };
...
template <> struct consume<Windows::ApplicationModel::Background::ICustomSystemEventTrigger> { template <typename D> using type = consume_Windows_ApplicationModel_Background_ICustomSystemEventTrigger<D>; };
...
template <> struct consume<Windows::ApplicationModel::Background::ICustomSystemEventTriggerFactory> { template <typename D> using type = consume_Windows_ApplicationModel_Background_ICustomSystemEventTriggerFactory<D>; };
...
template <> struct consume<Windows::ApplicationModel::Background::IStorageLibraryChangeTrackerTriggerFactory> { template <typename D> using type = consume_Windows_ApplicationModel_Background_IStorageLibraryChangeTrackerTriggerFactory<D>; };
