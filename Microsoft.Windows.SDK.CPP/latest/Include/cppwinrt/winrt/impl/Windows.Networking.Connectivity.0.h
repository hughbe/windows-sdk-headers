...
template <> struct name<Windows::Networking::Connectivity::ICellularApnContext2>{ static constexpr auto & value{ L"Windows.Networking.Connectivity.ICellularApnContext2" }; };
...
template <> struct name<Windows::Networking::Connectivity::IWwanConnectionProfileDetails2>{ static constexpr auto & value{ L"Windows.Networking.Connectivity.IWwanConnectionProfileDetails2" }; };
...
template <> struct name<Windows::Networking::Connectivity::WwanNetworkIPKind>{ static constexpr auto & value{ L"Windows.Networking.Connectivity.WwanNetworkIPKind" }; };
...
template <> struct consume<Windows::Networking::Connectivity::ICellularApnContext2> { template <typename D> using type = consume_Windows_Networking_Connectivity_ICellularApnContext2<D>; };
