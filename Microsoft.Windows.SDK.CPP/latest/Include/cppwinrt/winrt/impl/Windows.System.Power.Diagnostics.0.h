...
template <> struct guid_storage<Windows::System::Power::Diagnostics::IBackgroundEnergyDiagnosticsStatics>{ static constexpr guid value{ 0xD7663702,0xD3A6,0x46E0,{ 0x8F,0x9B,0x50,0xB9,0x5B,0xB4,0xF9,0xC5 } }; };
template <> struct guid_storage<Windows::System::Power::Diagnostics::IForegroundEnergyDiagnosticsStatics>{ static constexpr guid value{ 0x23CA0917,0xCD07,0x4609,{ 0xBE,0x15,0x8F,0xE8,0x94,0xC5,0xE4,0x1E } }; };

template <> struct abi<Windows::System::Power::Diagnostics::IBackgroundEnergyDiagnosticsStatics>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_DeviceSpecificConversionFactor(double* value) noexcept = 0;
    virtual int32_t WINRT_CALL ComputeTotalEnergyUsage(uint64_t* value) noexcept = 0;
