...
template <> struct abi<Windows::UI::Input::Preview::Injection::InjectedInputPoint>{ using type = struct_Windows_UI_Input_Preview_Injection_InjectedInputPoint; };
...
template <> struct abi<Windows::UI::Input::Preview::Injection::InjectedInputPointerInfo>{ using type = struct_Windows_UI_Input_Preview_Injection_InjectedInputPointerInfo; };
