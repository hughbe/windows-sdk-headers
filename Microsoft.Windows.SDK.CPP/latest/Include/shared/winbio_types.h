...
typedef ULONG32 WINBIO_SETTING_CONFIGURATION, *PWINBIO_SETTING_CONFIGURATION;

#define WINBIO_SETTING_CONFIGURATION_PERIPHERALS_WITH_ESS ((WINBIO_SETTING_CONFIGURATION)0)
