...
#if NCRYPT_VSM_ATTESTATION_CLEANUP
#define NCRYPTBUFFER_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS 54
#define NCRYPTBUFFER_VSM_KEY_ATTESTATION_CLAIM_RESTRICTIONS NCRYPTBUFFER_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS
...
#if NCRYPT_VSM_ATTESTATION_CLEANUP
#define NCRYPT_CLAIM_VSM_KEY_ATTESTATION_STATEMENT NCRYPT_CLAIM_VBS_KEY_ATTESTATION_STATEMENT
#endif // NCRYPT_VSM_ATTESTATION_CLEANUP
...
#define NCRYPT_VBS_KEY_ATTESTATION_STATEMENT_V0  NCRYPT_VSM_KEY_ATTESTATION_STATEMENT_V0

// Buffer contents for NCryptVerifyClaim (for buffer type NCRYPTBUFFER_ISOLATED_KEY_ATTESTATION_CLAIM_RESTRICTIONS)

#define NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS_V0 0
#define NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS_CURRENT_VERSION NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS_V0

#define NCRYPT_VSM_KEY_ATTESTATION_CLAIM_RESTRICTIONS_V0 NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS_V0
#define NCRYPT_VSM_KEY_ATTESTATION_CLAIM_RESTRICTIONS_CURRENT_VERSION NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS_CURRENT_VERSION

#pragma warning(disable:4214) // bit fields type other than int
typedef struct _NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS
{
    ULONG Version;            // Set to NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS_V0
    ULONGLONG TrustletId;     // Trustlet type
    ULONG MinSvn;             // Minimum acceptable trustlet SVN, 0 if don't care
    ULONG FlagsMask;          // Which of NCRYPT_VBS_KEY_FLAG_* flags to check
  ...
  NCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS, *PNCRYPT_VBS_KEY_ATTESTATION_CLAIM_RESTRICTIONS;
#endif // NCRYPT_VSM_ATTESTATION_CLEANUP
...
// We'd like to differentiate between the old structure and the new one for backward comp.
