...
typedef JOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION
    JOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION_V1,
    *PJOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION_V1;

typedef struct _JOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION_V2 {
    JOBOBJECT_BASIC_ACCOUNTING_INFORMATION BasicInfo;
    IO_COUNTERS IoInfo;
    DWORD64 NetworkBytesIn;
    DWORD64 NetworkBytesOut;
} JOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION_V2, *PJOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION_V2;
