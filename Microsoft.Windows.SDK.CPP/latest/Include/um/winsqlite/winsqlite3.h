...
/* sqlite3_filename was added in 3.40.0
   ...
   Therefore, some external APIs actually changed fron a char* to const char*
...
*/
SQLITE_API const char *SQLITE_APICALL sqlite3_uri_parameter(_SQLITE_FILENAME zFilename, const char *zParam);
SQLITE_API int SQLITE_APICALL sqlite3_uri_boolean(_SQLITE_FILENAME zFile, const char *zParam, int bDefault);
SQLITE_API sqlite3_int64 SQLITE_APICALL sqlite3_uri_int64(_SQLITE_FILENAME, const char*, sqlite3_int64);
#if NTDDI_VERSION >= NTDDI_WIN10_CO
SQLITE_API const char *SQLITE_APICALL sqlite3_uri_key(_SQLITE_FILENAME zFilename, int N);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_CO */
