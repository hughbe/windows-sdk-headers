...
template <> struct name<Windows::Networking::BackgroundTransfer::IDownloadOperation4>{ static constexpr auto & value{ L"Windows.Networking.BackgroundTransfer.IDownloadOperation4" }; };
...
template <> struct name<Windows::Networking::BackgroundTransfer::IUploadOperation3>{ static constexpr auto & value{ L"Windows.Networking.BackgroundTransfer.IUploadOperation3" }; };
...
template <> struct consume<Windows::Networking::BackgroundTransfer::IDownloadOperation4> { template <typename D> using type = consume_Windows_Networking_BackgroundTransfer_IDownloadOperation4<D>; };
...
template <> struct consume<Windows::Networking::BackgroundTransfer::IUploadOperation3> { template <typename D> using type = consume_Windows_Networking_BackgroundTransfer_IUploadOperation3<D>; };
...
template <> struct abi<Windows::Networking::BackgroundTransfer::BackgroundDownloadProgress>{ using type = struct_Windows_Networking_BackgroundTransfer_BackgroundDownloadProgress; };
...
template <> struct abi<Windows::Networking::BackgroundTransfer::BackgroundTransferFileRange>{ using type = struct_Windows_Networking_BackgroundTransfer_BackgroundTransferFileRange; };
