...
template <> struct name<Windows::ApplicationModel::Activation::IBarcodeScannerPreviewActivatedEventArgs>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.IBarcodeScannerPreviewActivatedEventArgs" }; };
...
template <> struct name<Windows::ApplicationModel::Activation::BarcodeScannerPreviewActivatedEventArgs>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.BarcodeScannerPreviewActivatedEventArgs" }; };
...
template <> struct consume<Windows::ApplicationModel::Activation::IBarcodeScannerPreviewActivatedEventArgs> { template <typename D> using type = consume_Windows_ApplicationModel_Activation_IBarcodeScannerPreviewActivatedEventArgs<D>; };
