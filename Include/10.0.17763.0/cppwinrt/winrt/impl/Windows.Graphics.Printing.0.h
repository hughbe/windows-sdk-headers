...
template <> struct name<Windows::Graphics::Printing::IPrintPageRange>{ static constexpr auto & value{ L"Windows.Graphics.Printing.IPrintPageRange" }; };
template <> struct name<Windows::Graphics::Printing::IPrintPageRangeFactory>{ static constexpr auto & value{ L"Windows.Graphics.Printing.IPrintPageRangeFactory" }; };
template <> struct name<Windows::Graphics::Printing::IPrintPageRangeOptions>{ static constexpr auto & value{ L"Windows.Graphics.Printing.IPrintPageRangeOptions" }; };
...
template <> struct name<Windows::Graphics::Printing::IPrintTaskOptions2>{ static constexpr auto & value{ L"Windows.Graphics.Printing.IPrintTaskOptions2" }; };
...
template <> struct name<Windows::Graphics::Printing::IStandardPrintTaskOptionsStatic3>{ static constexpr auto & value{ L"Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic3" }; };
...
template <> struct name<Windows::Graphics::Printing::PrintPageRange>{ static constexpr auto & value{ L"Windows.Graphics.Printing.PrintPageRange" }; };
template <> struct name<Windows::Graphics::Printing::PrintPageRangeOptions>{ static constexpr auto & value{ L"Windows.Graphics.Printing.PrintPageRangeOptions" }; };
...
template <> struct consume<Windows::Graphics::Printing::IPrintPageRange> { template <typename D> using type = consume_Windows_Graphics_Printing_IPrintPageRange<D>; };
...
template <> struct consume<Windows::Graphics::Printing::IPrintPageRangeFactory> { template <typename D> using type = consume_Windows_Graphics_Printing_IPrintPageRangeFactory<D>; };
...
template <> struct consume<Windows::Graphics::Printing::IPrintPageRangeOptions> { template <typename D> using type = consume_Windows_Graphics_Printing_IPrintPageRangeOptions<D>; };
...
template <> struct consume<Windows::Graphics::Printing::IPrintTaskOptions2> { template <typename D> using type = consume_Windows_Graphics_Printing_IPrintTaskOptions2<D>; };
...
template <> struct consume<Windows::Graphics::Printing::IStandardPrintTaskOptionsStatic3> { template <typename D> using type = consume_Windows_Graphics_Printing_IStandardPrintTaskOptionsStatic3<D>; };
