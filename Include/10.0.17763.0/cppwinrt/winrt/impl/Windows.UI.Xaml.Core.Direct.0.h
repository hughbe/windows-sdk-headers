...
template <> struct name<Windows::UI::Xaml::Core::Direct::IXamlDirect>{ static constexpr auto & value{ L"Windows.UI.Xaml.Core.Direct.IXamlDirect" }; };
template <> struct name<Windows::UI::Xaml::Core::Direct::IXamlDirectObject>{ static constexpr auto & value{ L"Windows.UI.Xaml.Core.Direct.IXamlDirectObject" }; };
template <> struct name<Windows::UI::Xaml::Core::Direct::IXamlDirectStatics>{ static constexpr auto & value{ L"Windows.UI.Xaml.Core.Direct.IXamlDirectStatics" }; };
template <> struct name<Windows::UI::Xaml::Core::Direct::XamlDirect>{ static constexpr auto & value{ L"Windows.UI.Xaml.Core.Direct.XamlDirect" }; };
template <> struct name<Windows::UI::Xaml::Core::Direct::XamlEventIndex>{ static constexpr auto & value{ L"Windows.UI.Xaml.Core.Direct.XamlEventIndex" }; };
template <> struct name<Windows::UI::Xaml::Core::Direct::XamlPropertyIndex>{ static constexpr auto & value{ L"Windows.UI.Xaml.Core.Direct.XamlPropertyIndex" }; };
template <> struct name<Windows::UI::Xaml::Core::Direct::XamlTypeIndex>{ static constexpr auto & value{ L"Windows.UI.Xaml.Core.Direct.XamlTypeIndex" }; };
template <> struct guid_storage<Windows::UI::Xaml::Core::Direct::IXamlDirect>{ static constexpr guid value{ 0x5FFA1295,0xADD2,0x590F,{ 0xA0,0x51,0x70,0x98,0x9B,0x86,0x6A,0xDE } }; };
template <> struct guid_storage<Windows::UI::Xaml::Core::Direct::IXamlDirectObject>{ static constexpr guid value{ 0x10614A82,0xCEE4,0x4645,{ 0xBA,0x25,0xD0,0x71,0xCE,0x77,0x83,0x55 } }; };
template <> struct guid_storage<Windows::UI::Xaml::Core::Direct::IXamlDirectStatics>{ static constexpr guid value{ 0x321887CC,0x14E4,0x5C6F,{ 0x87,0x8D,0xFB,0xB6,0x04,0xAD,0x7D,0x17 } }; };
...
template <> struct abi<Windows::UI::Xaml::Core::Direct::IXamlDirect>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL GetObject(void* xamlDirectObject, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetXamlDirectObject(void* object, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL CreateInstance(Windows::UI::Xaml::Core::Direct::XamlTypeIndex typeIndex, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL SetObjectProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, void* value) noexcept = 0;
    virtual int32_t WINRT_CALL SetXamlDirectObjectProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, void* value) noexcept = 0;
    virtual int32_t WINRT_CALL SetBooleanProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, bool value) noexcept = 0;
    virtual int32_t WINRT_CALL SetDoubleProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, double value) noexcept = 0;
    virtual int32_t WINRT_CALL SetInt32Property(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, int32_t value) noexcept = 0;
    virtual int32_t WINRT_CALL SetStringProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, void* value) noexcept = 0;
    virtual int32_t WINRT_CALL SetDateTimeProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::DateTime value) noexcept = 0;
    virtual int32_t WINRT_CALL SetPointProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::Point value) noexcept = 0;
    virtual int32_t WINRT_CALL SetRectProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::Rect value) noexcept = 0;
    virtual int32_t WINRT_CALL SetSizeProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::Size value) noexcept = 0;
    virtual int32_t WINRT_CALL SetTimeSpanProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual int32_t WINRT_CALL SetColorProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Color value) noexcept = 0;
    virtual int32_t WINRT_CALL SetCornerRadiusProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_CornerRadius value) noexcept = 0;
    virtual int32_t WINRT_CALL SetDurationProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Duration value) noexcept = 0;
    virtual int32_t WINRT_CALL SetGridLengthProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_GridLength value) noexcept = 0;
    virtual int32_t WINRT_CALL SetThicknessProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Thickness value) noexcept = 0;
    virtual int32_t WINRT_CALL SetMatrixProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Media_Matrix value) noexcept = 0;
    virtual int32_t WINRT_CALL SetMatrix3DProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D value) noexcept = 0;
    virtual int32_t WINRT_CALL SetEnumProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, uint32_t value) noexcept = 0;
    virtual int32_t WINRT_CALL GetObjectProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetXamlDirectObjectProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetBooleanProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, bool* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetDoubleProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, double* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetInt32Property(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, int32_t* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetStringProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, void** result) noexcept = 0;
    virtual int32_t WINRT_CALL GetDateTimeProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::DateTime* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetPointProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::Point* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetRectProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::Rect* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetSizeProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::Size* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetTimeSpanProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, Windows::Foundation::TimeSpan* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetColorProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Color* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetCornerRadiusProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_CornerRadius* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetDurationProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Duration* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetGridLengthProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_GridLength* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetThicknessProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Thickness* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetMatrixProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Media_Matrix* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetMatrix3DProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetEnumProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex, uint32_t* result) noexcept = 0;
    virtual int32_t WINRT_CALL ClearProperty(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlPropertyIndex propertyIndex) noexcept = 0;
    virtual int32_t WINRT_CALL GetCollectionCount(void* xamlDirectObject, uint32_t* result) noexcept = 0;
    virtual int32_t WINRT_CALL GetXamlDirectObjectFromCollectionAt(void* xamlDirectObject, uint32_t index, void** result) noexcept = 0;
    ...
    virtual int32_t WINRT_CALL RemoveFromCollection(void* xamlDirectObject, void* value, bool* result) noexcept = 0;
    ...
    virtual int32_t WINRT_CALL AddEventHandler(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlEventIndex eventIndex, void* handler) noexcept = 0;
    virtual int32_t WINRT_CALL AddEventHandler_HandledEventsToo(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlEventIndex eventIndex, void* handler, bool handledEventsToo) noexcept = 0;
    virtual int32_t WINRT_CALL RemoveEventHandler(void* xamlDirectObject, Windows::UI::Xaml::Core::Direct::XamlEventIndex eventIndex, void* handler) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Core::Direct::IXamlDirectObject>{ struct type : IInspectable
{
};};

template <> struct abi<Windows::UI::Xaml::Core::Direct::IXamlDirectStatics>{ struct type : IInspectable
{
...
template <> struct consume<Windows::UI::Xaml::Core::Direct::IXamlDirect> { template <typename D> using type = consume_Windows_UI_Xaml_Core_Direct_IXamlDirect<D>; };

template <typename D>
struct consume_Windows_UI_Xaml_Core_Direct_IXamlDirectObject
{
};
template <> struct consume<Windows::UI::Xaml::Core::Direct::IXamlDirectObject> { template <typename D> using type = consume_Windows_UI_Xaml_Core_Direct_IXamlDirectObject<D>; };
...
template <> struct consume<Windows::UI::Xaml::Core::Direct::IXamlDirectStatics> { template <typename D> using type = consume_Windows_UI_Xaml_Core_Direct_IXamlDirectStatics<D>; };
