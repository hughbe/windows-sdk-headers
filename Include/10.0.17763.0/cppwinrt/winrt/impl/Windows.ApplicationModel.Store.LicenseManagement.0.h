...
template <> struct guid_storage<Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics>{ static constexpr guid value{ 0xB5AC3AE0,0xDA47,0x4F20,{ 0x9A,0x23,0x09,0x18,0x2C,0x94,0x76,0xFF } }; };
template <> struct guid_storage<Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics2>{ static constexpr guid value{ 0xAB2EC47B,0x1F79,0x4480,{ 0xB8,0x7E,0x2C,0x49,0x9E,0x60,0x1B,0xA3 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>{ static constexpr guid value{ 0x3CCBB08F,0xDB31,0x48D5,{ 0x83,0x84,0xFA,0x17,0xC8,0x14,0x74,0xE2 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult>{ static constexpr guid value{ 0x3C674F73,0x3C87,0x4EE1,{ 0x82,0x01,0xF4,0x28,0x35,0x9B,0xD3,0xAF } }; };
...
{
    virtual int32_t WINRT_CALL AddLicenseAsync(void* license, void** action) noexcept = 0;
    virtual int32_t WINRT_CALL GetSatisfactionInfosAsync(void* contentIds, void* keyIds, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics2>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL RefreshLicensesAsync(Windows::ApplicationModel::Store::LicenseManagement::LicenseRefreshOption refreshOption, void** action) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_SatisfiedByDevice(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_SatisfiedByOpenLicense(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_SatisfiedByTrial(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_SatisfiedByPass(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_SatisfiedByInstallMedia(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_SatisfiedBySignedInUser(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_IsSatisfied(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult>{ struct type : IInspectable
{
    virtual int32_t WINRT_CALL get_LicenseSatisfactionInfos(void** value) noexcept = 0;
