...
typedef struct _KUSER_SHARED_DATA {
    ...
    //
    // On non-XBOX AMD64, these flags indicate the environments where user-mode
    // CET shadow stacks are available.
    //
...
C_ASSERT(FIELD_OFFSET(KUSER_SHARED_DATA, UserCetAvailableEnvironments) == 0x30c);
