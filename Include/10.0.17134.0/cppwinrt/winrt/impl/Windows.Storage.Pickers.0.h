...
{
    virtual HRESULT __stdcall get_ViewMode(Windows::Storage::Pickers::PickerViewMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_ViewMode(Windows::Storage::Pickers::PickerViewMode value) noexcept = 0;
    virtual HRESULT __stdcall get_SettingsIdentifier(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_SettingsIdentifier(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_SuggestedStartLocation(Windows::Storage::Pickers::PickerLocationId* value) noexcept = 0;
    virtual HRESULT __stdcall put_SuggestedStartLocation(Windows::Storage::Pickers::PickerLocationId value) noexcept = 0;
    ...
    virtual HRESULT __stdcall PickSingleFileAsync(void** pickSingleFileOperation) noexcept = 0;
    virtual HRESULT __stdcall PickMultipleFilesAsync(void** pickMultipleFilesOperation) noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Pickers::IFileOpenPicker2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall PickSingleFileAndContinue() noexcept = 0;
    virtual HRESULT __stdcall PickMultipleFilesAndContinue() noexcept = 0;
};};

template <> struct abi<Windows::Storage::Pickers::IFileOpenPickerStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ResumePickSingleFileAsync(void** pickSingleFileOperation) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Pickers::IFileOpenPickerWithOperationId>{ struct type : IInspectable
{
    virtual HRESULT __stdcall PickSingleFileAsync(HSTRING pickerOperationId, void** pickSingleFileOperation) noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Pickers::IFileSavePicker>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_CommitButtonText(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_CommitButtonText(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_FileTypeChoices(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DefaultFileExtension(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_DefaultFileExtension(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_SuggestedSaveFile(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_SuggestedSaveFile(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_SuggestedFileName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_SuggestedFileName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall PickSaveFileAsync(void** pickSaveFileOperation) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Pickers::IFileSavePicker2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ContinuationData(void** value) noexcept = 0;
    virtual HRESULT __stdcall PickSaveFileAndContinue() noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Pickers::IFolderPicker>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_CommitButtonText(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_FileTypeFilter(void** value) noexcept = 0;
    virtual HRESULT __stdcall PickSingleFolderAsync(void** pickSingleFolderOperation) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Pickers::IFolderPicker2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ContinuationData(void** value) noexcept = 0;
    virtual HRESULT __stdcall PickFolderAndContinue() noexcept = 0;
};};
