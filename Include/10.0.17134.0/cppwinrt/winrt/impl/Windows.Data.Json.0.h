...
{
    virtual HRESULT __stdcall GetObjectAt(uint32_t index, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetArrayAt(uint32_t index, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetStringAt(uint32_t index, HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNumberAt(uint32_t index, double* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetBooleanAt(uint32_t index, bool* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonArrayStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Parse(HSTRING input, void** jsonArray) noexcept = 0;
    virtual HRESULT __stdcall TryParse(HSTRING input, void** result, bool* succeeded) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonErrorStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetJsonStatus(int32_t hresult, Windows::Data::Json::JsonErrorStatus* status) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonObject>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetNamedValue(HSTRING name, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall SetNamedValue(HSTRING name, void* value) noexcept = 0;
    virtual HRESULT __stdcall GetNamedObject(HSTRING name, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedArray(HSTRING name, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedString(HSTRING name, HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedNumber(HSTRING name, double* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedBoolean(HSTRING name, bool* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonObjectStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Parse(HSTRING input, void** jsonObject) noexcept = 0;
    virtual HRESULT __stdcall TryParse(HSTRING input, void** result, bool* succeeded) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonObjectWithDefaultValues>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetNamedValueOrDefault(HSTRING name, void* defaultValue, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedObjectOrDefault(HSTRING name, void* defaultValue, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedStringOrDefault(HSTRING name, HSTRING defaultValue, HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedArrayOrDefault(HSTRING name, void* defaultValue, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedNumberOrDefault(HSTRING name, double defaultValue, double* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNamedBooleanOrDefault(HSTRING name, bool defaultValue, bool* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonValue>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ValueType(Windows::Data::Json::JsonValueType* value) noexcept = 0;
    virtual HRESULT __stdcall Stringify(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetString(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNumber(double* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetBoolean(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetArray(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetObject(void** returnValue) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonValueStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Parse(HSTRING input, void** jsonValue) noexcept = 0;
    virtual HRESULT __stdcall TryParse(HSTRING input, void** result, bool* succeeded) noexcept = 0;
    virtual HRESULT __stdcall CreateBooleanValue(bool input, void** jsonValue) noexcept = 0;
    virtual HRESULT __stdcall CreateNumberValue(double input, void** jsonValue) noexcept = 0;
    virtual HRESULT __stdcall CreateStringValue(HSTRING input, void** jsonValue) noexcept = 0;
};};

template <> struct abi<Windows::Data::Json::IJsonValueStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateNullValue(void** jsonValue) noexcept = 0;
};};
