...
template <> struct guid<Windows::Storage::Provider::IStorageProviderGetContentInfoForPathResult>{ static constexpr GUID value{ 0x2564711D,0xAA89,0x4D12,{ 0x82,0xE3,0xF7,0x2A,0x92,0xE3,0x39,0x66 } }; };
template <> struct guid<Windows::Storage::Provider::IStorageProviderGetPathForContentUriResult>{ static constexpr GUID value{ 0x63711A9D,0x4118,0x45A6,{ 0xAC,0xB6,0x22,0xC4,0x9D,0x01,0x9F,0x40 } }; };
...
template <> struct guid<Windows::Storage::Provider::IStorageProviderUriSource>{ static constexpr GUID value{ 0xB29806D1,0x8BE0,0x4962,{ 0x8B,0xB6,0x0D,0x4C,0x2E,0x14,0xD4,0x7A } }; };
...
struct consume_Windows_Storage_Provider_IStorageProviderSyncRootInfo
{
    ...
    void Path(Windows::Storage::IStorageFolder const& folder) const;
    hstring DisplayNameResource() const;
    void DisplayNameResource(param::hstring const& value) const;
    hstring IconResource() const;
    void IconResource(param::hstring const& value) const;
...
{
    virtual HRESULT __stdcall SetUpdateInformation(void* file, HSTRING contentId, Windows::Storage::Provider::ReadActivationMode readMode, Windows::Storage::Provider::WriteActivationMode writeMode, Windows::Storage::Provider::CachedFileOptions options) noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Provider::ICachedFileUpdaterUI>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_FileUpdateRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_FileUpdateRequested(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_UIRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_UIRequested(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_UIStatus(Windows::Storage::Provider::UIStatus* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Provider::IFileUpdateRequest>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Storage::Provider::FileUpdateStatus* value) noexcept = 0;
    virtual HRESULT __stdcall put_Status(Windows::Storage::Provider::FileUpdateStatus value) noexcept = 0;
    virtual HRESULT __stdcall GetDeferral(void** value) noexcept = 0;
    virtual HRESULT __stdcall UpdateLocalFile(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Provider::IFileUpdateRequest2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_UserInputNeededMessage(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_UserInputNeededMessage(HSTRING value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::Storage::Provider::StorageProviderUriSourceStatus* value) noexcept = 0;
    virtual HRESULT __stdcall put_Status(Windows::Storage::Provider::StorageProviderUriSourceStatus value) noexcept = 0;
    virtual HRESULT __stdcall get_ContentUri(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ContentUri(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_ContentId(HSTRING* value) noexcept = 0;
...
template <> struct abi<Windows::Storage::Provider::IStorageProviderGetPathForContentUriResult>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Path(HSTRING value) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Provider::IStorageProviderItemPropertiesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall SetAsync(void* item, void* itemProperties, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Provider::IStorageProviderItemProperty>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_Id(int32_t value) noexcept = 0;
    ...
    virtual HRESULT __stdcall put_IconResource(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_IconResource(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetItemProperties(HSTRING itemPath, void** itemProperties) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Provider::IStorageProviderPropertyCapabilities>{ struct type : IInspectable
{
    virtual HRESULT __stdcall IsPropertySupported(HSTRING propertyCanonicalName, bool* isSupported) noexcept = 0;
};};
...
template <> struct abi<Windows::Storage::Provider::IStorageProviderSyncRootInfo>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Context(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Path(void** folder) noexcept = 0;
    virtual HRESULT __stdcall put_Path(void* folder) noexcept = 0;
    virtual HRESULT __stdcall get_DisplayNameResource(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_DisplayNameResource(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_IconResource(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_IconResource(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_HydrationPolicy(Windows::Storage::Provider::StorageProviderHydrationPolicy* value) noexcept = 0;
    virtual HRESULT __stdcall put_HydrationPolicy(Windows::Storage::Provider::StorageProviderHydrationPolicy value) noexcept = 0;
    virtual HRESULT __stdcall get_HydrationPolicyModifier(Windows::Storage::Provider::StorageProviderHydrationPolicyModifier* value) noexcept = 0;
    virtual HRESULT __stdcall put_HydrationPolicyModifier(Windows::Storage::Provider::StorageProviderHydrationPolicyModifier value) noexcept = 0;
    virtual HRESULT __stdcall get_PopulationPolicy(Windows::Storage::Provider::StorageProviderPopulationPolicy* value) noexcept = 0;
    virtual HRESULT __stdcall put_PopulationPolicy(Windows::Storage::Provider::StorageProviderPopulationPolicy value) noexcept = 0;
    virtual HRESULT __stdcall get_InSyncPolicy(Windows::Storage::Provider::StorageProviderInSyncPolicy* value) noexcept = 0;
    virtual HRESULT __stdcall put_InSyncPolicy(Windows::Storage::Provider::StorageProviderInSyncPolicy value) noexcept = 0;
    virtual HRESULT __stdcall get_HardlinkPolicy(Windows::Storage::Provider::StorageProviderHardlinkPolicy* value) noexcept = 0;
    virtual HRESULT __stdcall put_HardlinkPolicy(Windows::Storage::Provider::StorageProviderHardlinkPolicy value) noexcept = 0;
    virtual HRESULT __stdcall get_ShowSiblingsAsGroup(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_ShowSiblingsAsGroup(bool value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_ProtectionMode(Windows::Storage::Provider::StorageProviderProtectionMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_ProtectionMode(Windows::Storage::Provider::StorageProviderProtectionMode value) noexcept = 0;
    virtual HRESULT __stdcall get_AllowPinning(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_AllowPinning(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_StorageProviderItemPropertyDefinitions(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RecycleBinUri(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_RecycleBinUri(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Provider::IStorageProviderSyncRootManagerStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Register(void* syncRootInformation) noexcept = 0;
    virtual HRESULT __stdcall Unregister(HSTRING id) noexcept = 0;
    virtual HRESULT __stdcall GetSyncRootInformationForFolder(void* folder, void** syncRootInformation) noexcept = 0;
    virtual HRESULT __stdcall GetSyncRootInformationForId(HSTRING id, void** syncRootInformation) noexcept = 0;
    virtual HRESULT __stdcall GetCurrentSyncRoots(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Storage::Provider::IStorageProviderUriSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetPathForContentUri(HSTRING contentUri, void* result) noexcept = 0;
    virtual HRESULT __stdcall GetContentInfoForPath(HSTRING path, void* result) noexcept = 0;
};};
