...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointment>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Organizer(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Organizer(void* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_BusyStatus(Windows::ApplicationModel::Appointments::AppointmentBusyStatus* value) noexcept = 0;
    virtual HRESULT __stdcall put_BusyStatus(Windows::ApplicationModel::Appointments::AppointmentBusyStatus value) noexcept = 0;
    virtual HRESULT __stdcall get_AllDay(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_AllDay(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_Sensitivity(Windows::ApplicationModel::Appointments::AppointmentSensitivity* value) noexcept = 0;
    virtual HRESULT __stdcall put_Sensitivity(Windows::ApplicationModel::Appointments::AppointmentSensitivity value) noexcept = 0;
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointment2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_CalendarId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RoamingId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_RoamingId(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_OriginalStartTime(void** value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_OnlineMeetingLink(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_OnlineMeetingLink(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_ReplyTime(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ReplyTime(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_UserResponse(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse* value) noexcept = 0;
    virtual HRESULT __stdcall put_UserResponse(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse value) noexcept = 0;
    virtual HRESULT __stdcall get_HasInvitees(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCanceledMeeting(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsCanceledMeeting(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsOrganizedByUser(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsOrganizedByUser(bool value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointment3>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_DetailsKind(Windows::ApplicationModel::Appointments::AppointmentDetailsKind* value) noexcept = 0;
    virtual HRESULT __stdcall put_DetailsKind(Windows::ApplicationModel::Appointments::AppointmentDetailsKind value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentCalendar>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DisplayColor(struct struct_Windows_UI_Color* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_OtherAppReadAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppReadAccess* value) noexcept = 0;
    virtual HRESULT __stdcall put_OtherAppReadAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppReadAccess value) noexcept = 0;
    virtual HRESULT __stdcall get_OtherAppWriteAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppWriteAccess* value) noexcept = 0;
    virtual HRESULT __stdcall put_OtherAppWriteAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppWriteAccess value) noexcept = 0;
    virtual HRESULT __stdcall get_SourceDisplayName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SummaryCardView(Windows::ApplicationModel::Appointments::AppointmentSummaryCardView* value) noexcept = 0;
    virtual HRESULT __stdcall put_SummaryCardView(Windows::ApplicationModel::Appointments::AppointmentSummaryCardView value) noexcept = 0;
    virtual HRESULT __stdcall FindAppointmentsAsync(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindAppointmentsAsyncWithOptions(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, void* options, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindExceptionsFromMasterAsync(HSTRING masterLocalId, void** value) noexcept = 0;
    virtual HRESULT __stdcall FindAllInstancesAsync(HSTRING masterLocalId, Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, void** value) noexcept = 0;
    virtual HRESULT __stdcall FindAllInstancesAsyncWithOptions(HSTRING masterLocalId, Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, void* pOptions, void** value) noexcept = 0;
    virtual HRESULT __stdcall GetAppointmentAsync(HSTRING localId, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAppointmentInstanceAsync(HSTRING localId, Windows::Foundation::DateTime instanceStartTime, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindUnexpandedAppointmentsAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall FindUnexpandedAppointmentsAsyncWithOptions(void* options, void** result) noexcept = 0;
    ...
    virtual HRESULT __stdcall DeleteAppointmentAsync(HSTRING localId, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall DeleteAppointmentInstanceAsync(HSTRING localId, Windows::Foundation::DateTime instanceStartTime, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall SaveAppointmentAsync(void* pAppointment, void** asyncAction) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentCalendar2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_DisplayColor(struct struct_Windows_UI_Color value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_CanCreateOrUpdateAppointments(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_CanCreateOrUpdateAppointments(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_CanCancelMeetings(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_CanCancelMeetings(bool value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_CanNotifyInvitees(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_CanNotifyInvitees(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_MustNofityInvitees(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_MustNofityInvitees(bool value) noexcept = 0;
    virtual HRESULT __stdcall TryCreateOrUpdateAppointmentAsync(void* appointment, bool notifyInvitees, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryCancelMeetingAsync(void* meeting, HSTRING subject, HSTRING comment, bool notifyInvitees, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryForwardMeetingAsync(void* meeting, void* invitees, HSTRING subject, HSTRING forwardHeader, HSTRING comment, void** result) noexcept = 0;
    ...
    virtual HRESULT __stdcall TryUpdateMeetingResponseAsync(void* meeting, Windows::ApplicationModel::Appointments::AppointmentParticipantResponse response, HSTRING subject, HSTRING comment, bool sendUpdate, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Appointments::AppointmentCalendarSyncStatus* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall put_Status(Windows::ApplicationModel::Appointments::AppointmentCalendarSyncStatus value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Type(Windows::ApplicationModel::Appointments::AppointmentConflictType* value) noexcept = 0;
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentException>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ExceptionProperties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDeleted(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentInvitee>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Role(Windows::ApplicationModel::Appointments::AppointmentParticipantRole* value) noexcept = 0;
    virtual HRESULT __stdcall put_Role(Windows::ApplicationModel::Appointments::AppointmentParticipantRole value) noexcept = 0;
    virtual HRESULT __stdcall get_Response(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse* value) noexcept = 0;
    virtual HRESULT __stdcall put_Response(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentManagerForUser>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ShowAddAppointmentAsync(void* appointment, Windows::Foundation::Rect selection, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowAddAppointmentWithPlacementAsync(void* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentAsync(HSTRING appointmentId, void* appointment, Windows::Foundation::Rect selection, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAsync(HSTRING appointmentId, void* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, void* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowTimeFrameAsync(Windows::Foundation::DateTime timeToShow, Windows::Foundation::TimeSpan duration, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsAsync(HSTRING appointmentId, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsWithDateAsync(HSTRING appointmentId, Windows::Foundation::DateTime instanceStartDate, void** result) noexcept = 0;
    virtual HRESULT __stdcall ShowEditNewAppointmentAsync(void* appointment, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestStoreAsync(Windows::ApplicationModel::Appointments::AppointmentStoreAccessType options, void** result) noexcept = 0;
...
{
    virtual HRESULT __stdcall ShowAddAppointmentAsync(void* appointment, Windows::Foundation::Rect selection, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowAddAppointmentWithPlacementAsync(void* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentAsync(HSTRING appointmentId, void* appointment, Windows::Foundation::Rect selection, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAsync(HSTRING appointmentId, void* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, void* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowTimeFrameAsync(Windows::Foundation::DateTime timeToShow, Windows::Foundation::TimeSpan duration, void** asyncAction) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentManagerStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ShowAppointmentDetailsAsync(HSTRING appointmentId, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsWithDateAsync(HSTRING appointmentId, Windows::Foundation::DateTime instanceStartDate, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall ShowEditNewAppointmentAsync(void* appointment, void** operation) noexcept = 0;
    virtual HRESULT __stdcall RequestStoreAsync(Windows::ApplicationModel::Appointments::AppointmentStoreAccessType options, void** operation) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentPropertiesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Subject(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Location(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_StartTime(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Duration(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Reminder(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BusyStatus(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sensitivity(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_OriginalStartTime(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsResponseRequested(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AllowNewTimeProposal(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AllDay(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Details(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_OnlineMeetingLink(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ReplyTime(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Organizer(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_UserResponse(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HasInvitees(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCanceledMeeting(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsOrganizedByUser(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Recurrence(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Uri(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Invitees(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DefaultProperties(void** value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentPropertiesStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ChangeNumber(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RemoteChangeNumber(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DetailsKind(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentRecurrence>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Unit(Windows::ApplicationModel::Appointments::AppointmentRecurrenceUnit* value) noexcept = 0;
    virtual HRESULT __stdcall put_Unit(Windows::ApplicationModel::Appointments::AppointmentRecurrenceUnit value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_Interval(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_Interval(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_DaysOfWeek(Windows::ApplicationModel::Appointments::AppointmentDaysOfWeek* value) noexcept = 0;
    virtual HRESULT __stdcall put_DaysOfWeek(Windows::ApplicationModel::Appointments::AppointmentDaysOfWeek value) noexcept = 0;
    virtual HRESULT __stdcall get_WeekOfMonth(Windows::ApplicationModel::Appointments::AppointmentWeekOfMonth* value) noexcept = 0;
    virtual HRESULT __stdcall put_WeekOfMonth(Windows::ApplicationModel::Appointments::AppointmentWeekOfMonth value) noexcept = 0;
    virtual HRESULT __stdcall get_Month(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_Month(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_Day(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_Day(uint32_t value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentRecurrence2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_RecurrenceType(Windows::ApplicationModel::Appointments::RecurrenceType* value) noexcept = 0;
    virtual HRESULT __stdcall get_TimeZone(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_TimeZone(HSTRING value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentStore>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall CreateAppointmentCalendarAsync(HSTRING name, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetAppointmentCalendarAsync(HSTRING calendarId, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAppointmentAsync(HSTRING localId, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAppointmentInstanceAsync(HSTRING localId, Windows::Foundation::DateTime instanceStartTime, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindAppointmentCalendarsAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall FindAppointmentCalendarsAsyncWithOptions(Windows::ApplicationModel::Appointments::FindAppointmentCalendarsOptions options, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindAppointmentsAsync(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindAppointmentsAsyncWithOptions(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, void* options, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindConflictAsync(void* appointment, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindConflictAsyncWithInstanceStart(void* appointment, Windows::Foundation::DateTime instanceStartTime, void** result) noexcept = 0;
    virtual HRESULT __stdcall MoveAppointmentAsync(void* appointment, void* destinationCalendar, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall ShowAddAppointmentAsync(void* appointment, Windows::Foundation::Rect selection, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentAsync(HSTRING localId, void* appointment, Windows::Foundation::Rect selection, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(HSTRING localId, void* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentAsync(HSTRING localId, Windows::Foundation::Rect selection, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAndDateAsync(HSTRING localId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsAsync(HSTRING localId, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsWithDateAsync(HSTRING localId, Windows::Foundation::DateTime instanceStartDate, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall ShowEditNewAppointmentAsync(void* appointment, void** operation) noexcept = 0;
    virtual HRESULT __stdcall FindLocalIdsFromRoamingIdAsync(HSTRING roamingId, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentStore2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_StoreChanged(void* pHandler, event_token* pToken) noexcept = 0;
    virtual HRESULT __stdcall remove_StoreChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall CreateAppointmentCalendarInAccountAsync(HSTRING name, HSTRING userDataAccountId, void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Appointment(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ChangeType(Windows::ApplicationModel::Appointments::AppointmentStoreChangeType* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentStoreChange2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AppointmentCalendar(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_CalendarIds(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_FetchProperties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IncludeHidden(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IncludeHidden(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxCount(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_MaxCount(uint32_t value) noexcept = 0;
};};
