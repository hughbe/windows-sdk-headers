...
{
    virtual HRESULT __stdcall get_Condition(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Condition(void* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall Create(void* compositor, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_InteractionSources(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IsPositionRoundingSuggested(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxPosition(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall put_MaxPosition(Windows::Foundation::Numerics::float3 value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxScale(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_MaxScale(float value) noexcept = 0;
    virtual HRESULT __stdcall get_MinPosition(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall put_MinPosition(Windows::Foundation::Numerics::float3 value) noexcept = 0;
    virtual HRESULT __stdcall get_MinScale(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_MinScale(float value) noexcept = 0;
    virtual HRESULT __stdcall get_NaturalRestingPosition(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_NaturalRestingScale(float* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_PositionInertiaDecayRate(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionInertiaDecayRate(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionVelocityInPixelsPerSecond(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_Scale(float* value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleInertiaDecayRate(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ScaleInertiaDecayRate(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleVelocityInPercentPerSecond(float* value) noexcept = 0;
    virtual HRESULT __stdcall AdjustPositionXIfGreaterThanThreshold(float adjustment, float positionThreshold) noexcept = 0;
    virtual HRESULT __stdcall AdjustPositionYIfGreaterThanThreshold(float adjustment, float positionThreshold) noexcept = 0;
    virtual HRESULT __stdcall ConfigurePositionXInertiaModifiers(void* modifiers) noexcept = 0;
    virtual HRESULT __stdcall ConfigurePositionYInertiaModifiers(void* modifiers) noexcept = 0;
    virtual HRESULT __stdcall ConfigureScaleInertiaModifiers(void* modifiers) noexcept = 0;
    virtual HRESULT __stdcall TryUpdatePosition(Windows::Foundation::Numerics::float3 value, int32_t* requestId) noexcept = 0;
    virtual HRESULT __stdcall TryUpdatePositionBy(Windows::Foundation::Numerics::float3 amount, int32_t* requestId) noexcept = 0;
    virtual HRESULT __stdcall TryUpdatePositionWithAnimation(void* animation, int32_t* requestId) noexcept = 0;
    virtual HRESULT __stdcall TryUpdatePositionWithAdditionalVelocity(Windows::Foundation::Numerics::float3 velocityInPixelsPerSecond, int32_t* requestId) noexcept = 0;
    virtual HRESULT __stdcall TryUpdateScale(float value, Windows::Foundation::Numerics::float3 centerPoint, int32_t* requestId) noexcept = 0;
    virtual HRESULT __stdcall TryUpdateScaleWithAnimation(void* animation, Windows::Foundation::Numerics::float3 centerPoint, int32_t* requestId) noexcept = 0;
    virtual HRESULT __stdcall TryUpdateScaleWithAdditionalVelocity(float velocityInPercentPerSecond, Windows::Foundation::Numerics::float3 centerPoint, int32_t* requestId) noexcept = 0;
};};

template <> struct abi<Windows::UI::Composition::Interactions::IInteractionTracker2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ConfigureCenterPointXInertiaModifiers(void* conditionalValues) noexcept = 0;
    virtual HRESULT __stdcall ConfigureCenterPointYInertiaModifiers(void* conditionalValues) noexcept = 0;
};};

template <> struct abi<Windows::UI::Composition::Interactions::IInteractionTracker3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ConfigureVector2PositionInertiaModifiers(void* modifiers) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_RequestId(int32_t* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Composition::Interactions::IInteractionTrackerInertiaMotion>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Condition(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Condition(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Motion(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Motion(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Composition::Interactions::IInteractionTrackerInertiaNaturalMotion>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Condition(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Condition(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_NaturalMotion(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_NaturalMotion(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Composition::Interactions::IInteractionTrackerInertiaRestingValue>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Condition(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Condition(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_RestingValue(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_RestingValue(void* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ModifiedRestingPosition(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ModifiedRestingScale(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_NaturalRestingPosition(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_NaturalRestingScale(float* value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionVelocityInPixelsPerSecond(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_RequestId(int32_t* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall CustomAnimationStateEntered(void* sender, void* args) noexcept = 0;
    virtual HRESULT __stdcall IdleStateEntered(void* sender, void* args) noexcept = 0;
    virtual HRESULT __stdcall InertiaStateEntered(void* sender, void* args) noexcept = 0;
    virtual HRESULT __stdcall InteractingStateEntered(void* sender, void* args) noexcept = 0;
    virtual HRESULT __stdcall RequestIgnored(void* sender, void* args) noexcept = 0;
    virtual HRESULT __stdcall ValuesChanged(void* sender, void* args) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Create(void* compositor, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateWithOwner(void* compositor, void* owner, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_IsPositionXRailsEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsPositionXRailsEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsPositionYRailsEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsPositionYRailsEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_ManipulationRedirectionMode(Windows::UI::Composition::Interactions::VisualInteractionSourceRedirectionMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_ManipulationRedirectionMode(Windows::UI::Composition::Interactions::VisualInteractionSourceRedirectionMode value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionXChainingMode(Windows::UI::Composition::Interactions::InteractionChainingMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionXChainingMode(Windows::UI::Composition::Interactions::InteractionChainingMode value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionXSourceMode(Windows::UI::Composition::Interactions::InteractionSourceMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionXSourceMode(Windows::UI::Composition::Interactions::InteractionSourceMode value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionYChainingMode(Windows::UI::Composition::Interactions::InteractionChainingMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionYChainingMode(Windows::UI::Composition::Interactions::InteractionChainingMode value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionYSourceMode(Windows::UI::Composition::Interactions::InteractionSourceMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionYSourceMode(Windows::UI::Composition::Interactions::InteractionSourceMode value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleChainingMode(Windows::UI::Composition::Interactions::InteractionChainingMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_ScaleChainingMode(Windows::UI::Composition::Interactions::InteractionChainingMode value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleSourceMode(Windows::UI::Composition::Interactions::InteractionSourceMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_ScaleSourceMode(Windows::UI::Composition::Interactions::InteractionSourceMode value) noexcept = 0;
    virtual HRESULT __stdcall get_Source(void** value) noexcept = 0;
    virtual HRESULT __stdcall TryRedirectForManipulation(void* pointerPoint) noexcept = 0;
};};

template <> struct abi<Windows::UI::Composition::Interactions::IVisualInteractionSource2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DeltaPosition(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeltaScale(float* value) noexcept = 0;
    virtual HRESULT __stdcall get_Position(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionVelocity(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_Scale(float* value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleVelocity(float* value) noexcept = 0;
    virtual HRESULT __stdcall ConfigureCenterPointXModifiers(void* conditionalValues) noexcept = 0;
    virtual HRESULT __stdcall ConfigureCenterPointYModifiers(void* conditionalValues) noexcept = 0;
    virtual HRESULT __stdcall ConfigureDeltaPositionXModifiers(void* conditionalValues) noexcept = 0;
    virtual HRESULT __stdcall ConfigureDeltaPositionYModifiers(void* conditionalValues) noexcept = 0;
    virtual HRESULT __stdcall ConfigureDeltaScaleModifiers(void* conditionalValues) noexcept = 0;
};};
