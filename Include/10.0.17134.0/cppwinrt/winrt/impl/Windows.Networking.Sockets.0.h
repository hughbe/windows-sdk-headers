...
template <> struct guid<Windows::Networking::Sockets::IMessageWebSocket3>{ static constexpr GUID value{ 0x59D9DEFB,0x71AF,0x4349,{ 0x84,0x87,0x91,0x1F,0xCF,0x68,0x15,0x97 } }; };
...
template <> struct guid<Windows::Networking::Sockets::IServerMessageWebSocket>{ static constexpr GUID value{ 0xE3AC9240,0x813B,0x5EFD,{ 0x7E,0x11,0xAE,0x23,0x05,0xFC,0x77,0xF1 } }; };
template <> struct guid<Windows::Networking::Sockets::IServerMessageWebSocketControl>{ static constexpr GUID value{ 0x69C2F051,0x1C1F,0x587A,{ 0x45,0x19,0x21,0x81,0x61,0x01,0x92,0xB7 } }; };
template <> struct guid<Windows::Networking::Sockets::IServerMessageWebSocketInformation>{ static constexpr GUID value{ 0xFC32B45F,0x4448,0x5505,{ 0x6C,0xC9,0x09,0xAF,0xA8,0x91,0x5F,0x5D } }; };
template <> struct guid<Windows::Networking::Sockets::IServerStreamWebSocket>{ static constexpr GUID value{ 0x2CED5BBF,0x74F6,0x55E4,{ 0x79,0xDF,0x91,0x32,0x68,0x0D,0xFE,0xE8 } }; };
template <> struct guid<Windows::Networking::Sockets::IServerStreamWebSocketInformation>{ static constexpr GUID value{ 0xFC32B45F,0x4448,0x5505,{ 0x6C,0xC9,0x09,0xAB,0xA8,0x91,0x5F,0x5D } }; };
...
{
    event_token MessageReceived(Windows::Foundation::TypedEventHandler<Windows::Networking::Sockets::ServerMessageWebSocket, Windows::Networking::Sockets::MessageWebSocketMessageReceivedEventArgs> const& value) const;
    using MessageReceived_revoker = event_revoker<Windows::Networking::Sockets::IServerMessageWebSocket>;
    ...
    Windows::Storage::Streams::IOutputStream OutputStream() const;
    event_token Closed(Windows::Foundation::TypedEventHandler<Windows::Networking::Sockets::ServerMessageWebSocket, Windows::Networking::Sockets::WebSocketClosedEventArgs> const& value) const;
    using Closed_revoker = event_revoker<Windows::Networking::Sockets::IServerMessageWebSocket>;
...
struct consume_Windows_Networking_Sockets_IServerStreamWebSocket
{
    ...
    Windows::Storage::Streams::IOutputStream OutputStream() const;
    event_token Closed(Windows::Foundation::TypedEventHandler<Windows::Networking::Sockets::ServerStreamWebSocket, Windows::Networking::Sockets::WebSocketClosedEventArgs> const& value) const;
    using Closed_revoker = event_revoker<Windows::Networking::Sockets::IServerStreamWebSocket>;
...
{
    virtual HRESULT __stdcall get_ControlChannelTriggerId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ServerKeepAliveIntervalInMinutes(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_ServerKeepAliveIntervalInMinutes(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CurrentKeepAliveIntervalInMinutes(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TransportObject(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_KeepAliveTrigger(void** trigger) noexcept = 0;
    virtual HRESULT __stdcall get_PushNotificationTrigger(void** trigger) noexcept = 0;
    virtual HRESULT __stdcall UsingTransport(void* transport) noexcept = 0;
    virtual HRESULT __stdcall WaitForPushEnabled(Windows::Networking::Sockets::ControlChannelTriggerStatus* channelTriggerStatus) noexcept = 0;
    virtual HRESULT __stdcall DecreaseNetworkKeepAliveInterval() noexcept = 0;
    virtual HRESULT __stdcall FlushTransport() noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ControlChannelTrigger(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IControlChannelTriggerFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateControlChannelTrigger(HSTRING channelId, uint32_t serverKeepAliveIntervalInMinutes, void** notificationChannel) noexcept = 0;
    virtual HRESULT __stdcall CreateControlChannelTriggerEx(HSTRING channelId, uint32_t serverKeepAliveIntervalInMinutes, Windows::Networking::Sockets::ControlChannelTriggerResourceType resourceRequestType, void** notificationChannel) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IControlChannelTriggerResetEventDetails>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ResetReason(Windows::Networking::Sockets::ControlChannelTriggerResetReason* value) noexcept = 0;
    virtual HRESULT __stdcall get_HardwareSlotReset(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SoftwareSlotReset(bool* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IDatagramSocket>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Information(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_OutputStream(void** value) noexcept = 0;
    virtual HRESULT __stdcall ConnectAsync(void* remoteHostName, HSTRING remoteServiceName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ConnectWithEndpointPairAsync(void* endpointPair, void** operation) noexcept = 0;
    virtual HRESULT __stdcall BindServiceNameAsync(HSTRING localServiceName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall BindEndpointAsync(void* localHostName, HSTRING localServiceName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall JoinMulticastGroup(void* host) noexcept = 0;
    virtual HRESULT __stdcall GetOutputStreamAsync(void* remoteHostName, HSTRING remoteServiceName, void** value) noexcept = 0;
    virtual HRESULT __stdcall GetOutputStreamWithEndpointPairAsync(void* endpointPair, void** value) noexcept = 0;
...
{
    virtual HRESULT __stdcall BindServiceNameAndAdapterAsync(HSTRING localServiceName, void* adapter, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IDatagramSocket3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CancelIOAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall EnableTransferOwnership(GUID taskId) noexcept = 0;
    virtual HRESULT __stdcall EnableTransferOwnershipWithConnectedStandbyAction(GUID taskId, Windows::Networking::Sockets::SocketActivityConnectedStandbyAction connectedStandbyAction) noexcept = 0;
    virtual HRESULT __stdcall TransferOwnership(HSTRING socketId) noexcept = 0;
    virtual HRESULT __stdcall TransferOwnershipWithContext(HSTRING socketId, void* data) noexcept = 0;
    virtual HRESULT __stdcall TransferOwnershipWithContextAndKeepAliveTime(HSTRING socketId, void* data, Windows::Foundation::TimeSpan keepAliveTime) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IDatagramSocketControl>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_QualityOfService(Windows::Networking::Sockets::SocketQualityOfService* value) noexcept = 0;
    virtual HRESULT __stdcall put_QualityOfService(Windows::Networking::Sockets::SocketQualityOfService value) noexcept = 0;
    virtual HRESULT __stdcall get_OutboundUnicastHopLimit(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_OutboundUnicastHopLimit(uint8_t value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IDatagramSocketControl2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InboundBufferSizeInBytes(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_InboundBufferSizeInBytes(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_DontFragment(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_DontFragment(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IDatagramSocketControl3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_MulticastOnly(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_MulticastOnly(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IDatagramSocketInformation>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_LocalAddress(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalPort(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RemoteAddress(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RemotePort(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IDatagramSocketMessageReceivedEventArgs>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_RemotePort(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalAddress(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetDataReader(void** dataReader) noexcept = 0;
    virtual HRESULT __stdcall GetDataStream(void** inputStream) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IDatagramSocketStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetEndpointPairsAsync(void* remoteHostName, HSTRING remoteServiceName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetEndpointPairsWithSortOptionsAsync(void* remoteHostName, HSTRING remoteServiceName, Windows::Networking::HostNameSortOptions sortOptions, void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall SendNonfinalFrameAsync(void* data, void** operation) noexcept = 0;
    virtual HRESULT __stdcall SendFinalFrameAsync(void* data, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IMessageWebSocketControl>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_MaxMessageSize(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_MaxMessageSize(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_MessageType(Windows::Networking::Sockets::SocketMessageType* value) noexcept = 0;
    virtual HRESULT __stdcall put_MessageType(Windows::Networking::Sockets::SocketMessageType value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IMessageWebSocketControl2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DesiredUnsolicitedPongInterval(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredUnsolicitedPongInterval(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_ActualUnsolicitedPongInterval(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall get_ReceiveMode(Windows::Networking::Sockets::MessageWebSocketReceiveMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_ReceiveMode(Windows::Networking::Sockets::MessageWebSocketReceiveMode value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_IsMessageComplete(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IServerMessageWebSocket>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_MessageReceived(void* value, event_token* token) noexcept = 0;
    ...
    virtual HRESULT __stdcall CloseWithStatus(uint16_t code, HSTRING reason) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_BandwidthStatistics(struct struct_Windows_Networking_Sockets_BandwidthStatistics* value) noexcept = 0;
    virtual HRESULT __stdcall get_Protocol(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalAddress(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Create(void* data, void** context) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::ISocketActivityInformation>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_SocketKind(Windows::Networking::Sockets::SocketActivityKind* value) noexcept = 0;
    virtual HRESULT __stdcall get_Context(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DatagramSocket(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_StreamSocket(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_StreamSocketListener(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::ISocketActivityInformationStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AllSockets(void** sockets) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::ISocketActivityTriggerDetails>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Reason(Windows::Networking::Sockets::SocketActivityTriggerReason* value) noexcept = 0;
    virtual HRESULT __stdcall get_SocketInformation(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::ISocketErrorStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetStatus(int32_t hresult, Windows::Networking::Sockets::SocketErrorStatus* status) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IStreamSocket>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall ConnectWithEndpointPairAsync(void* endpointPair, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ConnectAsync(void* remoteHostName, HSTRING remoteServiceName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ConnectWithEndpointPairAndProtectionLevelAsync(void* endpointPair, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ConnectWithProtectionLevelAsync(void* remoteHostName, HSTRING remoteServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, void** operation) noexcept = 0;
    virtual HRESULT __stdcall UpgradeToSslAsync(Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, void* validationHostName, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IStreamSocket2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ConnectWithProtectionLevelAndAdapterAsync(void* remoteHostName, HSTRING remoteServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, void* adapter, void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_NoDelay(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_NoDelay(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_KeepAlive(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeepAlive(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_OutboundBufferSizeInBytes(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_OutboundBufferSizeInBytes(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_QualityOfService(Windows::Networking::Sockets::SocketQualityOfService* value) noexcept = 0;
    virtual HRESULT __stdcall put_QualityOfService(Windows::Networking::Sockets::SocketQualityOfService value) noexcept = 0;
    virtual HRESULT __stdcall get_OutboundUnicastHopLimit(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_OutboundUnicastHopLimit(uint8_t value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_SerializeConnectionAttempts(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_SerializeConnectionAttempts(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_ClientCertificate(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ClientCertificate(void* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_MinProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel* value) noexcept = 0;
    virtual HRESULT __stdcall put_MinProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel value) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IStreamSocketInformation>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_RemotePort(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RoundTripTimeStatistics(struct struct_Windows_Networking_Sockets_RoundTripTimeStatistics* value) noexcept = 0;
    virtual HRESULT __stdcall get_BandwidthStatistics(struct struct_Windows_Networking_Sockets_BandwidthStatistics* value) noexcept = 0;
    virtual HRESULT __stdcall get_ProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel* value) noexcept = 0;
    virtual HRESULT __stdcall get_SessionKey(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IStreamSocketListener>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall BindServiceNameAsync(HSTRING localServiceName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall BindEndpointAsync(void* localHostName, HSTRING localServiceName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall add_ConnectionReceived(void* eventHandler, event_token* eventCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_ConnectionReceived(event_token eventCookie) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IStreamSocketListener2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall BindServiceNameWithProtectionLevelAsync(HSTRING localServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, void** operation) noexcept = 0;
    virtual HRESULT __stdcall BindServiceNameWithProtectionLevelAndAdapterAsync(HSTRING localServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, void* adapter, void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_OutputStream(void** value) noexcept = 0;
    virtual HRESULT __stdcall ConnectAsync(void* uri, void** operation) noexcept = 0;
    virtual HRESULT __stdcall SetRequestHeader(HSTRING headerName, HSTRING headerValue) noexcept = 0;
    virtual HRESULT __stdcall add_Closed(void* eventHandler, event_token* eventCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_Closed(event_token eventCookie) noexcept = 0;
    virtual HRESULT __stdcall CloseWithStatus(uint16_t code, HSTRING reason) noexcept = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IWebSocketClosedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Code(uint16_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Reason(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IWebSocketControl>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_SupportedProtocols(void** value) noexcept = 0;
};};
