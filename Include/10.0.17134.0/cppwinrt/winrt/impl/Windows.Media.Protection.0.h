...
template <> struct abi<Windows::Media::Protection::IComponentLoadFailedEventArgs>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Completion(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IComponentRenewalStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RenewSystemComponentsAsync(void* information, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IHdcpSession>{ struct type : IInspectable
{
    virtual HRESULT __stdcall IsEffectiveProtectionAtLeast(Windows::Media::Protection::HdcpProtection protection, bool* value) noexcept = 0;
    virtual HRESULT __stdcall GetEffectiveProtection(void** value) noexcept = 0;
    virtual HRESULT __stdcall SetDesiredMinProtectionAsync(Windows::Media::Protection::HdcpProtection protection, void** value) noexcept = 0;
    virtual HRESULT __stdcall add_ProtectionChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ProtectionChanged(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IMediaProtectionManager>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_ServiceRequested(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_ServiceRequested(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_RebootNeeded(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_RebootNeeded(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_ComponentLoadFailed(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_ComponentLoadFailed(event_token cookie) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Properties(void** ppProperties) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IMediaProtectionPMPServerFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreatePMPServer(void* pProperties, void** ppObject) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IMediaProtectionServiceCompletion>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Complete(bool success) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IMediaProtectionServiceRequest>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ProtectionSystem(GUID* system) noexcept = 0;
    virtual HRESULT __stdcall get_Type(GUID* type) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IProtectionCapabilities>{ struct type : IInspectable
{
    virtual HRESULT __stdcall IsTypeSupported(HSTRING type, HSTRING keySystem, Windows::Media::Protection::ProtectionCapabilityResult* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IRevocationAndRenewalInformation>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Items(void** items) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::IRevocationAndRenewalItem>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Reasons(Windows::Media::Protection::RevocationAndRenewalReasons* reasons) noexcept = 0;
    virtual HRESULT __stdcall get_HeaderHash(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_PublicKeyHash(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Name(HSTRING* name) noexcept = 0;
    virtual HRESULT __stdcall get_RenewalId(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_MediaPlaybackItem(void** value) noexcept = 0;
};};
