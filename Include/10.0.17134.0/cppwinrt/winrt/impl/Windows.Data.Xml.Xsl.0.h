...
{
    virtual HRESULT __stdcall TransformToString(void* inputNode, HSTRING* output) noexcept = 0;
};};

template <> struct abi<Windows::Data::Xml::Xsl::IXsltProcessor2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TransformToDocument(void* inputNode, void** output) noexcept = 0;
};};

template <> struct abi<Windows::Data::Xml::Xsl::IXsltProcessorFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(void* document, void** xsltProcessor) noexcept = 0;
};};
