...
{
    virtual HRESULT __stdcall get_ActivatedOperation(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Content(Windows::UI::WebUI::PrintContent* value) noexcept = 0;
    virtual HRESULT __stdcall put_Content(Windows::UI::WebUI::PrintContent value) noexcept = 0;
    virtual HRESULT __stdcall get_LeftMargin(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_LeftMargin(float value) noexcept = 0;
    virtual HRESULT __stdcall get_TopMargin(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_TopMargin(float value) noexcept = 0;
    virtual HRESULT __stdcall get_RightMargin(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_RightMargin(float value) noexcept = 0;
    virtual HRESULT __stdcall get_BottomMargin(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_BottomMargin(float value) noexcept = 0;
    virtual HRESULT __stdcall get_EnableHeaderFooter(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_EnableHeaderFooter(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_ShrinkToFit(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_ShrinkToFit(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_PercentScale(float* pScalePercent) noexcept = 0;
    virtual HRESULT __stdcall put_PercentScale(float scalePercent) noexcept = 0;
    virtual HRESULT __stdcall get_PageRange(HSTRING* pstrPageRange) noexcept = 0;
    virtual HRESULT __stdcall TrySetPageRange(HSTRING strPageRange, bool* pfSuccess) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::WebUI::IWebUIActivationStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_Navigated(void* handler, event_token* token) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Succeeded(bool* succeeded) noexcept = 0;
    virtual HRESULT __stdcall put_Succeeded(bool succeeded) noexcept = 0;
};};

template <> struct abi<Windows::UI::WebUI::IWebUIBackgroundTaskInstanceStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Current(void** backgroundTaskInstance) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_NavigatedOperation(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Invoke(void* sender, void* eventArgs) noexcept = 0;
};};
