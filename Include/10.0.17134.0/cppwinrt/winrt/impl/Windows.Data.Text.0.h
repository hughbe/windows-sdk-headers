...
{
    virtual HRESULT __stdcall get_SourceTextSegment(struct struct_Windows_Data_Text_TextSegment* value) noexcept = 0;
    virtual HRESULT __stdcall get_AlternateText(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NormalizationFormat(Windows::Data::Text::AlternateNormalizationFormat* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Data::Text::ISelectableWordsSegmenter>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall GetTokenAt(HSTRING text, uint32_t startIndex, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetTokens(HSTRING text, void** result) noexcept = 0;
    virtual HRESULT __stdcall Tokenize(HSTRING text, uint32_t startIndex, void* handler) noexcept = 0;
};};

template <> struct abi<Windows::Data::Text::ISelectableWordsSegmenterFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateWithLanguage(HSTRING language, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Data::Text::ISemanticTextQuery>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Find(HSTRING content, void** result) noexcept = 0;
    virtual HRESULT __stdcall FindInProperty(HSTRING propertyContent, HSTRING propertyName, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Data::Text::ISemanticTextQueryFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(HSTRING aqsFilter, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateWithLanguage(HSTRING aqsFilter, HSTRING filterLanguage, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Data::Text::ITextConversionGenerator>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ResolvedLanguage(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_LanguageAvailableButNotInstalled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall GetCandidatesAsync(HSTRING input, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetCandidatesWithMaxCountAsync(HSTRING input, uint32_t maxCandidates, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Data::Text::ITextConversionGeneratorFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(HSTRING languageTag, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Data::Text::ITextPhoneme>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ReadingText(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Data::Text::ITextReverseConversionGenerator>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ResolvedLanguage(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_LanguageAvailableButNotInstalled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall ConvertBackAsync(HSTRING input, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Data::Text::ITextReverseConversionGenerator2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetPhonemesAsync(HSTRING input, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetCodepointFromSurrogatePair(uint32_t highSurrogate, uint32_t lowSurrogate, uint32_t* codepoint) noexcept = 0;
    virtual HRESULT __stdcall GetSurrogatePairFromCodepoint(uint32_t codepoint, char16_t* highSurrogate, char16_t* lowSurrogate) noexcept = 0;
    virtual HRESULT __stdcall IsHighSurrogate(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsLowSurrogate(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsSupplementary(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsNoncharacter(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsWhitespace(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsAlphabetic(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsCased(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsUppercase(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsLowercase(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsIdStart(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsIdContinue(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsGraphemeBase(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall IsGraphemeExtend(uint32_t codepoint, bool* value) noexcept = 0;
    virtual HRESULT __stdcall GetNumericType(uint32_t codepoint, Windows::Data::Text::UnicodeNumericType* value) noexcept = 0;
    virtual HRESULT __stdcall GetGeneralCategory(uint32_t codepoint, Windows::Data::Text::UnicodeGeneralCategory* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Data::Text::IWordSegment>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Text(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SourceTextSegment(struct struct_Windows_Data_Text_TextSegment* value) noexcept = 0;
    virtual HRESULT __stdcall get_AlternateForms(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Invoke(void* precedingWords, void* words) noexcept = 0;
};};
