...
template <> struct abi<Windows::UI::Xaml::Navigation::INavigatingCancelEventArgs>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_NavigationMode(Windows::UI::Xaml::Navigation::NavigationMode* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Parameter(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_NavigationTransitionInfo(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstance(struct struct_Windows_UI_Xaml_Interop_TypeName sourcePageType, void* parameter, void* navigationTransitionInfo, void** instance) noexcept = 0;
};};
