...
template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtension>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall GetExtensionPropertiesAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetPublicFolderAsync(void** operation) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall RequestRemovePackageAsync(HSTRING packageFullName, void** operation) noexcept = 0;
    virtual HRESULT __stdcall add_PackageInstalled(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_PackageInstalled(event_token token) noexcept = 0;
    ...
    virtual HRESULT __stdcall add_PackageUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_PackageUpdated(event_token token) noexcept = 0;
...
{
    virtual HRESULT __stdcall Open(HSTRING appExtensionName, void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_AppExtensionName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Package(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Extensions(void** values) noexcept = 0;
};};
