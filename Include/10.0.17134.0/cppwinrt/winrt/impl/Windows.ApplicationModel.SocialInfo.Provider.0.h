...
{
    virtual HRESULT __stdcall get_OwnerRemoteId(HSTRING* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_OwnerRemoteId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::SocialInfo::SocialFeedKind* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall CreateSocialFeedUpdaterAsync(Windows::ApplicationModel::SocialInfo::SocialFeedKind kind, Windows::ApplicationModel::SocialInfo::SocialFeedUpdateMode mode, HSTRING ownerRemoteId, void** operation) noexcept = 0;
    virtual HRESULT __stdcall CreateDashboardItemUpdaterAsync(HSTRING ownerRemoteId, void** operation) noexcept = 0;
    virtual HRESULT __stdcall UpdateBadgeCountValue(HSTRING itemRemoteId, int32_t newCount) noexcept = 0;
    virtual HRESULT __stdcall ReportNewContentAvailable(HSTRING contactRemoteId, Windows::ApplicationModel::SocialInfo::SocialFeedKind kind) noexcept = 0;
    virtual HRESULT __stdcall ProvisionAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall DeprovisionAsync(void** operation) noexcept = 0;
};};
