...
template <> struct abi<Windows::UI::Xaml::Media::Media3D::ICompositeTransform3D>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_CenterZ(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_CenterZ(double value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_ScaleZ(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_ScaleZ(double value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_TranslateZ(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_TranslateZ(double value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::Media3D::ICompositeTransform3DStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_CenterZProperty(void** value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_ScaleZProperty(void** value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_TranslateZProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Identity(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D* value) noexcept = 0;
    virtual HRESULT __stdcall Multiply(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D matrix1, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D matrix2, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D* returnValue) noexcept = 0;
    virtual HRESULT __stdcall FromElements(double m11, double m12, double m13, double m14, double m21, double m22, double m23, double m24, double m31, double m32, double m33, double m34, double offsetX, double offsetY, double offsetZ, double m44, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetHasInverse(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D target, bool* value) noexcept = 0;
    virtual HRESULT __stdcall GetIsIdentity(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D target, bool* value) noexcept = 0;
    virtual HRESULT __stdcall Invert(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D target, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::Media3D::IPerspectiveTransform3D>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Depth(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Depth(double value) noexcept = 0;
    virtual HRESULT __stdcall get_OffsetX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_OffsetX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_OffsetY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_OffsetY(double value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::Media3D::IPerspectiveTransform3DStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_OffsetXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_OffsetYProperty(void** value) noexcept = 0;
};};
