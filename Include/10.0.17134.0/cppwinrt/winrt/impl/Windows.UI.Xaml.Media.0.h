...
template <> struct guid<Windows::UI::Xaml::Media::ICompositionTargetStatics3>{ static constexpr GUID value{ 0xBC0A7CD9,0x6750,0x4708,{ 0x99,0x4C,0x20,0x28,0xE0,0x31,0x2A,0xC8 } }; };
...
template <> struct guid<Windows::UI::Xaml::Media::IRenderedEventArgs>{ static constexpr GUID value{ 0xE349817D,0x81C7,0x4938,{ 0x82,0x8C,0xA7,0xE2,0x79,0x7B,0x35,0xA6 } }; };
...
{
    event_token Rendered(Windows::Foundation::EventHandler<Windows::UI::Xaml::Media::RenderedEventArgs> const& value) const;
    using Rendered_revoker = event_revoker<Windows::UI::Xaml::Media::ICompositionTargetStatics3>;
    Rendered_revoker Rendered(auto_revoke_t, Windows::Foundation::EventHandler<Windows::UI::Xaml::Media::RenderedEventArgs> const& value) const;
    void Rendered(event_token const& token) const;
};
...
{
    virtual HRESULT __stdcall get_BackgroundSource(Windows::UI::Xaml::Media::AcrylicBackgroundSource* value) noexcept = 0;
    virtual HRESULT __stdcall put_BackgroundSource(Windows::UI::Xaml::Media::AcrylicBackgroundSource value) noexcept = 0;
    virtual HRESULT __stdcall get_TintColor(struct struct_Windows_UI_Color* result) noexcept = 0;
    virtual HRESULT __stdcall put_TintColor(struct struct_Windows_UI_Color value) noexcept = 0;
    virtual HRESULT __stdcall get_TintOpacity(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_TintOpacity(double value) noexcept = 0;
    virtual HRESULT __stdcall get_TintTransitionDuration(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_TintTransitionDuration(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallback(bool* result) noexcept = 0;
    virtual HRESULT __stdcall put_AlwaysUseFallback(bool value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_BackgroundSourceProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TintColorProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TintOpacityProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TintTransitionDurationProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallbackProperty(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IArcSegment>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Point(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_Point(Windows::Foundation::Point value) noexcept = 0;
    virtual HRESULT __stdcall get_Size(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall put_Size(Windows::Foundation::Size value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationAngle(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RotationAngle(double value) noexcept = 0;
    virtual HRESULT __stdcall get_IsLargeArc(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsLargeArc(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_SweepDirection(Windows::UI::Xaml::Media::SweepDirection* value) noexcept = 0;
    virtual HRESULT __stdcall put_SweepDirection(Windows::UI::Xaml::Media::SweepDirection value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IArcSegmentStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_PointProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SizeProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationAngleProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IsLargeArcProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SweepDirectionProperty(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IBezierSegment>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Point1(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_Point1(Windows::Foundation::Point value) noexcept = 0;
    virtual HRESULT __stdcall get_Point2(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_Point2(Windows::Foundation::Point value) noexcept = 0;
    virtual HRESULT __stdcall get_Point3(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_Point3(Windows::Foundation::Point value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IBezierSegmentStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Point1Property(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Point2Property(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Point3Property(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IBrush>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Transform(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Transform(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_RelativeTransform(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_RelativeTransform(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IBrushStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_TransformProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RelativeTransformProperty(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::ICompositeTransform>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_CenterX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_CenterY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_ScaleX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_ScaleY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_SkewX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_SkewX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_SkewY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_SkewY(double value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_TranslateX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_TranslateX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_TranslateY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_TranslateY(double value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::ICompositeTransformStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CenterXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ScaleYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SkewXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SkewYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TranslateXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TranslateYProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall add_Rendering(void* value, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_Rendering(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_SurfaceContentsLost(void* value, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SurfaceContentsLost(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::ICompositionTargetStatics3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_Rendered(void* value, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_Rendered(event_token token) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IEllipseGeometry>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Center(Windows::Foundation::Point value) noexcept = 0;
    virtual HRESULT __stdcall get_RadiusX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RadiusX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RadiusY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RadiusY(double value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IEllipseGeometryStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_RadiusXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RadiusYProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstanceWithName(HSTRING familyName, void* outer, void** inner, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IFontFamilyStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_XamlAutoFontFamily(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IGeneralTransform>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall TransformPoint(Windows::Foundation::Point point, Windows::Foundation::Point* returnValue) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_InverseCore(void** value) noexcept = 0;
    virtual HRESULT __stdcall TryTransformCore(Windows::Foundation::Point inPoint, Windows::Foundation::Point* outPoint, bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall TransformBoundsCore(Windows::Foundation::Rect rect, Windows::Foundation::Rect* returnValue) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_FillRule(Windows::UI::Xaml::Media::FillRule* value) noexcept = 0;
    virtual HRESULT __stdcall put_FillRule(Windows::UI::Xaml::Media::FillRule value) noexcept = 0;
    virtual HRESULT __stdcall get_Children(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Children(void* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IGeometryGroupStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_FillRuleProperty(void** value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Empty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_StandardFlatteningTolerance(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_TransformProperty(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IGradientBrush>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SpreadMethod(Windows::UI::Xaml::Media::GradientSpreadMethod* value) noexcept = 0;
    virtual HRESULT __stdcall put_SpreadMethod(Windows::UI::Xaml::Media::GradientSpreadMethod value) noexcept = 0;
    virtual HRESULT __stdcall get_MappingMode(Windows::UI::Xaml::Media::BrushMappingMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_MappingMode(Windows::UI::Xaml::Media::BrushMappingMode value) noexcept = 0;
    virtual HRESULT __stdcall get_ColorInterpolationMode(Windows::UI::Xaml::Media::ColorInterpolationMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_ColorInterpolationMode(Windows::UI::Xaml::Media::ColorInterpolationMode value) noexcept = 0;
    virtual HRESULT __stdcall get_GradientStops(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_GradientStops(void* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_SpreadMethodProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_MappingModeProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ColorInterpolationModeProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_GradientStopsProperty(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IGradientStop>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Offset(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Offset(double value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IGradientStopStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_OffsetProperty(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IImageBrush>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ImageSource(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ImageSource(void* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_ImageSourceProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_StartPoint(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_StartPoint(Windows::Foundation::Point value) noexcept = 0;
    virtual HRESULT __stdcall get_EndPoint(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_EndPoint(Windows::Foundation::Point value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::ILineGeometryStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_StartPointProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_EndPointProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstanceWithGradientStopCollectionAndAngle(void* gradientStopCollection, double angle, void** instance) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::UI::Xaml::Media::LoadedImageSourceLoadStatus* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::ILoadedImageSurface>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DecodedPhysicalSize(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_DecodedSize(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_NaturalSize(Windows::Foundation::Size* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall StartLoadFromUriWithSize(void* uri, Windows::Foundation::Size desiredMaxSize, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall StartLoadFromUri(void* uri, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall StartLoadFromStreamWithSize(void* stream, Windows::Foundation::Size desiredMaxSize, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall StartLoadFromStream(void* stream, void** returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IMatrix3DProjection>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ProjectionMatrix(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D* value) noexcept = 0;
    virtual HRESULT __stdcall put_ProjectionMatrix(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IMatrix3DProjectionStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ProjectionMatrixProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Identity(struct struct_Windows_UI_Xaml_Media_Matrix* value) noexcept = 0;
    virtual HRESULT __stdcall FromElements(double m11, double m12, double m21, double m22, double offsetX, double offsetY, struct struct_Windows_UI_Xaml_Media_Matrix* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetIsIdentity(struct struct_Windows_UI_Xaml_Media_Matrix target, bool* value) noexcept = 0;
    virtual HRESULT __stdcall Transform(struct struct_Windows_UI_Xaml_Media_Matrix target, Windows::Foundation::Point point, Windows::Foundation::Point* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IMatrixTransform>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Matrix(struct struct_Windows_UI_Xaml_Media_Matrix* value) noexcept = 0;
    virtual HRESULT __stdcall put_Matrix(struct struct_Windows_UI_Xaml_Media_Matrix value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IMatrixTransformStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_MatrixProperty(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IMediaTransportControlsThumbnailRequestedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall SetThumbnailImage(void* source) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_StreamKind(Windows::Media::Playback::FailedMediaStreamKind* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IPathFigure>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Segments(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_StartPoint(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_StartPoint(Windows::Foundation::Point value) noexcept = 0;
    virtual HRESULT __stdcall get_IsClosed(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsClosed(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsFilled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsFilled(bool value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IPathFigureStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SegmentsProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_StartPointProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IsClosedProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IsFilledProperty(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IPathGeometry>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_FillRule(Windows::UI::Xaml::Media::FillRule* value) noexcept = 0;
    virtual HRESULT __stdcall put_FillRule(Windows::UI::Xaml::Media::FillRule value) noexcept = 0;
    virtual HRESULT __stdcall get_Figures(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Figures(void* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IPathGeometryStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_FillRuleProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_FiguresProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_LocalOffsetX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_LocalOffsetX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalOffsetY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_LocalOffsetY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalOffsetZ(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_LocalOffsetZ(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RotationX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RotationY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationZ(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RotationZ(double value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterOfRotationX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_CenterOfRotationX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterOfRotationY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_CenterOfRotationY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterOfRotationZ(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_CenterOfRotationZ(double value) noexcept = 0;
    virtual HRESULT __stdcall get_GlobalOffsetX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_GlobalOffsetX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_GlobalOffsetY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_GlobalOffsetY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_GlobalOffsetZ(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_GlobalOffsetZ(double value) noexcept = 0;
    virtual HRESULT __stdcall get_ProjectionMatrix(struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IPlaneProjectionStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_LocalOffsetXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalOffsetYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalOffsetZProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RotationZProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterOfRotationXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterOfRotationYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterOfRotationZProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_GlobalOffsetXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_GlobalOffsetYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_GlobalOffsetZProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ProjectionMatrixProperty(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IPolyBezierSegment>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Points(void* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IPolyBezierSegmentStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_PointsProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Rect(Windows::Foundation::Rect* value) noexcept = 0;
    virtual HRESULT __stdcall put_Rect(Windows::Foundation::Rect value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IRectangleGeometryStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_RectProperty(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IRenderedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_FrameDuration(Windows::Foundation::TimeSpan* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IRenderingEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_RenderingTime(Windows::Foundation::TimeSpan* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IRevealBrush>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Color(struct struct_Windows_UI_Color value) noexcept = 0;
    virtual HRESULT __stdcall get_TargetTheme(Windows::UI::Xaml::ApplicationTheme* value) noexcept = 0;
    virtual HRESULT __stdcall put_TargetTheme(Windows::UI::Xaml::ApplicationTheme value) noexcept = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallback(bool* result) noexcept = 0;
    virtual HRESULT __stdcall put_AlwaysUseFallback(bool value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ColorProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TargetThemeProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallbackProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_StateProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall SetState(void* element, Windows::UI::Xaml::Media::RevealBrushState value) noexcept = 0;
    virtual HRESULT __stdcall GetState(void* element, Windows::UI::Xaml::Media::RevealBrushState* result) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IRotateTransform>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_CenterY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_CenterY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_Angle(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Angle(double value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IRotateTransformStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CenterXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AngleProperty(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::ISkewTransform>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_CenterY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_CenterY(double value) noexcept = 0;
    virtual HRESULT __stdcall get_AngleX(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_AngleX(double value) noexcept = 0;
    virtual HRESULT __stdcall get_AngleY(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_AngleY(double value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::ISkewTransformStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CenterXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CenterYProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AngleXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AngleYProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstanceWithColor(struct struct_Windows_UI_Color color, void** instance) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_AlignmentX(Windows::UI::Xaml::Media::AlignmentX* value) noexcept = 0;
    virtual HRESULT __stdcall put_AlignmentX(Windows::UI::Xaml::Media::AlignmentX value) noexcept = 0;
    virtual HRESULT __stdcall get_AlignmentY(Windows::UI::Xaml::Media::AlignmentY* value) noexcept = 0;
    virtual HRESULT __stdcall put_AlignmentY(Windows::UI::Xaml::Media::AlignmentY value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_AlignmentXProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AlignmentYProperty(void** value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Marker(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Marker(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::ITransformGroup>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Children(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Children(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Value(struct struct_Windows_UI_Xaml_Media_Matrix* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_X(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_X(double value) noexcept = 0;
    virtual HRESULT __stdcall get_Y(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Y(double value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::ITranslateTransformStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_XProperty(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_YProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall FindElementsInHostCoordinatesPoint(Windows::Foundation::Point intersectingPoint, void* subtree, void** elements) noexcept = 0;
    virtual HRESULT __stdcall FindElementsInHostCoordinatesRect(Windows::Foundation::Rect intersectingRect, void* subtree, void** elements) noexcept = 0;
    virtual HRESULT __stdcall FindAllElementsInHostCoordinatesPoint(Windows::Foundation::Point intersectingPoint, void* subtree, bool includeAllElements, void** elements) noexcept = 0;
    virtual HRESULT __stdcall FindAllElementsInHostCoordinatesRect(Windows::Foundation::Rect intersectingRect, void* subtree, bool includeAllElements, void** elements) noexcept = 0;
    virtual HRESULT __stdcall GetChild(void* reference, int32_t childIndex, void** child) noexcept = 0;
    virtual HRESULT __stdcall GetChildrenCount(void* reference, int32_t* count) noexcept = 0;
    virtual HRESULT __stdcall GetParent(void* reference, void** parent) noexcept = 0;
    virtual HRESULT __stdcall DisconnectChildrenRecursive(void* element) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IVisualTreeHelperStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetOpenPopups(void* window, void** popups) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IXamlCompositionBrushBase>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_FallbackColor(struct struct_Windows_UI_Color* value) noexcept = 0;
    virtual HRESULT __stdcall put_FallbackColor(struct struct_Windows_UI_Color value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall OnConnected() noexcept = 0;
    virtual HRESULT __stdcall OnDisconnected() noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IXamlCompositionBrushBaseProtected>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CompositionBrush(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_CompositionBrush(void* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IXamlCompositionBrushBaseStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_FallbackColorProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetId(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall OnConnected(void* newElement) noexcept = 0;
    virtual HRESULT __stdcall OnDisconnected(void* oldElement) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IXamlLightProtected>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CompositionLight(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_CompositionLight(void* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IXamlLightStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall AddTargetElement(HSTRING lightId, void* element) noexcept = 0;
    virtual HRESULT __stdcall RemoveTargetElement(HSTRING lightId, void* element) noexcept = 0;
    virtual HRESULT __stdcall AddTargetBrush(HSTRING lightId, void* brush) noexcept = 0;
    virtual HRESULT __stdcall RemoveTargetBrush(HSTRING lightId, void* brush) noexcept = 0;
};};
