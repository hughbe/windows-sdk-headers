...
template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Category(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_CategoryDescription(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_CategoryDescription(HSTRING value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_DisplayPicture(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_DisplayPicture(void* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsCurrentAppActiveCallOriginApp(bool* value) noexcept = 0;
    virtual HRESULT __stdcall ShowPhoneCallOriginSettingsUI() noexcept = 0;
    virtual HRESULT __stdcall SetCallOrigin(GUID requestId, void* callOrigin) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RequestSetAsActiveCallOriginAppAsync(void** result) noexcept = 0;
};};
