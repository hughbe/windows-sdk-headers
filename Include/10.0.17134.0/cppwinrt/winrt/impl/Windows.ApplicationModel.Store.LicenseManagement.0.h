...
{
    virtual HRESULT __stdcall AddLicenseAsync(void* license, void** action) noexcept = 0;
    virtual HRESULT __stdcall GetSatisfactionInfosAsync(void* contentIds, void* keyIds, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RefreshLicensesAsync(Windows::ApplicationModel::Store::LicenseManagement::LicenseRefreshOption refreshOption, void** action) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SatisfiedByDevice(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SatisfiedByOpenLicense(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SatisfiedByTrial(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SatisfiedByPass(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SatisfiedByInstallMedia(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SatisfiedBySignedInUser(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsSatisfied(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_LicenseSatisfactionInfos(void** value) noexcept = 0;
