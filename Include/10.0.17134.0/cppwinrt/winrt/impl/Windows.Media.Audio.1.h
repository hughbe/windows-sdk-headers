...
struct WINRT_EBO IMediaSourceAudioInputNode :
    ...
    impl::require<IMediaSourceAudioInputNode, Windows::Foundation::IClosable, Windows::Media::Audio::IAudioInputNode, Windows::Media::Audio::IAudioInputNode2, Windows::Media::Audio::IAudioNode>
{
