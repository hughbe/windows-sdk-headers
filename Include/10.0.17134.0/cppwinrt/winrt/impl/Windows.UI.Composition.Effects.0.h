...
{
    virtual HRESULT __stdcall get_AmbientAmount(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_AmbientAmount(float value) noexcept = 0;
    virtual HRESULT __stdcall get_DiffuseAmount(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_DiffuseAmount(float value) noexcept = 0;
    virtual HRESULT __stdcall get_NormalMapSource(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_NormalMapSource(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_SpecularAmount(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_SpecularAmount(float value) noexcept = 0;
    virtual HRESULT __stdcall get_SpecularShine(float* value) noexcept = 0;
    virtual HRESULT __stdcall put_SpecularShine(float value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Composition::Effects::ISceneLightingEffect2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ReflectanceModel(Windows::UI::Composition::Effects::SceneLightingEffectReflectanceModel* value) noexcept = 0;
    virtual HRESULT __stdcall put_ReflectanceModel(Windows::UI::Composition::Effects::SceneLightingEffectReflectanceModel value) noexcept = 0;
};};
