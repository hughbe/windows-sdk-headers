...
{
    virtual HRESULT __stdcall get_SupportLink(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportAppLink(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportProvider(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_LocalSystemEdition(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_OemSupportInfo(void** value) noexcept = 0;
};};
