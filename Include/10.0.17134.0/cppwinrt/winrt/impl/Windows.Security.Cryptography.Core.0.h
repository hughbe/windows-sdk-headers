...
{
    virtual HRESULT __stdcall get_RsaPkcs1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaOaepSha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaOaepSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaOaepSha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaOaepSha512(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EcdsaP256Sha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EcdsaP384Sha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EcdsaP521Sha512(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DsaSha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DsaSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPkcs1Sha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPkcs1Sha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPkcs1Sha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPkcs1Sha512(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPssSha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPssSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPssSha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RsaSignPssSha512(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IAsymmetricAlgorithmNamesStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EcdsaSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EcdsaSha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EcdsaSha512(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IAsymmetricKeyAlgorithmProvider>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall CreateKeyPair(uint32_t keySize, void** key) noexcept = 0;
    virtual HRESULT __stdcall ImportDefaultPrivateKeyBlob(void* keyBlob, void** key) noexcept = 0;
    virtual HRESULT __stdcall ImportKeyPairWithBlobType(void* keyBlob, Windows::Security::Cryptography::Core::CryptographicPrivateKeyBlobType BlobType, void** key) noexcept = 0;
    virtual HRESULT __stdcall ImportDefaultPublicKeyBlob(void* keyBlob, void** key) noexcept = 0;
    virtual HRESULT __stdcall ImportPublicKeyWithBlobType(void* keyBlob, Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType BlobType, void** key) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IAsymmetricKeyAlgorithmProvider2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateKeyPairWithCurveName(HSTRING curveName, void** key) noexcept = 0;
    virtual HRESULT __stdcall CreateKeyPairWithCurveParameters(uint32_t __parametersSize, uint8_t* parameters, void** key) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IAsymmetricKeyAlgorithmProviderStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall OpenAlgorithm(HSTRING algorithm, void** provider) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::ICryptographicEngineStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Encrypt(void* key, void* data, void* iv, void** value) noexcept = 0;
    virtual HRESULT __stdcall Decrypt(void* key, void* data, void* iv, void** value) noexcept = 0;
    virtual HRESULT __stdcall EncryptAndAuthenticate(void* key, void* data, void* nonce, void* authenticatedData, void** value) noexcept = 0;
    virtual HRESULT __stdcall DecryptAndAuthenticate(void* key, void* data, void* nonce, void* authenticationTag, void* authenticatedData, void** value) noexcept = 0;
    virtual HRESULT __stdcall Sign(void* key, void* data, void** value) noexcept = 0;
    virtual HRESULT __stdcall VerifySignature(void* key, void* data, void* signature, bool* isAuthenticated) noexcept = 0;
    virtual HRESULT __stdcall DeriveKeyMaterial(void* key, void* parameters, uint32_t desiredKeySize, void** keyMaterial) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::ICryptographicEngineStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall SignHashedData(void* key, void* data, void** value) noexcept = 0;
    virtual HRESULT __stdcall VerifySignatureWithHashInput(void* key, void* data, void* signature, bool* isAuthenticated) noexcept = 0;
    virtual HRESULT __stdcall DecryptAsync(void* key, void* data, void* iv, void** value) noexcept = 0;
    virtual HRESULT __stdcall SignAsync(void* key, void* data, void** value) noexcept = 0;
    virtual HRESULT __stdcall SignHashedDataAsync(void* key, void* data, void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Core::ICryptographicKey>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall ExportDefaultPrivateKeyBlobType(void** value) noexcept = 0;
    virtual HRESULT __stdcall ExportPrivateKeyWithBlobType(Windows::Security::Cryptography::Core::CryptographicPrivateKeyBlobType BlobType, void** value) noexcept = 0;
    virtual HRESULT __stdcall ExportDefaultPublicKeyBlobType(void** value) noexcept = 0;
    virtual HRESULT __stdcall ExportPublicKeyWithBlobType(Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType BlobType, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IEccCurveNamesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_BrainpoolP160r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP160t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP192r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP192t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP224r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP224t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP256r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP256t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP320r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP320t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP384r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP384t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP512r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BrainpoolP512t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Curve25519(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ec192wapi(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NistP192(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NistP224(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NistP256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NistP384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NistP521(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NumsP256t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NumsP384t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_NumsP512t1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP160k1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP160r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP160r2(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP192k1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP192r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP224k1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP224r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP256k1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP256r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP384r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecP521r1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Wtls7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Wtls9(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Wtls12(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_X962P192v1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_X962P192v2(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_X962P192v3(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_X962P239v1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_X962P239v2(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_X962P239v3(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_X962P256v1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AllEccCurveNames(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Core::IEncryptedAndAuthenticatedData>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_AuthenticationTag(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IHashAlgorithmNamesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Md5(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sha512(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IHashAlgorithmProvider>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HashLength(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall HashData(void* data, void** value) noexcept = 0;
    virtual HRESULT __stdcall CreateHash(void** Value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Append(void* data) noexcept = 0;
    virtual HRESULT __stdcall GetValueAndReset(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IKeyDerivationAlgorithmNamesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Pbkdf2Md5(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Pbkdf2Sha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Pbkdf2Sha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Pbkdf2Sha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Pbkdf2Sha512(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp800108CtrHmacMd5(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp800108CtrHmacSha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp800108CtrHmacSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp800108CtrHmacSha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp800108CtrHmacSha512(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp80056aConcatMd5(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp80056aConcatSha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp80056aConcatSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp80056aConcatSha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sp80056aConcatSha512(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IKeyDerivationAlgorithmNamesStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CapiKdfMd5(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_CapiKdfSha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_CapiKdfSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_CapiKdfSha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_CapiKdfSha512(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IKeyDerivationAlgorithmProvider>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall CreateKey(void* keyMaterial, void** key) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_KdfGenericBinary(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_KdfGenericBinary(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_IterationCount(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IKeyDerivationParameters2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Capi1KdfTargetAlgorithm(Windows::Security::Cryptography::Core::Capi1KdfTargetAlgorithm* value) noexcept = 0;
    virtual HRESULT __stdcall put_Capi1KdfTargetAlgorithm(Windows::Security::Cryptography::Core::Capi1KdfTargetAlgorithm value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IKeyDerivationParametersStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall BuildForPbkdf2(void* pbkdf2Salt, uint32_t iterationCount, void** value) noexcept = 0;
    virtual HRESULT __stdcall BuildForSP800108(void* label, void* context, void** value) noexcept = 0;
    virtual HRESULT __stdcall BuildForSP80056a(void* algorithmId, void* partyUInfo, void* partyVInfo, void* suppPubInfo, void* suppPrivInfo, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IKeyDerivationParametersStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall BuildForCapi1Kdf(Windows::Security::Cryptography::Core::Capi1KdfTargetAlgorithm capi1KdfTargetAlgorithm, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IMacAlgorithmNamesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_HmacMd5(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HmacSha1(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HmacSha256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HmacSha384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HmacSha512(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AesCmac(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IMacAlgorithmProvider>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_MacLength(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall CreateKey(void* keyMaterial, void** macKey) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::IMacAlgorithmProvider2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateHash(void* keyMaterial, void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall OpenKeyPairFromCertificateAsync(void* certificate, HSTRING hashAlgorithmName, Windows::Security::Cryptography::Core::CryptographicPadding padding, void** operation) noexcept = 0;
    virtual HRESULT __stdcall OpenPublicKeyFromCertificate(void* certificate, HSTRING hashAlgorithmName, Windows::Security::Cryptography::Core::CryptographicPadding padding, void** key) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::ISymmetricAlgorithmNamesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DesCbc(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DesEcb(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_TripleDesCbc(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_TripleDesEcb(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Rc2Cbc(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Rc2Ecb(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AesCbc(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AesEcb(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AesGcm(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AesCcm(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AesCbcPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AesEcbPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DesCbcPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DesEcbPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_TripleDesCbcPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_TripleDesEcbPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Rc2CbcPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Rc2EcbPkcs7(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Rc4(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Core::ISymmetricKeyAlgorithmProvider>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BlockLength(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall CreateSymmetricKey(void* keyMaterial, void** key) noexcept = 0;
};};
