...
template <> struct abi<Windows::ApplicationModel::Search::ILocalContentSuggestionSettings>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_AqsFilter(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_AqsFilter(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_PropertiesToMatch(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Search::ISearchPane>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_VisibilityChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_VisibilityChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_QueryChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_QueryChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_SuggestionsRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SuggestionsRequested(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_QuerySubmitted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_QuerySubmitted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ResultSuggestionChosen(void* handler, event_token* token) noexcept = 0;
    ...
    virtual HRESULT __stdcall ShowOverloadDefault() noexcept = 0;
    virtual HRESULT __stdcall ShowOverloadWithQuery(HSTRING query) noexcept = 0;
    virtual HRESULT __stdcall put_ShowOnKeyboardInput(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_ShowOnKeyboardInput(bool* value) noexcept = 0;
    virtual HRESULT __stdcall TrySetQueryText(HSTRING query, bool* succeeded) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_QueryTextAlternatives(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_QueryTextCompositionStart(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_QueryTextCompositionLength(uint32_t* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetForCurrentView(void** searchPane) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Search::ISearchPaneStaticsWithHideThisApplication>{ struct type : IInspectable
{
    virtual HRESULT __stdcall HideThisApplication() noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Search::ISearchPaneSuggestionsRequest>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_SearchSuggestionCollection(void** collection) noexcept = 0;
...
{
    virtual HRESULT __stdcall CreateInstance(void* queryTextAlternatives, uint32_t queryTextCompositionStart, uint32_t queryTextCompositionLength, void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Search::ISearchSuggestionCollection>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall AppendQuerySuggestion(HSTRING text) noexcept = 0;
    virtual HRESULT __stdcall AppendQuerySuggestions(void* suggestions) noexcept = 0;
    virtual HRESULT __stdcall AppendResultSuggestion(HSTRING text, HSTRING detailText, HSTRING tag, void* image, HSTRING imageAlternateText) noexcept = 0;
    virtual HRESULT __stdcall AppendSearchSeparator(HSTRING label) noexcept = 0;
};};
