...
template <> struct abi<Windows::Services::Cortana::ICortanaPermissionsManager>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall ArePermissionsGrantedAsync(void* permissions, void** getGrantedPermissionsOperation) noexcept = 0;
    virtual HRESULT __stdcall GrantPermissionsAsync(void* permissions, void** grantOperation) noexcept = 0;
    virtual HRESULT __stdcall RevokePermissionsAsync(void* permissions, void** revokeOperation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_HasUserConsentToVoiceActivation(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsVoiceActivationEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsVoiceActivationEnabled(bool value) noexcept = 0;
};};
