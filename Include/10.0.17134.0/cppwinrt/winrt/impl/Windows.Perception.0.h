...
{
    virtual HRESULT __stdcall get_TargetTime(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual HRESULT __stdcall get_PredictionAmount(Windows::Foundation::TimeSpan* value) noexcept = 0;
};};

template <> struct abi<Windows::Perception::IPerceptionTimestampHelperStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall FromHistoricalTargetTime(Windows::Foundation::DateTime targetTime, void** value) noexcept = 0;
};};
