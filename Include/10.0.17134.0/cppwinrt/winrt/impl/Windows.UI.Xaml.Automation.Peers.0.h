...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IAutomationPeer7>{ static constexpr GUID value{ 0x796B3287,0xE642,0x48AB,{ 0xB2,0x23,0x52,0x08,0xB4,0x1D,0xA9,0xD6 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IAutomationPeer8>{ static constexpr GUID value{ 0x5C6A1FE6,0x9A55,0x4D7F,{ 0x94,0x98,0xCF,0xE4,0x29,0xE9,0x2D,0xA8 } }; };
...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IAutomationPeerOverrides8>{ static constexpr GUID value{ 0x0E1EBBD4,0xA003,0x4936,{ 0x81,0x75,0xF5,0x45,0x7C,0x07,0xF0,0xC6 } }; };
...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::ICalendarDatePickerAutomationPeer>{ static constexpr GUID value{ 0x40D8938E,0xDB5E,0x4B03,{ 0xBE,0xBA,0xD1,0x0F,0x62,0x41,0x97,0x87 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::ICalendarDatePickerAutomationPeerFactory>{ static constexpr GUID value{ 0xAB705DD2,0xD293,0x45BF,{ 0x9F,0x19,0x26,0xF7,0x60,0x3A,0x5E,0x9B } }; };
...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IColorPickerSliderAutomationPeer>{ static constexpr GUID value{ 0xA514215A,0x7293,0x4577,{ 0x92,0x4C,0x47,0xD4,0xE0,0xBF,0x9B,0x90 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IColorPickerSliderAutomationPeerFactory>{ static constexpr GUID value{ 0x1A55C77E,0x9DD6,0x45A3,{ 0x90,0x42,0xB4,0x02,0x00,0xFE,0xA1,0xA9 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IColorSpectrumAutomationPeer>{ static constexpr GUID value{ 0x15D5BA03,0x010D,0x4FF7,{ 0x90,0x87,0xF4,0xDD,0x09,0xF8,0x31,0xB7 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IColorSpectrumAutomationPeerFactory>{ static constexpr GUID value{ 0x0AC400E1,0xB743,0x4496,{ 0x83,0x7A,0x88,0x89,0xE6,0xAC,0x64,0x97 } }; };
...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::INavigationViewItemAutomationPeer>{ static constexpr GUID value{ 0x309847A5,0x9971,0x4D8D,{ 0xA8,0x1C,0x08,0x5C,0x70,0x86,0xA1,0xB9 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::INavigationViewItemAutomationPeerFactory>{ static constexpr GUID value{ 0x0BC2835D,0xAA38,0x4F97,{ 0x96,0x64,0xE6,0xFC,0x82,0x1D,0x81,0xED } }; };
...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IPersonPictureAutomationPeer>{ static constexpr GUID value{ 0x27156D4C,0xA66F,0x4AAF,{ 0x82,0x86,0x4F,0x79,0x6D,0x30,0x62,0x8C } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IPersonPictureAutomationPeerFactory>{ static constexpr GUID value{ 0xA95F1F6D,0x2524,0x44A4,{ 0x97,0xFD,0x11,0x81,0x13,0x01,0x00,0xAD } }; };
...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IRatingControlAutomationPeer>{ static constexpr GUID value{ 0x3D14349A,0x9963,0x4A47,{ 0x82,0x3C,0xF4,0x57,0xCB,0x32,0x09,0xD5 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::IRatingControlAutomationPeerFactory>{ static constexpr GUID value{ 0xF179F272,0x9846,0x4632,{ 0x8B,0x9C,0xBE,0x6F,0xA8,0xD3,0xC9,0xBB } }; };
...
template <> struct guid<Windows::UI::Xaml::Automation::Peers::ITreeViewItemAutomationPeer>{ static constexpr GUID value{ 0x2331D648,0xB617,0x437F,{ 0x92,0x0C,0x71,0xD4,0x50,0x50,0x3E,0x65 } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::ITreeViewItemAutomationPeerFactory>{ static constexpr GUID value{ 0x73D388BF,0x1D01,0x4159,{ 0x82,0xC0,0x2B,0x29,0x96,0xDB,0xFD,0xCE } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::ITreeViewListAutomationPeer>{ static constexpr GUID value{ 0x71C1B5BC,0xBB29,0x4479,{ 0xA8,0xA8,0x60,0x6B,0xE6,0xB8,0x23,0xAE } }; };
template <> struct guid<Windows::UI::Xaml::Automation::Peers::ITreeViewListAutomationPeerFactory>{ static constexpr GUID value{ 0x00F597E2,0xF811,0x475A,{ 0xBF,0xE6,0x29,0x0F,0xE7,0x07,0xFA,0x88 } }; };
...
{
    Windows::UI::Xaml::Automation::Peers::CalendarDatePickerAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::CalendarDatePicker const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Automation::Peers::ColorPickerSliderAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::ColorPickerSlider const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Automation::Peers::ColorSpectrumAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::ColorSpectrum const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Automation::Peers::NavigationViewItemAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::NavigationViewItem const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Automation::Peers::PersonPictureAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::PersonPicture const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Automation::Peers::RatingControlAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::RatingControl const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Automation::Peers::TreeViewItemAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::TreeViewItem const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Automation::Peers::TreeViewListAutomationPeer CreateInstanceWithOwner(Windows::UI::Xaml::Controls::TreeViewList const& owner, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    virtual HRESULT __stdcall CreateInstanceWithOwner(void* owner, void* outer, void** inner, void** instance) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstanceWithOwner(void* owner, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeer>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EventsSource(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_EventsSource(void* value) noexcept = 0;
    virtual HRESULT __stdcall GetPattern(Windows::UI::Xaml::Automation::Peers::PatternInterface patternInterface, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall RaiseAutomationEvent(Windows::UI::Xaml::Automation::Peers::AutomationEvents eventId) noexcept = 0;
    virtual HRESULT __stdcall RaisePropertyChangedEvent(void* automationProperty, void* oldValue, void* newValue) noexcept = 0;
    virtual HRESULT __stdcall GetAcceleratorKey(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAccessKey(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAutomationControlType(Windows::UI::Xaml::Automation::Peers::AutomationControlType* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAutomationId(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetBoundingRectangle(Windows::Foundation::Rect* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetChildren(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetClassName(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetClickablePoint(Windows::Foundation::Point* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetHelpText(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetItemStatus(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetItemType(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLabeledBy(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLocalizedControlType(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetName(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetOrientation(Windows::UI::Xaml::Automation::Peers::AutomationOrientation* returnValue) noexcept = 0;
    virtual HRESULT __stdcall HasKeyboardFocus(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsContentElement(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsControlElement(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsEnabled(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsKeyboardFocusable(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsOffscreen(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsPassword(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsRequiredForForm(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall SetFocus() noexcept = 0;
    virtual HRESULT __stdcall GetParent(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall InvalidatePeer() noexcept = 0;
    virtual HRESULT __stdcall GetPeerFromPoint(Windows::Foundation::Point point, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLiveSetting(Windows::UI::Xaml::Automation::Peers::AutomationLiveSetting* returnValue) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Navigate(Windows::UI::Xaml::Automation::Peers::AutomationNavigationDirection direction, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetElementFromPoint(Windows::Foundation::Point pointInWindowCoordinates, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetFocusedElement(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall ShowContextMenu() noexcept = 0;
    virtual HRESULT __stdcall GetControlledPeers(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAnnotations(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall SetParent(void* peer) noexcept = 0;
    virtual HRESULT __stdcall RaiseTextEditTextChangedEvent(Windows::UI::Xaml::Automation::AutomationTextEditChangeType automationTextEditChangeType, void* changedData) noexcept = 0;
    virtual HRESULT __stdcall GetPositionInSet(int32_t* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetSizeOfSet(int32_t* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLevel(int32_t* returnValue) noexcept = 0;
    virtual HRESULT __stdcall RaiseStructureChangedEvent(Windows::UI::Xaml::Automation::Peers::AutomationStructureChangeType structureChangeType, void* child) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeer4>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetLandmarkType(Windows::UI::Xaml::Automation::Peers::AutomationLandmarkType* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLocalizedLandmarkType(HSTRING* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeer5>{ struct type : IInspectable
{
    virtual HRESULT __stdcall IsPeripheral(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsDataValidForForm(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetFullDescription(HSTRING* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeer6>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetCulture(int32_t* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeer7>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RaiseNotificationEvent(Windows::UI::Xaml::Automation::Peers::AutomationNotificationKind notificationKind, Windows::UI::Xaml::Automation::Peers::AutomationNotificationProcessing notificationProcessing, HSTRING displayString, HSTRING activityId) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeer8>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetHeadingLevel(Windows::UI::Xaml::Automation::Peers::AutomationHeadingLevel* returnValue) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerAnnotation>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Peer(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Peer(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerAnnotationFactory>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWithPeerParameter(Windows::UI::Xaml::Automation::AnnotationType type, void* peer, void** instance) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerAnnotationStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_PeerProperty(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetPatternCore(Windows::UI::Xaml::Automation::Peers::PatternInterface patternInterface, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAcceleratorKeyCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAccessKeyCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAutomationControlTypeCore(Windows::UI::Xaml::Automation::Peers::AutomationControlType* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAutomationIdCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetBoundingRectangleCore(Windows::Foundation::Rect* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetChildrenCore(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetClassNameCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetClickablePointCore(Windows::Foundation::Point* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetHelpTextCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetItemStatusCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetItemTypeCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLabeledByCore(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLocalizedControlTypeCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetNameCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetOrientationCore(Windows::UI::Xaml::Automation::Peers::AutomationOrientation* returnValue) noexcept = 0;
    virtual HRESULT __stdcall HasKeyboardFocusCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsContentElementCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsControlElementCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsEnabledCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsKeyboardFocusableCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsOffscreenCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsPasswordCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsRequiredForFormCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall SetFocusCore() noexcept = 0;
    virtual HRESULT __stdcall GetPeerFromPointCore(Windows::Foundation::Point point, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLiveSettingCore(Windows::UI::Xaml::Automation::Peers::AutomationLiveSetting* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerOverrides2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ShowContextMenuCore() noexcept = 0;
    virtual HRESULT __stdcall GetControlledPeersCore(void** returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerOverrides3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall NavigateCore(Windows::UI::Xaml::Automation::Peers::AutomationNavigationDirection direction, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetElementFromPointCore(Windows::Foundation::Point pointInWindowCoordinates, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetFocusedElementCore(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetAnnotationsCore(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetPositionInSetCore(int32_t* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetSizeOfSetCore(int32_t* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLevelCore(int32_t* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerOverrides4>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetLandmarkTypeCore(Windows::UI::Xaml::Automation::Peers::AutomationLandmarkType* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetLocalizedLandmarkTypeCore(HSTRING* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerOverrides5>{ struct type : IInspectable
{
    virtual HRESULT __stdcall IsPeripheralCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall IsDataValidForFormCore(bool* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetFullDescriptionCore(HSTRING* returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetDescribedByCore(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetFlowsToCore(void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall GetFlowsFromCore(void** returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerOverrides6>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetCultureCore(int32_t* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerOverrides8>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetHeadingLevelCore(Windows::UI::Xaml::Automation::Peers::AutomationHeadingLevel* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerProtected>{ struct type : IInspectable
{
    virtual HRESULT __stdcall PeerFromProvider(void* provider, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall ProviderFromPeer(void* peer, void** returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ListenerExists(Windows::UI::Xaml::Automation::Peers::AutomationEvents eventId, bool* returnValue) noexcept = 0;
};};

template <> struct abi<Windows::UI::Xaml::Automation::Peers::IAutomationPeerStatics3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GenerateRawElementProviderRuntimeId(struct struct_Windows_UI_Xaml_Automation_Peers_RawElementProviderRuntimeId* returnValue) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstanceWithParentAndItem(void* item, void* parent, void* outer, void** inner, void** instance) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Owner(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall FromElement(void* element, void** returnValue) noexcept = 0;
    virtual HRESULT __stdcall CreatePeerForElement(void* element, void** returnValue) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Automation::Peers::IItemAutomationPeer>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ItemsControlAutomationPeer(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateItemAutomationPeer(void* item, void** returnValue) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall OnCreateItemAutomationPeer(void* item, void** returnValue) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstanceWithParentAndItem(void* item, void* parent, void** instance) noexcept = 0;
};};
