...
template <> struct guid<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDiagnosticAvailableEventArgs3>{ static constexpr GUID value{ 0xC3650CD5,0xDAEB,0x4103,{ 0x84,0xDA,0x68,0x76,0x9A,0xD5,0x13,0xFF } }; };
...
template <> struct guid<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDownloadCompletedEventArgs3>{ static constexpr GUID value{ 0x0F8A8BD1,0x93B2,0x47C6,{ 0xBA,0xDC,0x8B,0xE2,0xC8,0xF7,0xF6,0xE8 } }; };
...
template <> struct guid<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDownloadFailedEventArgs3>{ static constexpr GUID value{ 0xD0354549,0x1132,0x4A10,{ 0x91,0x5A,0xC2,0x21,0x1B,0x5B,0x94,0x09 } }; };
...
template <> struct guid<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDownloadRequestedEventArgs3>{ static constexpr GUID value{ 0x333C50FD,0x4F62,0x4481,{ 0xAB,0x44,0x1E,0x47,0xB0,0x57,0x42,0x25 } }; };
...
template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSource>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_DesiredLiveOffset(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredLiveOffset(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_InitialBitrate(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_InitialBitrate(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CurrentDownloadBitrate(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_CurrentPlaybackBitrate(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_AvailableBitrates(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DesiredMinBitrate(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredMinBitrate(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_DesiredMaxBitrate(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredMaxBitrate(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_AudioOnlyPlayback(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_InboundBitsPerSecond(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_InboundBitsPerSecondWindow(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_InboundBitsPerSecondWindow(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall add_DownloadBitrateChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DownloadBitrateChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_PlaybackBitrateChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_PlaybackBitrateChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_DownloadRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DownloadRequested(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_DownloadCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DownloadCompleted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_DownloadFailed(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DownloadFailed(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSource2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AdvancedSettings(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSource3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_MinLiveOffset(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxSeekableWindowSize(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DesiredSeekableWindowSize(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredSeekableWindowSize(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Diagnostics(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetCorrelatedTimes(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceAdvancedSettings>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AllSegmentsIndependent(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_AllSegmentsIndependent(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_DesiredBitrateHeadroomRatio(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredBitrateHeadroomRatio(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_BitrateDowngradeTriggerRatio(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_BitrateDowngradeTriggerRatio(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceCorrelatedTimes>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_PresentationTimeStamp(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ProgramDateTime(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceCreationResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCreationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_MediaSource(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_HttpResponseMessage(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_DiagnosticType(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDiagnosticType* value) noexcept = 0;
    virtual HRESULT __stdcall get_RequestId(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Position(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SegmentId(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceType(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceUri(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceByteRangeOffset(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceByteRangeLength(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Bitrate(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ResourceDuration(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceContentType(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDiagnostics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_DiagnosticAvailable(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DiagnosticAvailable(event_token token) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_OldValue(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_NewValue(uint32_t* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Reason(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadBitrateChangedReason* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ResourceType(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceResourceType* value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceUri(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceByteRangeOffset(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceByteRangeLength(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_HttpResponseMessage(void** value) noexcept = 0;
...
template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDownloadCompletedEventArgs2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Statistics(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Position(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ResourceUri(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ResourceUri(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_InputStream(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_InputStream(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Buffer(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Buffer(void* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall put_ExtendedStatus(uint32_t value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDownloadResult2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ResourceByteRangeOffset(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ResourceByteRangeOffset(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceByteRangeLength(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ResourceByteRangeLength(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceDownloadStatistics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ContentBytesReceivedCount(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TimeToHeadersReceived(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TimeToFirstByteReceived(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TimeToLastByteReceived(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourcePlaybackBitrateChangedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_OldValue(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_NewValue(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_AudioOnly(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Streaming::Adaptive::IAdaptiveMediaSourceStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall IsContentTypeSupported(HSTRING contentType, bool* result) noexcept = 0;
    virtual HRESULT __stdcall CreateFromUriAsync(void* uri, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFromUriWithDownloaderAsync(void* uri, void* httpClient, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFromStreamAsync(void* stream, void* uri, HSTRING contentType, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFromStreamWithDownloaderAsync(void* stream, void* uri, HSTRING contentType, void* httpClient, void** result) noexcept = 0;
};};
