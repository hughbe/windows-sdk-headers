...
template <> struct guid<Windows::System::Diagnostics::IDiagnosticInvoker2>{ static constexpr GUID value{ 0xE3BF945C,0x155A,0x4B52,{ 0xA8,0xEC,0x07,0x0C,0x44,0xF9,0x50,0x00 } }; };
...
template <> struct abi<Windows::System::Diagnostics::IDiagnosticActionResult>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Results(void** value) noexcept = 0;
};};

template <> struct abi<Windows::System::Diagnostics::IDiagnosticInvoker>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RunDiagnosticActionAsync(void* context, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::System::Diagnostics::IDiagnosticInvoker2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RunDiagnosticActionFromStringAsync(HSTRING context, void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetReport(void** value) noexcept = 0;
};};

template <> struct abi<Windows::System::Diagnostics::IProcessCpuUsageReport>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_KernelTime(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall get_UserTime(Windows::Foundation::TimeSpan* value) noexcept = 0;
};};
...
template <> struct abi<Windows::System::Diagnostics::IProcessDiagnosticInfo>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ExecutableFileName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Parent(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ProcessStartTime(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual HRESULT __stdcall get_DiskUsage(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_MemoryUsage(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CpuUsage(void** value) noexcept = 0;
};};

template <> struct abi<Windows::System::Diagnostics::IProcessDiagnosticInfo2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetAppDiagnosticInfos(void** result) noexcept = 0;
    virtual HRESULT __stdcall get_IsPackaged(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::System::Diagnostics::IProcessDiagnosticInfoStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetForProcesses(void** processes) noexcept = 0;
    virtual HRESULT __stdcall GetForCurrentProcess(void** processes) noexcept = 0;
};};

template <> struct abi<Windows::System::Diagnostics::IProcessDiagnosticInfoStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TryGetForProcessId(uint32_t processId, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ReadOperationCount(int64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_WriteOperationCount(int64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_OtherOperationCount(int64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_BytesReadCount(int64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_BytesWrittenCount(int64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_OtherBytesCount(int64_t* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_NonPagedPoolSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PageFaultCount(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PageFileSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PagedPoolSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PeakNonPagedPoolSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PeakPageFileSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PeakPagedPoolSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PeakVirtualMemorySizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PeakWorkingSetSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PrivatePageCount(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_VirtualMemorySizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_WorkingSetSizeInBytes(uint64_t* value) noexcept = 0;
};};
...
template <> struct abi<Windows::System::Diagnostics::ISystemCpuUsageReport>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_KernelTime(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall get_UserTime(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall get_IdleTime(Windows::Foundation::TimeSpan* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetForCurrentSystem(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_TotalPhysicalSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_AvailableSizeInBytes(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_CommittedSizeInBytes(uint64_t* value) noexcept = 0;
};};
