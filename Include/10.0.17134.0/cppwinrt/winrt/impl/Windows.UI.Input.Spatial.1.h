...
struct WINRT_EBO ISpatialInteractionController3 :
    ...
    impl::require<ISpatialInteractionController3, Windows::UI::Input::Spatial::ISpatialInteractionController, Windows::UI::Input::Spatial::ISpatialInteractionController2>
{
