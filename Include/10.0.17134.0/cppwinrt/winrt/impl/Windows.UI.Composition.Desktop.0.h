...
template <> struct guid<Windows::UI::Composition::Desktop::IDesktopWindowTarget>{ static constexpr GUID value{ 0x6329D6CA,0x3366,0x490E,{ 0x9D,0xB3,0x25,0x31,0x29,0x29,0xAC,0x51 } }; };
...
{
    virtual HRESULT __stdcall get_IsTopmost(bool* value) noexcept = 0;
};};
