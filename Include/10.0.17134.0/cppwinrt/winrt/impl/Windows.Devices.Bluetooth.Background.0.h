...
{
    virtual HRESULT __stdcall get_Error(Windows::Devices::Bluetooth::BluetoothError* value) noexcept = 0;
    virtual HRESULT __stdcall get_Advertisements(void** value) noexcept = 0;
...
template <> struct abi<Windows::Devices::Bluetooth::Background::IGattCharacteristicNotificationTriggerDetails2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ValueChangedEvents(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_AllServices(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Bluetooth::Background::IRfcommConnectionTriggerDetails>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Incoming(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_RemoteDevice(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Bluetooth::Background::IRfcommInboundConnectionInformation>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SdpRecord(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_SdpRecord(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_LocalServiceId(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_LocalServiceId(void* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall put_ServiceCapabilities(Windows::Devices::Bluetooth::BluetoothServiceCapabilities value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Bluetooth::Background::IRfcommOutboundConnectionInformation>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_RemoteServiceId(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_RemoteServiceId(void* value) noexcept = 0;
};};
