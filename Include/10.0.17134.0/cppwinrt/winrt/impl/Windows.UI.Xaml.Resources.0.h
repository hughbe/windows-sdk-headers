...
{
    virtual HRESULT __stdcall GetResource(HSTRING resourceId, HSTRING objectType, HSTRING propertyName, HSTRING propertyType, void** returnValue) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Current(void* value) noexcept = 0;
};};
