...
template <> struct guid<Windows::UI::Input::Spatial::ISpatialInteractionController3>{ static constexpr GUID value{ 0x628466A0,0x9D91,0x4A0B,{ 0x88,0x8D,0x16,0x5E,0x67,0x0A,0x8C,0xD5 } }; };
...
{
    virtual HRESULT __stdcall add_RecognitionStarted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_RecognitionStarted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_RecognitionEnded(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_RecognitionEnded(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_Tapped(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_Tapped(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_HoldStarted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_HoldStarted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_HoldCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_HoldCompleted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_HoldCanceled(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_HoldCanceled(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ManipulationStarted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ManipulationStarted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ManipulationUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ManipulationUpdated(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ManipulationCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ManipulationCompleted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ManipulationCanceled(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ManipulationCanceled(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_NavigationStarted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_NavigationStarted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_NavigationUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_NavigationUpdated(event_token token) noexcept = 0;
    ...
    virtual HRESULT __stdcall add_NavigationCanceled(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_NavigationCanceled(event_token token) noexcept = 0;
    virtual HRESULT __stdcall CaptureInteraction(void* interaction) noexcept = 0;
    virtual HRESULT __stdcall CancelPendingGestures() noexcept = 0;
    virtual HRESULT __stdcall TrySetGestureSettings(Windows::UI::Input::Spatial::SpatialGestureSettings settings, bool* succeeded) noexcept = 0;
    virtual HRESULT __stdcall get_GestureSettings(Windows::UI::Input::Spatial::SpatialGestureSettings* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialGestureRecognizerFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(Windows::UI::Input::Spatial::SpatialGestureSettings settings, void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialHoldCanceledEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InteractionSourceKind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_InteractionSourceKind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
    virtual HRESULT __stdcall TryGetPointerPose(void* coordinateSystem, void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteraction>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SourceState(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionController>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_HasTouchpad(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_HasThumbstick(bool* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall TryGetRenderableModelAsync(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionController3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TryGetBatteryReport(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionControllerProperties>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsTouchpadTouched(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsTouchpadPressed(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsThumbstickPressed(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_ThumbstickX(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_ThumbstickY(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_TouchpadX(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_TouchpadY(double* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionDetectedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InteractionSourceKind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
    virtual HRESULT __stdcall TryGetPointerPose(void* coordinateSystem, void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Interaction(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionDetectedEventArgs2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InteractionSource(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionManager>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_SourceDetected(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SourceDetected(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_SourceLost(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SourceLost(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_SourceUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SourceUpdated(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_SourcePressed(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SourcePressed(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_SourceReleased(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SourceReleased(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_InteractionDetected(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_InteractionDetected(event_token token) noexcept = 0;
    virtual HRESULT __stdcall GetDetectedSourcesAtTimestamp(void* timeStamp, void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionSource>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionSource2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsPointingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsMenuSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsGraspSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_Controller(void** value) noexcept = 0;
    virtual HRESULT __stdcall TryGetStateAtTimestamp(void* timestamp, void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionSource3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Handedness(Windows::UI::Input::Spatial::SpatialInteractionSourceHandedness* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_PressKind(Windows::UI::Input::Spatial::SpatialInteractionPressKind* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionSourceLocation>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Velocity(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionSourceLocation2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Orientation(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionSourceLocation3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_PositionAccuracy(Windows::UI::Input::Spatial::SpatialInteractionSourcePositionAccuracy* value) noexcept = 0;
    virtual HRESULT __stdcall get_AngularVelocity(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SourcePointerPose(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialInteractionSourceProperties>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TryGetSourceLossMitigationDirection(void* coordinateSystem, void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SourceLossRisk(double* value) noexcept = 0;
    virtual HRESULT __stdcall TryGetLocation(void* coordinateSystem, void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_IsSelectPressed(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsMenuPressed(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsGrasped(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SelectPressedValue(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_ControllerProperties(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_InteractionSourceKind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
    virtual HRESULT __stdcall TryGetCumulativeDelta(void* coordinateSystem, void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialManipulationDelta>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Translation(Windows::Foundation::Numerics::float3* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_InteractionSourceKind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
    virtual HRESULT __stdcall get_NormalizedOffset(Windows::Foundation::Numerics::float3* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Input::Spatial::ISpatialNavigationStartedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InteractionSourceKind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
    virtual HRESULT __stdcall TryGetPointerPose(void* coordinateSystem, void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IsNavigatingX(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsNavigatingY(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsNavigatingZ(bool* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Input::Spatial::ISpatialPointerInteractionSourcePose>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ForwardDirection(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall get_UpDirection(Windows::Foundation::Numerics::float3* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall TryGetInteractionSourcePose(void* source, void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Spatial::ISpatialPointerPoseStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TryGetAtTimestamp(void* coordinateSystem, void* timestamp, void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Input::Spatial::ISpatialRecognitionStartedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InteractionSourceKind(Windows::UI::Input::Spatial::SpatialInteractionSourceKind* value) noexcept = 0;
    virtual HRESULT __stdcall TryGetPointerPose(void* coordinateSystem, void** value) noexcept = 0;
    virtual HRESULT __stdcall IsGesturePossible(Windows::UI::Input::Spatial::SpatialGestureSettings gesture, bool* value) noexcept = 0;
};};
