...
{
    virtual HRESULT __stdcall get_BankAndCreditUnions(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EatDrink(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Hospitals(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HotelsAndMotels(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_All(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Parking(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SeeDo(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Shop(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Services::Maps::LocalSearch::ILocalLocation>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_DataAttribution(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Services::Maps::LocalSearch::ILocalLocation2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Category(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RatingInfo(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_HoursOfOperation(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Services::Maps::LocalSearch::ILocalLocationFinderResult>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Services::Maps::LocalSearch::LocalLocationFinderStatus* value) noexcept = 0;
};};

template <> struct abi<Windows::Services::Maps::LocalSearch::ILocalLocationFinderStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall FindLocalLocationsAsync(HSTRING searchTerm, void* searchArea, HSTRING localCategory, uint32_t maxResults, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Services::Maps::LocalSearch::ILocalLocationHoursOfOperationItem>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Day(Windows::Globalization::DayOfWeek* value) noexcept = 0;
    virtual HRESULT __stdcall get_Start(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall get_Span(Windows::Foundation::TimeSpan* value) noexcept = 0;
};};

template <> struct abi<Windows::Services::Maps::LocalSearch::ILocalLocationRatingInfo>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AggregateRating(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RatingCount(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ProviderIdentifier(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Services::Maps::LocalSearch::IPlaceInfoHelperStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateFromLocalLocation(void* location, void** resultValue) noexcept = 0;
};};
