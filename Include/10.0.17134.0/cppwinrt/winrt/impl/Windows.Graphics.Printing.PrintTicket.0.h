...
template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketCapabilities>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_XmlNamespace(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_XmlNode(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentBindingFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentCollateFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentDuplexFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentHolePunchFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentInputBinFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentNUpFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentStapleFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_JobPasscodeFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PageBorderlessFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PageMediaSizeFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PageMediaTypeFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PageOrientationFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PageOutputColorFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PageOutputQualityFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PageResolutionFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetFeature(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetParameterDefinition(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketFeature>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall GetOption(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
    virtual HRESULT __stdcall get_Options(void** result) noexcept = 0;
    virtual HRESULT __stdcall GetSelectedOption(void** value) noexcept = 0;
    virtual HRESULT __stdcall SetSelectedOption(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_SelectionType(Windows::Graphics::Printing::PrintTicket::PrintTicketFeatureSelectionType* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketOption>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_XmlNode(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DisplayName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall GetPropertyNode(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetScoredPropertyNode(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetPropertyValue(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetScoredPropertyValue(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketParameterDefinition>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_XmlNamespace(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_XmlNode(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DataType(Windows::Graphics::Printing::PrintTicket::PrintTicketParameterDataType* value) noexcept = 0;
    virtual HRESULT __stdcall get_UnitType(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RangeMin(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_RangeMax(int32_t* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Type(Windows::Graphics::Printing::PrintTicket::PrintTicketValueType* value) noexcept = 0;
    virtual HRESULT __stdcall GetValueAsInteger(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall GetValueAsString(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicket>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_XmlNamespace(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_XmlNode(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetCapabilities(void** result) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentBindingFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentCollateFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentDuplexFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DocumentHolePunchFeature(void** value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_PageResolutionFeature(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetFeature(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
    virtual HRESULT __stdcall NotifyXmlChangedAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall ValidateAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetParameterInitializer(HSTRING name, HSTRING xmlNamespace, void** result) noexcept = 0;
    virtual HRESULT __stdcall SetParameterInitializerAsInteger(HSTRING name, HSTRING xmlNamespace, int32_t integerValue, void** result) noexcept = 0;
    virtual HRESULT __stdcall SetParameterInitializerAsString(HSTRING name, HSTRING xmlNamespace, HSTRING stringValue, void** result) noexcept = 0;
    virtual HRESULT __stdcall MergeAndValidateTicket(void* deltaShemaTicket, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketValidationResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Validated(bool* value) noexcept = 0;
