...
template <> struct abi<Windows::Gaming::UI::IGameBarStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_IsInputRedirectedChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_IsInputRedirectedChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_Visible(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsInputRedirected(bool* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Gaming::UI::IGameChatMessageReceivedEventArgs>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_AppDisplayName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SenderName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Message(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Origin(Windows::Gaming::UI::GameChatMessageOrigin* value) noexcept = 0;
};};

template <> struct abi<Windows::Gaming::UI::IGameChatOverlay>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DesiredPosition(Windows::Gaming::UI::GameChatOverlayPosition* value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredPosition(Windows::Gaming::UI::GameChatOverlayPosition value) noexcept = 0;
    virtual HRESULT __stdcall AddMessage(HSTRING sender, HSTRING message, Windows::Gaming::UI::GameChatMessageOrigin origin) noexcept = 0;
};};
...
template <> struct abi<Windows::Gaming::UI::IGameChatOverlayMessageSource>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall SetDelayBeforeClosingAfterMessageReceived(Windows::Foundation::TimeSpan value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall RequestPermissionAsync(void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Gaming::UI::IGameMonitorStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetDefault(void** gameMonitor) noexcept = 0;
};};

template <> struct abi<Windows::Gaming::UI::IGameUIProviderActivatedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_GameUIArgs(void** value) noexcept = 0;
    virtual HRESULT __stdcall ReportCompleted(void* results) noexcept = 0;
};};
