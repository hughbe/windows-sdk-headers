...
template <> struct guid<Windows::UI::Core::ICorePointerInputSource2>{ static constexpr GUID value{ 0xD703708A,0x4516,0x4786,{ 0xB1,0xE5,0x27,0x51,0xD5,0x63,0xF9,0x97 } }; };
...
{
    virtual HRESULT __stdcall get_AutomationProvider(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_AutomationProvider(void* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_KeyCode(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyStatus(struct struct_Windows_UI_Core_CorePhysicalKeyStatus* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::IClosestInteractiveBoundsRequestedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_PointerPosition(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall get_SearchBounds(Windows::Foundation::Rect* value) noexcept = 0;
    virtual HRESULT __stdcall get_ClosestInteractiveBounds(Windows::Foundation::Rect* value) noexcept = 0;
    virtual HRESULT __stdcall put_ClosestInteractiveBounds(Windows::Foundation::Rect value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreAcceleratorKeys>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_AcceleratorKeyActivated(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_AcceleratorKeyActivated(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreClosestInteractiveBoundsRequested>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_ClosestInteractiveBoundsRequested(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_ClosestInteractiveBoundsRequested(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreComponentFocusable>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_HasFocus(bool* value) noexcept = 0;
    virtual HRESULT __stdcall add_GotFocus(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_GotFocus(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_LostFocus(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_LostFocus(event_token cookie) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Core::ICoreCursor>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Type(Windows::UI::Core::CoreCursorType* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreCursorFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateCursor(Windows::UI::Core::CoreCursorType type, uint32_t id, void** cursor) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreDispatcher>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_HasThreadAccess(bool* value) noexcept = 0;
    virtual HRESULT __stdcall ProcessEvents(Windows::UI::Core::CoreProcessEventsOption options) noexcept = 0;
    virtual HRESULT __stdcall RunAsync(Windows::UI::Core::CoreDispatcherPriority priority, void* agileCallback, void** asyncAction) noexcept = 0;
    virtual HRESULT __stdcall RunIdleAsync(void* agileCallback, void** asyncAction) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreDispatcher2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TryRunAsync(Windows::UI::Core::CoreDispatcherPriority priority, void* agileCallback, void** asyncOperation) noexcept = 0;
    virtual HRESULT __stdcall TryRunIdleAsync(void* agileCallback, void** asyncOperation) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreDispatcherWithTaskPriority>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CurrentPriority(Windows::UI::Core::CoreDispatcherPriority* value) noexcept = 0;
    virtual HRESULT __stdcall put_CurrentPriority(Windows::UI::Core::CoreDispatcherPriority value) noexcept = 0;
    virtual HRESULT __stdcall ShouldYield(bool* value) noexcept = 0;
    virtual HRESULT __stdcall ShouldYieldToPriority(Windows::UI::Core::CoreDispatcherPriority priority, bool* value) noexcept = 0;
    virtual HRESULT __stdcall StopProcessEvents() noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Core::ICoreInputSourceBase>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsInputEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsInputEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall add_InputEnabled(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_InputEnabled(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreKeyboardInputSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetCurrentKeyState(Windows::System::VirtualKey virtualKey, Windows::UI::Core::CoreVirtualKeyStates* KeyState) noexcept = 0;
    virtual HRESULT __stdcall add_CharacterReceived(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_CharacterReceived(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_KeyDown(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_KeyDown(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_KeyUp(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_KeyUp(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreKeyboardInputSource2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetCurrentKeyEventDeviceId(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICorePointerInputSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ReleasePointerCapture() noexcept = 0;
    virtual HRESULT __stdcall SetPointerCapture() noexcept = 0;
    virtual HRESULT __stdcall get_HasCapture(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_PointerPosition(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall get_PointerCursor(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_PointerCursor(void* value) noexcept = 0;
    virtual HRESULT __stdcall add_PointerCaptureLost(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerCaptureLost(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerEntered(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerEntered(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerExited(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerExited(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerMoved(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerMoved(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerPressed(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerPressed(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerReleased(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerReleased(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerWheelChanged(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerWheelChanged(event_token cookie) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall add_PointerRoutedAway(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerRoutedAway(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerRoutedTo(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerRoutedTo(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerRoutedReleased(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerRoutedReleased(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreTouchHitTesting>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_TouchHitTesting(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_TouchHitTesting(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindow>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AutomationHostProvider(void** value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_Dispatcher(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_FlowDirection(Windows::UI::Core::CoreWindowFlowDirection* value) noexcept = 0;
    virtual HRESULT __stdcall put_FlowDirection(Windows::UI::Core::CoreWindowFlowDirection value) noexcept = 0;
    virtual HRESULT __stdcall get_IsInputEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsInputEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_PointerCursor(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_PointerCursor(void* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall GetAsyncKeyState(Windows::System::VirtualKey virtualKey, Windows::UI::Core::CoreVirtualKeyStates* KeyState) noexcept = 0;
    virtual HRESULT __stdcall GetKeyState(Windows::System::VirtualKey virtualKey, Windows::UI::Core::CoreVirtualKeyStates* KeyState) noexcept = 0;
    virtual HRESULT __stdcall ReleasePointerCapture() noexcept = 0;
    virtual HRESULT __stdcall SetPointerCapture() noexcept = 0;
    virtual HRESULT __stdcall add_Activated(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_Activated(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_AutomationProviderRequested(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_AutomationProviderRequested(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_CharacterReceived(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_CharacterReceived(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_Closed(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_Closed(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_InputEnabled(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_InputEnabled(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_KeyDown(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_KeyDown(event_token cookie) noexcept = 0;
    ...
    virtual HRESULT __stdcall add_PointerWheelChanged(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerWheelChanged(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_SizeChanged(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_SizeChanged(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_VisibilityChanged(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_VisibilityChanged(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindow2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_PointerPosition(Windows::Foundation::Point value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall add_ResizeStarted(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_ResizeStarted(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_ResizeCompleted(void* handler, event_token* pCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_ResizeCompleted(event_token cookie) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindow5>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DispatcherQueue(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ActivationMode(Windows::UI::Core::CoreWindowActivationMode* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindowDialog>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_Showing(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_Showing(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall get_MaxSize(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_MinSize(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_Title(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_Title(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_IsInteractionDelayed(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsInteractionDelayed(int32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_Commands(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DefaultCommandIndex(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_DefaultCommandIndex(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CancelCommandIndex(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_CancelCommandIndex(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_BackButtonCommand(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_BackButtonCommand(void* value) noexcept = 0;
    virtual HRESULT __stdcall ShowAsync(void** asyncInfo) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindowDialogFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateWithTitle(HSTRING title, void** coreWindowDialog) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Create(Windows::Foundation::Point position, void** coreWindowFlyout) noexcept = 0;
    virtual HRESULT __stdcall CreateWithTitle(Windows::Foundation::Point position, HSTRING title, void** coreWindowFlyout) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindowPopupShowingEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall SetDesiredSize(Windows::Foundation::Size value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindowResizeManager>{ struct type : IInspectable
{
    virtual HRESULT __stdcall NotifyLayoutCompleted() noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindowResizeManagerLayoutCapability>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_ShouldWaitForLayoutCompletion(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_ShouldWaitForLayoutCompletion(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindowResizeManagerStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetForCurrentView(void** CoreWindowResizeManager) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ICoreWindowStatic>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetForCurrentThread(void** ppWindow) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::IIdleDispatchedHandlerArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsDispatcherIdle(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::IInitializeWithCoreWindow>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Initialize(void* window) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::IInputEnabledEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InputEnabled(bool* value) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Core::IPointerEventArgs>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall GetIntermediatePoints(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Core::ISystemNavigationManager>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_BackRequested(void* handler, event_token* token) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_AppViewBackButtonVisibility(Windows::UI::Core::AppViewBackButtonVisibility* value) noexcept = 0;
    virtual HRESULT __stdcall put_AppViewBackButtonVisibility(Windows::UI::Core::AppViewBackButtonVisibility value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ProximityEvaluation(struct struct_Windows_UI_Core_CoreProximityEvaluation* value) noexcept = 0;
    virtual HRESULT __stdcall put_ProximityEvaluation(struct struct_Windows_UI_Core_CoreProximityEvaluation value) noexcept = 0;
    virtual HRESULT __stdcall get_Point(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall get_BoundingBox(Windows::Foundation::Rect* value) noexcept = 0;
    virtual HRESULT __stdcall EvaluateProximityToRect(Windows::Foundation::Rect controlBoundingBox, struct struct_Windows_UI_Core_CoreProximityEvaluation* proximityEvaluation) noexcept = 0;
    virtual HRESULT __stdcall EvaluateProximityToPolygon(uint32_t __controlVerticesSize, Windows::Foundation::Point* controlVertices, struct struct_Windows_UI_Core_CoreProximityEvaluation* proximityEvaluation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_WindowActivationState(Windows::UI::Core::CoreWindowActivationState* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Invoke(void* e) noexcept = 0;
};};
