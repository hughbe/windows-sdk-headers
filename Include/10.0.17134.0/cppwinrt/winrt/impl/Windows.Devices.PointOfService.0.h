...
template <> struct guid<Windows::Devices::PointOfService::IBarcodeScannerReportFactory>{ static constexpr GUID value{ 0xA2547326,0x2013,0x457C,{ 0x89,0x63,0x49,0xC1,0x5D,0xCA,0x78,0xCE } }; };
...
template <> struct guid<Windows::Devices::PointOfService::IClaimedBarcodeScanner3>{ static constexpr GUID value{ 0xE6CEB430,0x712E,0x45FC,{ 0x8B,0x86,0xCD,0x55,0xF5,0xAE,0xF7,0x9D } }; };
...
template <> struct guid<Windows::Devices::PointOfService::IUnifiedPosErrorDataFactory>{ static constexpr GUID value{ 0x4B982551,0x1FFE,0x451B,{ 0xA3,0x68,0x63,0xE0,0xCE,0x46,0x5F,0x5A } }; };
...
template <> struct abi<Windows::Devices::PointOfService::IBarcodeScanner>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall ClaimScannerAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall CheckHealthAsync(Windows::Devices::PointOfService::UnifiedPosHealthCheckLevel level, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetSupportedSymbologiesAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall IsSymbologySupportedAsync(uint32_t barcodeSymbology, void** operation) noexcept = 0;
    virtual HRESULT __stdcall RetrieveStatisticsAsync(void* statisticsCategories, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetSupportedProfiles(void** value) noexcept = 0;
    virtual HRESULT __stdcall IsProfileSupported(HSTRING profile, bool* isSupported) noexcept = 0;
    virtual HRESULT __stdcall add_StatusUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_StatusUpdated(event_token token) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_PowerReportingType(Windows::Devices::PointOfService::UnifiedPosPowerReportingType* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatisticsReportingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatisticsUpdatingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsImagePreviewSupported(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeScannerCapabilities1>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsSoftwareTriggerSupported(bool* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_PartialInputData(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IsRetriable(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_ErrorData(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeScannerImagePreviewReceivedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Preview(void** preview) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeScannerReport>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ScanDataType(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ScanData(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ScanDataLabel(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeScannerReportFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(uint32_t scanDataType, void* scanData, void* scanDataLabel, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeScannerStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetDefaultAsync(void** result) noexcept = 0;
...
{
    virtual HRESULT __stdcall GetDeviceSelectorWithConnectionTypes(Windows::Devices::PointOfService::PosConnectionTypes connectionTypes, HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeScannerStatusUpdatedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Devices::PointOfService::BarcodeScannerStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedStatus(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeSymbologiesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Unknown(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean8(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean8Add2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean8Add5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Eanv(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_EanvAdd2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_EanvAdd5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean13(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean13Add2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean13Add5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Isbn(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsbnAdd5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ismn(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsmnAdd2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsmnAdd5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Issn(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_IssnAdd2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_IssnAdd5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean99(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean99Add2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ean99Add5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Upca(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UpcaAdd2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UpcaAdd5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Upce(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UpceAdd2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UpceAdd5(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UpcCoupon(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TfStd(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TfDis(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TfInt(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TfInd(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TfMat(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TfIata(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Gs1DatabarType1(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Gs1DatabarType2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Gs1DatabarType3(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code39(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code39Ex(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Trioptic39(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code32(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Pzn(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code93(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code93Ex(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code128(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Gs1128(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Gs1128Coupon(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UccEan128(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Sisac(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Isbt(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Codabar(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code11(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Msi(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Plessey(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Telepen(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code16k(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_CodablockA(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_CodablockF(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Codablock128(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Code49(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Aztec(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_DataCode(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_DataMatrix(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_HanXin(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Maxicode(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_MicroPdf417(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_MicroQr(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Pdf417(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Qr(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_MsTag(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ccab(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ccc(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Tlc39(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_AusPost(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanPost(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ChinaPost(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_DutchKix(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_InfoMail(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ItalianPost25(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ItalianPost39(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_JapanPost(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_KoreanPost(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_SwedenPost(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UkPost(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UsIntelligent(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UsIntelligentPkg(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UsPlanet(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_UsPostNet(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Us4StateFics(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_OcrA(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_OcrB(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Micr(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedBase(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall GetName(uint32_t scanDataType, HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeSymbologiesStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Gs1DWCode(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IBarcodeSymbologyAttributes>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsCheckDigitValidationEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsCheckDigitValidationEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCheckDigitValidationSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCheckDigitTransmissionEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsCheckDigitTransmissionEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCheckDigitTransmissionSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_DecodeLength1(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_DecodeLength1(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_DecodeLength2(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_DecodeLength2(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_DecodeLengthKind(Windows::Devices::PointOfService::BarcodeSymbologyDecodeLengthKind* value) noexcept = 0;
    virtual HRESULT __stdcall put_DecodeLengthKind(Windows::Devices::PointOfService::BarcodeSymbologyDecodeLengthKind value) noexcept = 0;
...
template <> struct abi<Windows::Devices::PointOfService::ICashDrawer>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsDrawerOpen(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_DrawerEventSource(void** value) noexcept = 0;
    virtual HRESULT __stdcall ClaimDrawerAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall CheckHealthAsync(Windows::Devices::PointOfService::UnifiedPosHealthCheckLevel level, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetStatisticsAsync(void* statisticsCategories, void** operation) noexcept = 0;
    virtual HRESULT __stdcall add_StatusUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_StatusUpdated(event_token token) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::ICashDrawerCapabilities>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsStatisticsReportingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatisticsUpdatingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatusReportingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatusMultiDrawerDetectSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDrawerOpenSensorAvailable(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ICashDrawerCloseAlarm>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_AlarmTimeout(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_AlarmTimeout(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_BeepFrequency(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_BeepFrequency(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_BeepDuration(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_BeepDuration(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_BeepDelay(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_BeepDelay(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall add_AlarmTimeoutExpired(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_AlarmTimeoutExpired(event_token token) noexcept = 0;
    virtual HRESULT __stdcall StartAsync(void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ICashDrawerEventSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_DrawerClosed(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DrawerClosed(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_DrawerOpened(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DrawerOpened(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ICashDrawerEventSourceEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CashDrawer(void** drawer) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_StatusKind(Windows::Devices::PointOfService::CashDrawerStatusKind* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedStatus(uint32_t* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IClaimedBarcodeScanner>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_IsDisabledOnDataReceived(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDisabledOnDataReceived(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsDecodeDataEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDecodeDataEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall EnableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall DisableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall RetainDevice() noexcept = 0;
    virtual HRESULT __stdcall SetActiveSymbologiesAsync(void* symbologies, void** result) noexcept = 0;
    virtual HRESULT __stdcall ResetStatisticsAsync(void* statisticsCategories, void** result) noexcept = 0;
    virtual HRESULT __stdcall UpdateStatisticsAsync(void* statistics, void** result) noexcept = 0;
    virtual HRESULT __stdcall SetActiveProfileAsync(HSTRING profile, void** result) noexcept = 0;
    ...
    virtual HRESULT __stdcall add_TriggerPressed(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_TriggerPressed(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_TriggerReleased(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_TriggerReleased(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ReleaseDeviceRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ReleaseDeviceRequested(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ImagePreviewReceived(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ImagePreviewReceived(event_token token) noexcept = 0;
...
{
    virtual HRESULT __stdcall StartSoftwareTriggerAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall StopSoftwareTriggerAsync(void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IClaimedBarcodeScanner2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetSymbologyAttributesAsync(uint32_t barcodeSymbology, void** result) noexcept = 0;
    virtual HRESULT __stdcall SetSymbologyAttributesAsync(uint32_t barcodeSymbology, void* attributes, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IClaimedBarcodeScanner3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ShowVideoPreviewAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall HideVideoPreview() noexcept = 0;
    virtual HRESULT __stdcall put_IsVideoPreviewShownOnEnable(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsVideoPreviewShownOnEnable(bool* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IClaimedCashDrawer>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDrawerOpen(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_CloseAlarm(void** value) noexcept = 0;
    virtual HRESULT __stdcall OpenDrawerAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall EnableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall DisableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall RetainDeviceAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall ResetStatisticsAsync(void* statisticsCategories, void** result) noexcept = 0;
    virtual HRESULT __stdcall UpdateStatisticsAsync(void* statistics, void** result) noexcept = 0;
    virtual HRESULT __stdcall add_ReleaseDeviceRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ReleaseDeviceRequested(event_token token) noexcept = 0;
...
{
    virtual HRESULT __stdcall CreateJob(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IClaimedLineDisplay>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Capabilities(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PhysicalDeviceName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_PhysicalDeviceDescription(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceControlDescription(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceControlVersion(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceServiceVersion(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DefaultWindow(void** value) noexcept = 0;
    virtual HRESULT __stdcall RetainDevice() noexcept = 0;
    virtual HRESULT __stdcall add_ReleaseDeviceRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ReleaseDeviceRequested(event_token token) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetStatisticsAsync(void* statisticsCategories, void** result) noexcept = 0;
    virtual HRESULT __stdcall CheckHealthAsync(Windows::Devices::PointOfService::UnifiedPosHealthCheckLevel level, void** result) noexcept = 0;
    virtual HRESULT __stdcall CheckPowerStatusAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall add_StatusUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_StatusUpdated(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedScreenSizesInCharacters(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxBitmapSizeInPixels(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedCharacterSets(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CustomGlyphs(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetAttributes(void** value) noexcept = 0;
    virtual HRESULT __stdcall TryUpdateAttributesAsync(void* attributes, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TrySetDescriptorAsync(uint32_t descriptor, Windows::Devices::PointOfService::LineDisplayDescriptorState descriptorState, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryClearDescriptorsAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryCreateWindowAsync(Windows::Foundation::Rect viewport, Windows::Foundation::Size windowSize, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryStoreStorageFileBitmapAsync(void* bitmap, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryStoreStorageFileBitmapWithAlignmentAsync(void* bitmap, Windows::Devices::PointOfService::LineDisplayHorizontalAlignment horizontalAlignment, Windows::Devices::PointOfService::LineDisplayVerticalAlignment verticalAlignment, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryStoreStorageFileBitmapWithAlignmentAndWidthAsync(void* bitmap, Windows::Devices::PointOfService::LineDisplayHorizontalAlignment horizontalAlignment, Windows::Devices::PointOfService::LineDisplayVerticalAlignment verticalAlignment, int32_t widthInPixels, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IClaimedMagneticStripeReader>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_IsDecodeDataEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDecodeDataEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDeviceAuthenticated(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_DataEncryptionAlgorithm(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_DataEncryptionAlgorithm(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_TracksToRead(Windows::Devices::PointOfService::MagneticStripeReaderTrackIds value) noexcept = 0;
    virtual HRESULT __stdcall get_TracksToRead(Windows::Devices::PointOfService::MagneticStripeReaderTrackIds* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsTransmitSentinelsEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsTransmitSentinelsEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall EnableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall DisableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall RetainDevice() noexcept = 0;
    virtual HRESULT __stdcall SetErrorReportingType(Windows::Devices::PointOfService::MagneticStripeReaderErrorReportingType value) noexcept = 0;
    virtual HRESULT __stdcall RetrieveDeviceAuthenticationDataAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall AuthenticateDeviceAsync(uint32_t __responseTokenSize, uint8_t* responseToken, void** result) noexcept = 0;
    virtual HRESULT __stdcall DeAuthenticateDeviceAsync(uint32_t __responseTokenSize, uint8_t* responseToken, void** result) noexcept = 0;
    virtual HRESULT __stdcall UpdateKeyAsync(HSTRING key, HSTRING keyName, void** result) noexcept = 0;
    virtual HRESULT __stdcall ResetStatisticsAsync(void* statisticsCategories, void** result) noexcept = 0;
    virtual HRESULT __stdcall UpdateStatisticsAsync(void* statistics, void** result) noexcept = 0;
    virtual HRESULT __stdcall add_BankCardDataReceived(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_BankCardDataReceived(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_AamvaCardDataReceived(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_AamvaCardDataReceived(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_VendorSpecificDataReceived(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_VendorSpecificDataReceived(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ReleaseDeviceRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ReleaseDeviceRequested(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ErrorOccurred(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ErrorOccurred(event_token token) noexcept = 0;
...
template <> struct abi<Windows::Devices::PointOfService::IClaimedPosPrinter>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_CharacterSet(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CharacterSet(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCoverOpen(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsCharacterSetMappingEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCharacterSetMappingEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_MapMode(Windows::Devices::PointOfService::PosPrinterMapMode value) noexcept = 0;
    virtual HRESULT __stdcall get_MapMode(Windows::Devices::PointOfService::PosPrinterMapMode* value) noexcept = 0;
    virtual HRESULT __stdcall get_Receipt(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Slip(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Journal(void** value) noexcept = 0;
    virtual HRESULT __stdcall EnableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall DisableAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall RetainDeviceAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall ResetStatisticsAsync(void* statisticsCategories, void** result) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_SidewaysMaxLines(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_SidewaysMaxChars(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_LinesToPaperCut(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PageSize(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_PrintArea(Windows::Foundation::Rect* value) noexcept = 0;
    virtual HRESULT __stdcall CreateJob(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IClaimedSlipPrinter>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SidewaysMaxLines(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_SidewaysMaxChars(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxLines(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_LinesNearEndToEnd(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PrintSide(Windows::Devices::PointOfService::PosPrinterPrintSide* value) noexcept = 0;
    virtual HRESULT __stdcall get_PageSize(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_PrintArea(Windows::Foundation::Rect* value) noexcept = 0;
    virtual HRESULT __stdcall OpenJaws() noexcept = 0;
    virtual HRESULT __stdcall CloseJaws() noexcept = 0;
    virtual HRESULT __stdcall InsertSlipAsync(Windows::Foundation::TimeSpan timeout, void** result) noexcept = 0;
    virtual HRESULT __stdcall RemoveSlipAsync(Windows::Foundation::TimeSpan timeout, void** result) noexcept = 0;
    virtual HRESULT __stdcall ChangePrintSide(Windows::Devices::PointOfService::PosPrinterPrintSide printSide) noexcept = 0;
    virtual HRESULT __stdcall CreateJob(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ICommonClaimedPosPrinterStation>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_CharactersPerLine(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CharactersPerLine(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_LineHeight(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_LineHeight(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_LineSpacing(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_LineSpacing(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_LineWidth(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsLetterQuality(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IsLetterQuality(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsPaperNearEnd(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_ColorCartridge(Windows::Devices::PointOfService::PosPrinterColorCartridge value) noexcept = 0;
    virtual HRESULT __stdcall get_ColorCartridge(Windows::Devices::PointOfService::PosPrinterColorCartridge* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCoverOpen(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCartridgeRemoved(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCartridgeEmpty(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsHeadCleaning(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsPaperEmpty(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsReadyToPrint(bool* value) noexcept = 0;
    virtual HRESULT __stdcall ValidateData(HSTRING data, bool* result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ICommonPosPrintStationCapabilities>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsPrinterPresent(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDualColorSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_ColorCartridgeCapabilities(Windows::Devices::PointOfService::PosPrinterColorCapabilities* value) noexcept = 0;
    virtual HRESULT __stdcall get_CartridgeSensors(Windows::Devices::PointOfService::PosPrinterCartridgeSensors* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsBoldSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsItalicSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsUnderlineSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDoubleHighPrintSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDoubleWidePrintSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDoubleHighDoubleWidePrintSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsPaperEmptySensorSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsPaperNearEndSensorSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedCharactersPerLine(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ICommonReceiptSlipCapabilities>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsBarcodeSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsBitmapSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsLeft90RotationSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsRight90RotationSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_Is180RotationSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsPrintAreaSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_RuledLineCapabilities(Windows::Devices::PointOfService::PosPrinterRuledLineCapabilities* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedBarcodeRotations(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedBitmapRotations(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::ILineDisplay>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_DeviceControlVersion(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceServiceVersion(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall ClaimAsync(void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_IsPowerNotifyEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsPowerNotifyEnabled(bool value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_BlinkRate(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_BlinkRate(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_ScreenSizeInCharacters(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall put_ScreenSizeInCharacters(Windows::Foundation::Size value) noexcept = 0;
    virtual HRESULT __stdcall get_CharacterSet(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_CharacterSet(int32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCharacterSetMappingEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsCharacterSetMappingEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_CurrentWindow(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_CurrentWindow(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::ILineDisplayCapabilities>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsStatisticsUpdatingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_PowerReportingType(Windows::Devices::PointOfService::UnifiedPosPowerReportingType* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanChangeScreenSize(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanDisplayBitmaps(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanReadCharacterAtCursor(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanMapCharacterSets(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanDisplayCustomGlyphs(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanReverse(Windows::Devices::PointOfService::LineDisplayTextAttributeGranularity* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanBlink(Windows::Devices::PointOfService::LineDisplayTextAttributeGranularity* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanChangeBlinkRate(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsBrightnessSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCursorSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsHorizontalMarqueeSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsVerticalMarqueeSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsInterCharacterWaitSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedDescriptors(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedWindows(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayCursor>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CanCustomize(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsBlinkSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsBlockSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsHalfBlockSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsUnderlineSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsReverseSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsOtherSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall GetAttributes(void** result) noexcept = 0;
    virtual HRESULT __stdcall TryUpdateAttributesAsync(void* attributes, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayCursorAttributes>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsBlinkEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsBlinkEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_CursorType(Windows::Devices::PointOfService::LineDisplayCursorType* value) noexcept = 0;
    virtual HRESULT __stdcall put_CursorType(Windows::Devices::PointOfService::LineDisplayCursorType value) noexcept = 0;
    virtual HRESULT __stdcall get_IsAutoAdvanceEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsAutoAdvanceEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_Position(Windows::Foundation::Point* value) noexcept = 0;
    virtual HRESULT __stdcall put_Position(Windows::Foundation::Point value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayCustomGlyphs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SizeInPixels(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedGlyphCodes(void** value) noexcept = 0;
    virtual HRESULT __stdcall TryRedefineAsync(uint32_t glyphCode, void* glyphData, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayMarquee>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Format(Windows::Devices::PointOfService::LineDisplayMarqueeFormat* value) noexcept = 0;
    virtual HRESULT __stdcall put_Format(Windows::Devices::PointOfService::LineDisplayMarqueeFormat value) noexcept = 0;
    virtual HRESULT __stdcall get_RepeatWaitInterval(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_RepeatWaitInterval(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall get_ScrollWaitInterval(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_ScrollWaitInterval(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall TryStartScrollingAsync(Windows::Devices::PointOfService::LineDisplayScrollDirection direction, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryStopScrollingAsync(void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_StatisticsCategorySelector(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayStatisticsCategorySelector>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AllStatistics(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_UnifiedPosStatistics(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ManufacturerStatistics(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayStatusUpdatedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Devices::PointOfService::LineDisplayPowerStatus* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayStoredBitmap>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EscapeSequence(HSTRING* escapeSequence) noexcept = 0;
    virtual HRESULT __stdcall TryDeleteAsync(void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayWindow>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SizeInCharacters(Windows::Foundation::Size* value) noexcept = 0;
    virtual HRESULT __stdcall get_InterCharacterWaitInterval(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall put_InterCharacterWaitInterval(Windows::Foundation::TimeSpan value) noexcept = 0;
    virtual HRESULT __stdcall TryRefreshAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayTextAsync(HSTRING text, Windows::Devices::PointOfService::LineDisplayTextAttribute displayAttribute, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayTextAtPositionAsync(HSTRING text, Windows::Devices::PointOfService::LineDisplayTextAttribute displayAttribute, Windows::Foundation::Point startPosition, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayTextNormalAsync(HSTRING text, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryScrollTextAsync(Windows::Devices::PointOfService::LineDisplayScrollDirection direction, uint32_t numberOfColumnsOrRows, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryClearTextAsync(void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ILineDisplayWindow2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Cursor(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Marquee(void** value) noexcept = 0;
    virtual HRESULT __stdcall ReadCharacterAtCursorAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayStoredBitmapAtCursorAsync(void* bitmap, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayStorageFileBitmapAtCursorAsync(void* bitmap, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayStorageFileBitmapAtCursorWithAlignmentAsync(void* bitmap, Windows::Devices::PointOfService::LineDisplayHorizontalAlignment horizontalAlignment, Windows::Devices::PointOfService::LineDisplayVerticalAlignment verticalAlignment, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayStorageFileBitmapAtCursorWithAlignmentAndWidthAsync(void* bitmap, Windows::Devices::PointOfService::LineDisplayHorizontalAlignment horizontalAlignment, Windows::Devices::PointOfService::LineDisplayVerticalAlignment verticalAlignment, int32_t widthInPixels, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayStorageFileBitmapAtPointAsync(void* bitmap, Windows::Foundation::Point offsetInPixels, void** operation) noexcept = 0;
    virtual HRESULT __stdcall TryDisplayStorageFileBitmapAtPointWithWidthAsync(void* bitmap, Windows::Foundation::Point offsetInPixels, int32_t widthInPixels, void** operation) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IMagneticStripeReader>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Capabilities(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedCardTypes(uint32_t* __valueSize, uint32_t** value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceAuthenticationProtocol(Windows::Devices::PointOfService::MagneticStripeReaderAuthenticationProtocol* value) noexcept = 0;
    virtual HRESULT __stdcall CheckHealthAsync(Windows::Devices::PointOfService::UnifiedPosHealthCheckLevel level, void** operation) noexcept = 0;
    virtual HRESULT __stdcall ClaimReaderAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall RetrieveStatisticsAsync(void* statisticsCategories, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetErrorReportingType(Windows::Devices::PointOfService::MagneticStripeReaderErrorReportingType* value) noexcept = 0;
    virtual HRESULT __stdcall add_StatusUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_StatusUpdated(event_token token) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Report(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_LicenseNumber(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExpirationDate(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Restrictions(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Class(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Endorsements(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BirthDate(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_FirstName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Surname(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Suffix(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Gender(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HairColor(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EyeColor(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Height(HSTRING* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Report(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AccountNumber(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExpirationDate(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ServiceCode(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Title(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_FirstName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_MiddleInitial(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Surname(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Suffix(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_CardAuthentication(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedEncryptionAlgorithms(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_AuthenticationLevel(Windows::Devices::PointOfService::MagneticStripeReaderAuthenticationLevel* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsIsoSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsJisOneSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsJisTwoSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_PowerReportingType(Windows::Devices::PointOfService::UnifiedPosPowerReportingType* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatisticsReportingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatisticsUpdatingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsTrackDataMaskingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsTransmitSentinelsSupported(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IMagneticStripeReaderCardTypesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Unknown(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Bank(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Aamva(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedBase(uint32_t* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_None(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_TripleDesDukpt(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedBase(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IMagneticStripeReaderErrorOccurredEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Track1Status(Windows::Devices::PointOfService::MagneticStripeReaderTrackErrorType* value) noexcept = 0;
    virtual HRESULT __stdcall get_Track2Status(Windows::Devices::PointOfService::MagneticStripeReaderTrackErrorType* value) noexcept = 0;
    virtual HRESULT __stdcall get_Track3Status(Windows::Devices::PointOfService::MagneticStripeReaderTrackErrorType* value) noexcept = 0;
    virtual HRESULT __stdcall get_Track4Status(Windows::Devices::PointOfService::MagneticStripeReaderTrackErrorType* value) noexcept = 0;
    virtual HRESULT __stdcall get_ErrorData(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PartialInputData(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_CardType(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Track1(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Track2(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Track3(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Track4(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Properties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CardAuthenticationData(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CardAuthenticationDataLength(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_AdditionalSecurityInformation(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::Devices::PointOfService::MagneticStripeReaderStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedStatus(uint32_t* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IMagneticStripeReaderTrackData>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_DiscretionaryData(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_EncryptedData(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IPosPrinter>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Capabilities(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedCharacterSets(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedTypeFaces(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Status(void** value) noexcept = 0;
    virtual HRESULT __stdcall ClaimPrinterAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall CheckHealthAsync(Windows::Devices::PointOfService::UnifiedPosHealthCheckLevel level, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetStatisticsAsync(void* statisticsCategories, void** operation) noexcept = 0;
    virtual HRESULT __stdcall add_StatusUpdated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_StatusUpdated(event_token token) noexcept = 0;
...
template <> struct abi<Windows::Devices::PointOfService::IPosPrinterCapabilities>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsStatisticsReportingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStatisticsUpdatingSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_DefaultCharacterSet(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_HasCoverSensor(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_CanMapCharacterSet(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsTransactionSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_Receipt(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Slip(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Journal(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Utf16LE(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ascii(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ansi(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IPosPrinterJob>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Print(HSTRING data) noexcept = 0;
    virtual HRESULT __stdcall PrintLine(HSTRING data) noexcept = 0;
    virtual HRESULT __stdcall PrintNewline() noexcept = 0;
    virtual HRESULT __stdcall ExecuteAsync(void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_StatusKind(Windows::Devices::PointOfService::PosPrinterStatusKind* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedStatus(uint32_t* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall SetBarcodeRotation(Windows::Devices::PointOfService::PosPrinterRotation value) noexcept = 0;
    virtual HRESULT __stdcall SetPrintRotation(Windows::Devices::PointOfService::PosPrinterRotation value, bool includeBitmaps) noexcept = 0;
    virtual HRESULT __stdcall SetPrintArea(Windows::Foundation::Rect value) noexcept = 0;
    virtual HRESULT __stdcall SetBitmap(uint32_t bitmapNumber, void* bitmap, Windows::Devices::PointOfService::PosPrinterAlignment alignment) noexcept = 0;
    virtual HRESULT __stdcall SetBitmapCustomWidthStandardAlign(uint32_t bitmapNumber, void* bitmap, Windows::Devices::PointOfService::PosPrinterAlignment alignment, uint32_t width) noexcept = 0;
    virtual HRESULT __stdcall SetCustomAlignedBitmap(uint32_t bitmapNumber, void* bitmap, uint32_t alignmentDistance) noexcept = 0;
    virtual HRESULT __stdcall SetBitmapCustomWidthCustomAlign(uint32_t bitmapNumber, void* bitmap, uint32_t alignmentDistance, uint32_t width) noexcept = 0;
    virtual HRESULT __stdcall PrintSavedBitmap(uint32_t bitmapNumber) noexcept = 0;
    virtual HRESULT __stdcall DrawRuledLine(HSTRING positionList, Windows::Devices::PointOfService::PosPrinterLineDirection lineDirection, uint32_t lineWidth, Windows::Devices::PointOfService::PosPrinterLineStyle lineStyle, uint32_t lineColor) noexcept = 0;
    virtual HRESULT __stdcall PrintBarcode(HSTRING data, uint32_t symbology, uint32_t height, uint32_t width, Windows::Devices::PointOfService::PosPrinterBarcodeTextPosition textPosition, Windows::Devices::PointOfService::PosPrinterAlignment alignment) noexcept = 0;
    virtual HRESULT __stdcall PrintBarcodeCustomAlign(HSTRING data, uint32_t symbology, uint32_t height, uint32_t width, Windows::Devices::PointOfService::PosPrinterBarcodeTextPosition textPosition, uint32_t alignmentDistance) noexcept = 0;
    virtual HRESULT __stdcall PrintBitmap(void* bitmap, Windows::Devices::PointOfService::PosPrinterAlignment alignment) noexcept = 0;
    virtual HRESULT __stdcall PrintBitmapCustomWidthStandardAlign(void* bitmap, Windows::Devices::PointOfService::PosPrinterAlignment alignment, uint32_t width) noexcept = 0;
    virtual HRESULT __stdcall PrintCustomAlignedBitmap(void* bitmap, uint32_t alignmentDistance) noexcept = 0;
    virtual HRESULT __stdcall PrintBitmapCustomWidthCustomAlign(void* bitmap, uint32_t alignmentDistance, uint32_t width) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IReceiptPrintJob>{ struct type : IInspectable
{
    virtual HRESULT __stdcall MarkFeed(Windows::Devices::PointOfService::PosPrinterMarkFeedKind kind) noexcept = 0;
    virtual HRESULT __stdcall CutPaper(double percentage) noexcept = 0;
    virtual HRESULT __stdcall CutPaperDefault() noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IReceiptPrinterCapabilities>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CanCutPaper(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStampSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_MarkFeedCapabilities(Windows::Devices::PointOfService::PosPrinterMarkFeedCapabilities* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::ISlipPrinterCapabilities>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsFullLengthSupported(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsBothSidesPrintingSupported(bool* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::PointOfService::IUnifiedPosErrorData>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Severity(Windows::Devices::PointOfService::UnifiedPosErrorSeverity* value) noexcept = 0;
    virtual HRESULT __stdcall get_Reason(Windows::Devices::PointOfService::UnifiedPosErrorReason* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendedReason(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::PointOfService::IUnifiedPosErrorDataFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(HSTRING message, Windows::Devices::PointOfService::UnifiedPosErrorSeverity severity, Windows::Devices::PointOfService::UnifiedPosErrorReason reason, uint32_t extendedReason, void** result) noexcept = 0;
};};
