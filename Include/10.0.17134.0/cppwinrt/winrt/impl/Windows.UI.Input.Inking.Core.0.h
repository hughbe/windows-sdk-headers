...
{
    virtual HRESULT __stdcall AppendInkPoints(void* inkPoints, Windows::Foundation::Rect* result) noexcept = 0;
    virtual HRESULT __stdcall CreateInkStroke(void** result) noexcept = 0;
    virtual HRESULT __stdcall get_DrawingAttributes(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PointTransform(Windows::Foundation::Numerics::float3x2* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall Create(void* drawingAttributes, Windows::Foundation::Numerics::float3x2 pointTransform, void** result) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Inking::Core::ICoreInkIndependentInputSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_PointerEntering(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerEntering(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerHovering(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerHovering(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerExiting(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerExiting(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerPressing(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerPressing(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerMoving(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerMoving(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerReleasing(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerReleasing(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_PointerLost(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_PointerLost(event_token cookie) noexcept = 0;
...
{
    virtual HRESULT __stdcall Create(void* inkPresenter, void** inkIndependentInputSource) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Inking::Core::ICoreInkPresenterHost>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InkPresenter(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RootVisual(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_RootVisual(void* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Inking::Core::ICoreWetStrokeUpdateEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_NewInkPoints(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PointerId(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Disposition(Windows::UI::Input::Inking::Core::CoreWetStrokeDisposition* value) noexcept = 0;
    virtual HRESULT __stdcall put_Disposition(Windows::UI::Input::Inking::Core::CoreWetStrokeDisposition value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Inking::Core::ICoreWetStrokeUpdateSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_WetStrokeStarting(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_WetStrokeStarting(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_WetStrokeContinuing(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_WetStrokeContinuing(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_WetStrokeStopping(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_WetStrokeStopping(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_WetStrokeCompleted(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_WetStrokeCompleted(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall add_WetStrokeCanceled(void* handler, event_token* cookie) noexcept = 0;
    virtual HRESULT __stdcall remove_WetStrokeCanceled(event_token cookie) noexcept = 0;
    virtual HRESULT __stdcall get_InkPresenter(void** value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Input::Inking::Core::ICoreWetStrokeUpdateSourceStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(void* inkPresenter, void** WetStrokeUpdateSource) noexcept = 0;
};};
