...
{
    virtual HRESULT __stdcall add_RegistrationCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_RegistrationCompleted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ProximityDetectionCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ProximityDetectionCompleted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_LicenseFetchCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_LicenseFetchCompleted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ReRegistrationNeeded(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ReRegistrationNeeded(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ClosedCaptionDataReceived(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ClosedCaptionDataReceived(event_token token) noexcept = 0;
    virtual HRESULT __stdcall StartAsync(void* contentUrl, uint32_t startAsyncOptions, void* registrationCustomData, void* licenseFetchDescriptor, void** result) noexcept = 0;
    virtual HRESULT __stdcall LicenseFetchAsync(void* licenseFetchDescriptor, void** result) noexcept = 0;
    virtual HRESULT __stdcall ReRegistrationAsync(void* registrationCustomData, void** result) noexcept = 0;
...
{
    virtual HRESULT __stdcall CreateInstance(void* downloadEngine, void* streamParser, void* pMessenger, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDClosedCaptionDataReceivedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ClosedCaptionDataFormat(Windows::Media::Protection::PlayReady::NDClosedCaptionFormat* ccForamt) noexcept = 0;
    virtual HRESULT __stdcall get_PresentationTimestamp(int64_t* presentationTimestamp) noexcept = 0;
    virtual HRESULT __stdcall get_ClosedCaptionData(uint32_t* __ccDataBytesSize, uint8_t** ccDataBytes) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDCustomData>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CustomDataTypeID(uint32_t* __customDataTypeIDBytesSize, uint8_t** customDataTypeIDBytes) noexcept = 0;
    virtual HRESULT __stdcall get_CustomData(uint32_t* __customDataBytesSize, uint8_t** customDataBytes) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDCustomDataFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(uint32_t __customDataTypeIDBytesSize, uint8_t* customDataTypeIDBytes, uint32_t __customDataBytesSize, uint8_t* customDataBytes, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDDownloadEngine>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Open(void* uri, uint32_t __sessionIDBytesSize, uint8_t* sessionIDBytes) noexcept = 0;
    virtual HRESULT __stdcall Pause() noexcept = 0;
    virtual HRESULT __stdcall Resume() noexcept = 0;
    virtual HRESULT __stdcall Close() noexcept = 0;
    virtual HRESULT __stdcall Seek(Windows::Foundation::TimeSpan startPosition) noexcept = 0;
    virtual HRESULT __stdcall get_CanSeek(bool* canSeek) noexcept = 0;
    virtual HRESULT __stdcall get_BufferFullMinThresholdInSamples(uint32_t* bufferFullMinThreshold) noexcept = 0;
    virtual HRESULT __stdcall get_BufferFullMaxThresholdInSamples(uint32_t* bufferFullMaxThreshold) noexcept = 0;
    virtual HRESULT __stdcall get_Notifier(void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDDownloadEngineNotifier>{ struct type : IInspectable
{
    virtual HRESULT __stdcall OnStreamOpened() noexcept = 0;
    virtual HRESULT __stdcall OnPlayReadyObjectReceived(uint32_t __dataBytesSize, uint8_t* dataBytes) noexcept = 0;
    virtual HRESULT __stdcall OnContentIDReceived(void* licenseFetchDescriptor) noexcept = 0;
    virtual HRESULT __stdcall OnDataReceived(uint32_t __dataBytesSize, uint8_t* dataBytes, uint32_t bytesReceived) noexcept = 0;
    virtual HRESULT __stdcall OnEndOfStream() noexcept = 0;
    virtual HRESULT __stdcall OnNetworkError() noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDLicenseFetchCompletedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ResponseCustomData(void** customData) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDLicenseFetchDescriptor>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ContentIDType(Windows::Media::Protection::PlayReady::NDContentIDType* contentIDType) noexcept = 0;
    virtual HRESULT __stdcall get_ContentID(uint32_t* __contentIDBytesSize, uint8_t** contentIDBytes) noexcept = 0;
    virtual HRESULT __stdcall get_LicenseFetchChallengeCustomData(void** licenseFetchChallengeCustomData) noexcept = 0;
    virtual HRESULT __stdcall put_LicenseFetchChallengeCustomData(void* licenseFetchChallengeCustomData) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDLicenseFetchDescriptorFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(Windows::Media::Protection::PlayReady::NDContentIDType contentIDType, uint32_t __contentIDBytesSize, uint8_t* contentIDBytes, void* licenseFetchChallengeCustomData, void** instance) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall SendRegistrationRequestAsync(uint32_t __sessionIDBytesSize, uint8_t* sessionIDBytes, uint32_t __challengeDataBytesSize, uint8_t* challengeDataBytes, void** result) noexcept = 0;
    ...
    virtual HRESULT __stdcall SendLicenseFetchRequestAsync(uint32_t __sessionIDBytesSize, uint8_t* sessionIDBytes, uint32_t __challengeDataBytesSize, uint8_t* challengeDataBytes, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDProximityDetectionCompletedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ProximityDetectionRetryCount(uint32_t* retryCount) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDRegistrationCompletedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ResponseCustomData(void** customData) noexcept = 0;
    virtual HRESULT __stdcall get_TransmitterProperties(void** transmitterProperties) noexcept = 0;
    virtual HRESULT __stdcall get_TransmitterCertificateAccepted(bool* acceptpt) noexcept = 0;
    virtual HRESULT __stdcall put_TransmitterCertificateAccepted(bool accept) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDSendResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Response(uint32_t* __responseDataBytesSize, uint8_t** responseDataBytes) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDStartResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_MediaStreamSource(void** mediaStreamSource) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDStorageFileHelper>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetFileURLs(void* file, void** fileURLs) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDStreamParser>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ParseData(uint32_t __dataBytesSize, uint8_t* dataBytes) noexcept = 0;
    virtual HRESULT __stdcall GetStreamInformation(void* descriptor, Windows::Media::Protection::PlayReady::NDMediaStreamType* streamType, uint32_t* streamID) noexcept = 0;
    virtual HRESULT __stdcall BeginOfStream() noexcept = 0;
    virtual HRESULT __stdcall EndOfStream() noexcept = 0;
    virtual HRESULT __stdcall get_Notifier(void** instance) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall OnContentIDReceived(void* licenseFetchDescriptor) noexcept = 0;
    virtual HRESULT __stdcall OnMediaStreamDescriptorCreated(void* audioStreamDescriptors, void* videoStreamDescriptors) noexcept = 0;
    virtual HRESULT __stdcall OnSampleParsed(uint32_t streamID, Windows::Media::Protection::PlayReady::NDMediaStreamType streamType, void* streamSample, int64_t pts, Windows::Media::Protection::PlayReady::NDClosedCaptionFormat ccFormat, uint32_t __ccDataBytesSize, uint8_t* ccDataBytes) noexcept = 0;
    virtual HRESULT __stdcall OnBeginSetupDecryptor(void* descriptor, GUID keyID, uint32_t __proBytesSize, uint8_t* proBytes) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDTCPMessengerFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(HSTRING remoteHostName, uint32_t remoteHostPort, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::INDTransmitterProperties>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CertificateType(Windows::Media::Protection::PlayReady::NDCertificateType* type) noexcept = 0;
    virtual HRESULT __stdcall get_PlatformIdentifier(Windows::Media::Protection::PlayReady::NDCertificatePlatformID* identifier) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedFeatures(uint32_t* __featureSetsSize, Windows::Media::Protection::PlayReady::NDCertificateFeature** featureSets) noexcept = 0;
    virtual HRESULT __stdcall get_SecurityLevel(uint32_t* level) noexcept = 0;
    virtual HRESULT __stdcall get_SecurityVersion(uint32_t* securityVersion) noexcept = 0;
    virtual HRESULT __stdcall get_ExpirationDate(Windows::Foundation::DateTime* expirationDate) noexcept = 0;
    virtual HRESULT __stdcall get_ClientID(uint32_t* __clientIDBytesSize, uint8_t** clientIDBytes) noexcept = 0;
    virtual HRESULT __stdcall get_ModelDigest(uint32_t* __modelDigestBytesSize, uint8_t** modelDigestBytes) noexcept = 0;
    virtual HRESULT __stdcall get_ModelManufacturerName(HSTRING* modelManufacturerName) noexcept = 0;
    virtual HRESULT __stdcall get_ModelName(HSTRING* modelName) noexcept = 0;
    virtual HRESULT __stdcall get_ModelNumber(HSTRING* modelNumber) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyContentHeader>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_KeyId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyIdString(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_LicenseAcquisitionUrl(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_LicenseAcquisitionUserInterfaceUrl(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DomainServiceId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_EncryptionType(Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm* value) noexcept = 0;
    virtual HRESULT __stdcall get_CustomAttributes(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DecryptorSetup(Windows::Media::Protection::PlayReady::PlayReadyDecryptorSetup* value) noexcept = 0;
    virtual HRESULT __stdcall GetSerializedHeader(uint32_t* __headerBytesSize, uint8_t** headerBytes) noexcept = 0;
    virtual HRESULT __stdcall get_HeaderWithEmbeddedUpdates(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyContentHeader2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_KeyIds(uint32_t* __contentKeyIdsSize, GUID** contentKeyIds) noexcept = 0;
    virtual HRESULT __stdcall get_KeyIdStrings(uint32_t* __contentKeyIdStringsSize, HSTRING** contentKeyIdStrings) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyContentHeaderFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstanceFromWindowsMediaDrmHeader(uint32_t __headerBytesSize, uint8_t* headerBytes, void* licenseAcquisitionUrl, void* licenseAcquisitionUserInterfaceUrl, HSTRING customAttributes, GUID domainServiceId, void** instance) noexcept = 0;
    virtual HRESULT __stdcall CreateInstanceFromComponents(GUID contentKeyId, HSTRING contentKeyIdString, Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm contentEncryptionAlgorithm, void* licenseAcquisitionUrl, void* licenseAcquisitionUserInterfaceUrl, HSTRING customAttributes, GUID domainServiceId, void** instance) noexcept = 0;
    virtual HRESULT __stdcall CreateInstanceFromPlayReadyHeader(uint32_t __headerBytesSize, uint8_t* headerBytes, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyContentHeaderFactory2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstanceFromComponents2(uint32_t dwFlags, uint32_t __contentKeyIdsSize, GUID* contentKeyIds, uint32_t __contentKeyIdStringsSize, HSTRING* contentKeyIdStrings, Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm contentEncryptionAlgorithm, void* licenseAcquisitionUrl, void* licenseAcquisitionUserInterfaceUrl, HSTRING customAttributes, GUID domainServiceId, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyContentResolver>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ServiceRequest(void* contentHeader, void** serviceRequest) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyDomain>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AccountId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_ServiceId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_Revision(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_FriendlyName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DomainJoinUrl(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyDomainIterableFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(GUID domainAccountId, void** domainIterable) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyDomainJoinServiceRequest>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DomainAccountId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall put_DomainAccountId(GUID value) noexcept = 0;
    virtual HRESULT __stdcall get_DomainFriendlyName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_DomainFriendlyName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_DomainServiceId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall put_DomainServiceId(GUID value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GenerateData(GUID guidCPSystemId, uint32_t countOfStreams, void* configuration, Windows::Media::Protection::PlayReady::PlayReadyITADataFormat format, uint32_t* __dataBytesSize, uint8_t** dataBytes) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_FullyEvaluated(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_UsableForPlay(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExpirationDate(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ExpireAfterFirstPlay(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_DomainAccountID(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_ChainDepth(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall GetKIDAtChainDepth(uint32_t chainDepth, GUID* kid) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyLicense2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SecureStopId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_SecurityLevel(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_InMemoryOnly(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExpiresInRealTime(bool* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ContentHeader(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ContentHeader(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_DomainServiceId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall put_DomainServiceId(GUID value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_SessionId(GUID* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateLicenseIterable(void* contentHeader, bool fullyEvaluated, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyLicenseIterableFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(void* contentHeader, bool fullyEvaluated, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyLicenseManagement>{ struct type : IInspectable
{
    virtual HRESULT __stdcall DeleteLicenses(void* contentHeader, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyLicenseSession>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateLAServiceRequest(void** serviceRequest) noexcept = 0;
    virtual HRESULT __stdcall ConfigureMediaProtectionManager(void* mpm) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyLicenseSession2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateLicenseIterable(void* contentHeader, bool fullyEvaluated, void** licenseIterable) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyLicenseSessionFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateInstance(void* configuration, void** instance) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyMeteringReportServiceRequest>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_MeteringCertificate(uint32_t* __meteringCertBytesSize, uint8_t** meteringCertBytes) noexcept = 0;
    virtual HRESULT __stdcall put_MeteringCertificate(uint32_t __meteringCertBytesSize, uint8_t* meteringCertBytes) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstance(uint32_t __publisherCertBytesSize, uint8_t* publisherCertBytes, void** instance) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadySecureStopServiceRequest>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Stopped(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_PublisherCertificate(uint32_t* __publisherCertBytesSize, uint8_t** publisherCertBytes) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstance(uint32_t __publisherCertBytesSize, uint8_t* publisherCertBytes, void** instance) noexcept = 0;
    virtual HRESULT __stdcall CreateInstanceFromSessionID(GUID sessionID, uint32_t __publisherCertBytesSize, uint8_t* publisherCertBytes, void** instance) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyServiceRequest>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ResponseCustomData(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ChallengeCustomData(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ChallengeCustomData(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall BeginServiceRequest(void** action) noexcept = 0;
    virtual HRESULT __stdcall NextServiceRequest(void** serviceRequest) noexcept = 0;
    virtual HRESULT __stdcall GenerateManualEnablingChallenge(void** challengeMessage) noexcept = 0;
    virtual HRESULT __stdcall ProcessManualEnablingResponse(uint32_t __responseBytesSize, uint8_t* responseBytes, HRESULT* result) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadySoapMessage>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetMessageBody(uint32_t* __messageBodyBytesSize, uint8_t** messageBodyBytes) noexcept = 0;
    virtual HRESULT __stdcall get_MessageHeaders(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Uri(void** messageUri) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_DomainJoinServiceRequestType(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_DomainLeaveServiceRequestType(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_IndividualizationServiceRequestType(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_LicenseAcquirerServiceRequestType(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_MeteringReportServiceRequestType(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_RevocationServiceRequestType(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_MediaProtectionSystemId(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_PlayReadySecurityVersion(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_PlayReadyCertificateSecurityLevel(uint32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyStatics3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SecureStopServiceRequestType(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall CheckSupportedHardware(Windows::Media::Protection::PlayReady::PlayReadyHardwareDRMFeatures hwdrmFeature, bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyStatics4>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InputTrustAuthorityToCreate(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ProtectionSystemId(GUID* value) noexcept = 0;
};};
