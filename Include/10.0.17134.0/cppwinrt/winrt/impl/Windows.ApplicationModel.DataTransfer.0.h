...
template <> struct guid<Windows::ApplicationModel::DataTransfer::IDataPackagePropertySet4>{ static constexpr GUID value{ 0x6390EBF5,0x1739,0x4C74,{ 0xB2,0x2F,0x86,0x5F,0xAB,0x5E,0x85,0x45 } }; };
...
template <> struct guid<Windows::ApplicationModel::DataTransfer::IDataPackagePropertySetView4>{ static constexpr GUID value{ 0x4474C80D,0xD16F,0x40AE,{ 0x95,0x80,0x6F,0x85,0x62,0xB9,0x42,0x35 } }; };
...
template <> struct guid<Windows::ApplicationModel::DataTransfer::IStandardDataFormatsStatics3>{ static constexpr GUID value{ 0x3B57B069,0x01D4,0x474C,{ 0x8B,0x5F,0xBC,0x8E,0x27,0xF3,0x8B,0x21 } }; };
...
{
    virtual HRESULT __stdcall GetContent(void** content) noexcept = 0;
    virtual HRESULT __stdcall SetContent(void* content) noexcept = 0;
    virtual HRESULT __stdcall Flush() noexcept = 0;
    virtual HRESULT __stdcall Clear() noexcept = 0;
    virtual HRESULT __stdcall add_ContentChanged(void* changeHandler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ContentChanged(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackage>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetView(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Properties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RequestedOperation(Windows::ApplicationModel::DataTransfer::DataPackageOperation* value) noexcept = 0;
    virtual HRESULT __stdcall put_RequestedOperation(Windows::ApplicationModel::DataTransfer::DataPackageOperation value) noexcept = 0;
    virtual HRESULT __stdcall add_OperationCompleted(void* handler, event_token* eventCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_OperationCompleted(event_token eventCookie) noexcept = 0;
    virtual HRESULT __stdcall add_Destroyed(void* handler, event_token* eventCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_Destroyed(event_token eventCookie) noexcept = 0;
    virtual HRESULT __stdcall SetData(HSTRING formatId, void* value) noexcept = 0;
    virtual HRESULT __stdcall SetDataProvider(HSTRING formatId, void* delayRenderer) noexcept = 0;
    virtual HRESULT __stdcall SetText(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall SetUri(void* value) noexcept = 0;
    virtual HRESULT __stdcall SetHtmlFormat(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_ResourceMap(void** value) noexcept = 0;
    virtual HRESULT __stdcall SetRtf(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall SetBitmap(void* value) noexcept = 0;
    virtual HRESULT __stdcall SetStorageItemsReadOnly(void* value) noexcept = 0;
    virtual HRESULT __stdcall SetStorageItems(void* value, bool readOnly) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackage2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall SetApplicationLink(void* value) noexcept = 0;
    virtual HRESULT __stdcall SetWebLink(void* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackage3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_ShareCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ShareCompleted(event_token token) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackagePropertySet>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_FileTypes(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ApplicationName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ApplicationName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_ApplicationListingUri(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ApplicationListingUri(void* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackagePropertySet2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ContentSourceWebLink(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ContentSourceWebLink(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_ContentSourceApplicationLink(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ContentSourceApplicationLink(void* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_LogoBackgroundColor(struct struct_Windows_UI_Color* value) noexcept = 0;
    virtual HRESULT __stdcall put_LogoBackgroundColor(struct struct_Windows_UI_Color value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_ContentSourceUserActivityJson(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ContentSourceUserActivityJson(HSTRING value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackageView>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Properties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RequestedOperation(Windows::ApplicationModel::DataTransfer::DataPackageOperation* value) noexcept = 0;
    virtual HRESULT __stdcall ReportOperationCompleted(Windows::ApplicationModel::DataTransfer::DataPackageOperation value) noexcept = 0;
    virtual HRESULT __stdcall get_AvailableFormats(void** formatIds) noexcept = 0;
    virtual HRESULT __stdcall Contains(HSTRING formatId, bool* value) noexcept = 0;
    virtual HRESULT __stdcall GetDataAsync(HSTRING formatId, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetTextAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetCustomTextAsync(HSTRING formatId, void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetUriAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetHtmlFormatAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetResourceMapAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetRtfAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetBitmapAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetStorageItemsAsync(void** operation) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackageView2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetApplicationLinkAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall GetWebLinkAsync(void** operation) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackageView3>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall RequestAccessWithEnterpriseIdAsync(HSTRING enterpriseId, void** operation) noexcept = 0;
    virtual HRESULT __stdcall UnlockAndAssumeEnterpriseIdentity(Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult* result) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataPackageView4>{ struct type : IInspectable
{
    virtual HRESULT __stdcall SetAcceptedFormatId(HSTRING formatId) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_FormatId(HSTRING* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall SetData(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataRequest>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Deadline(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual HRESULT __stdcall FailWithDisplayText(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall GetDeferral(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall add_DataRequested(void* eventHandler, event_token* eventCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_DataRequested(event_token eventCookie) noexcept = 0;
    virtual HRESULT __stdcall add_TargetApplicationChosen(void* eventHandler, event_token* eventCookie) noexcept = 0;
    virtual HRESULT __stdcall remove_TargetApplicationChosen(event_token eventCookie) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataTransferManager2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_ShareProvidersRequested(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ShareProvidersRequested(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IDataTransferManagerStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ShowShareUI() noexcept = 0;
...
{
    virtual HRESULT __stdcall ShowShareUIWithOptions(void* options) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IHtmlFormatHelperStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetStaticFragment(HSTRING htmlFormat, HSTRING* htmlFragment) noexcept = 0;
    virtual HRESULT __stdcall CreateHtmlFormat(HSTRING htmlFragment, HSTRING* htmlFormat) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IOperationCompletedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Operation(Windows::ApplicationModel::DataTransfer::DataPackageOperation* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IOperationCompletedEventArgs2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AcceptedFormatId(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IShareCompletedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ShareTarget(void** value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IShareProvider>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Title(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DisplayIcon(void** value) noexcept = 0;
...
{
    virtual HRESULT __stdcall Create(HSTRING title, void* displayIcon, struct struct_Windows_UI_Color backgroundColor, void* handler, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Providers(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Data(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetDeferral(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::IShareTargetInfo>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ShareProvider(void** value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IShareUIOptions>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Theme(Windows::ApplicationModel::DataTransfer::ShareUITheme* value) noexcept = 0;
    virtual HRESULT __stdcall put_Theme(Windows::ApplicationModel::DataTransfer::ShareUITheme value) noexcept = 0;
...
{
    virtual HRESULT __stdcall AddFile(void* file, HSTRING* outToken) noexcept = 0;
    virtual HRESULT __stdcall RedeemTokenForFileAsync(HSTRING token, void** operation) noexcept = 0;
    virtual HRESULT __stdcall RemoveFile(HSTRING token) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::IStandardDataFormatsStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Html(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Rtf(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Bitmap(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_StorageItems(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IStandardDataFormatsStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_WebLink(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ApplicationLink(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::IStandardDataFormatsStatics3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_UserActivityJsonArray(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Invoke(void* request) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::DataTransfer::ShareProviderHandler>{ struct type : IUnknown
{
    virtual HRESULT __stdcall Invoke(void* operation) noexcept = 0;
};};
