...
template <> struct guid<Windows::ApplicationModel::Core::IAppListEntry3>{ static constexpr GUID value{ 0x6099F28D,0xFC32,0x470A,{ 0xBC,0x69,0x4B,0x06,0x1A,0x76,0xEF,0x2E } }; };
...
{
    virtual HRESULT __stdcall LaunchForUserAsync(void* user, void** operation) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplication>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_Suspending(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_Suspending(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_Resuming(void* handler, event_token* token) noexcept = 0;
    ...
    virtual HRESULT __stdcall GetCurrentView(void** value) noexcept = 0;
    virtual HRESULT __stdcall Run(void* viewSource) noexcept = 0;
    virtual HRESULT __stdcall RunWithActivationFactories(void* activationFactoryCallback) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplication2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_LeavingBackground(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_LeavingBackground(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_EnteredBackground(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_EnteredBackground(event_token token) noexcept = 0;
    virtual HRESULT __stdcall EnablePrelaunch(bool value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::ICoreApplication3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RequestRestartAsync(HSTRING launchArguments, void** operation) noexcept = 0;
    virtual HRESULT __stdcall RequestRestartForUserAsync(void* user, HSTRING launchArguments, void** operation) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationExit>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_Exiting(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_Exiting(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationUnhandledError>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_UnhandledErrorDetected(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_UnhandledErrorDetected(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationUseCount>{ struct type : IInspectable
{
    virtual HRESULT __stdcall IncrementApplicationUseCount() noexcept = 0;
    virtual HRESULT __stdcall DecrementApplicationUseCount() noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationView>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_Activated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_Activated(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_IsMain(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsHosted(bool* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_IsComponent(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_TitleBar(void** value) noexcept = 0;
    virtual HRESULT __stdcall add_HostedViewClosing(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_HostedViewClosing(event_token token) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall put_ExtendViewIntoTitleBar(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_ExtendViewIntoTitleBar(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_SystemOverlayLeftInset(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_SystemOverlayRightInset(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_Height(double* value) noexcept = 0;
    virtual HRESULT __stdcall add_LayoutMetricsChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_LayoutMetricsChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_IsVisible(bool* value) noexcept = 0;
    virtual HRESULT __stdcall add_IsVisibleChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_IsVisibleChanged(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::ICoreImmersiveApplication>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Views(void** value) noexcept = 0;
    virtual HRESULT __stdcall CreateNewView(HSTRING runtimeType, HSTRING entryPoint, void** view) noexcept = 0;
    virtual HRESULT __stdcall get_MainView(void** value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::ICoreImmersiveApplication2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateNewViewFromMainView(void** view) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::ICoreImmersiveApplication3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateNewViewWithViewSource(void* viewSource, void** view) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::IFrameworkView>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Initialize(void* applicationView) noexcept = 0;
    virtual HRESULT __stdcall SetWindow(void* window) noexcept = 0;
    virtual HRESULT __stdcall Load(HSTRING entryPoint) noexcept = 0;
    virtual HRESULT __stdcall Run() noexcept = 0;
    virtual HRESULT __stdcall Uninitialize() noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::IFrameworkViewSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateView(void** viewProvider) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Core::IUnhandledError>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall Propagate() noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Core::IUnhandledErrorDetectedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_UnhandledError(void** value) noexcept = 0;
};};
