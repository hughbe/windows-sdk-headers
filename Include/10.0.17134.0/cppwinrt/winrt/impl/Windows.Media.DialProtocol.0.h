...
template <> struct guid<Windows::Media::DialProtocol::IDialReceiverApp2>{ static constexpr GUID value{ 0x530C5805,0x9130,0x42AC,{ 0xA5,0x04,0x19,0x77,0xDC,0xB2,0xEA,0x8A } }; };
...
template <> struct abi<Windows::Media::DialProtocol::IDialApp>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall RequestLaunchAsync(HSTRING appArgument, void** value) noexcept = 0;
    virtual HRESULT __stdcall StopAsync(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetAppStateAsync(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::DialProtocol::IDialAppStateDetails>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_State(Windows::Media::DialProtocol::DialAppState* value) noexcept = 0;
    virtual HRESULT __stdcall get_FullXml(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::DialProtocol::IDialDevice>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall GetDialApp(HSTRING appName, void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Filter(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Appearance(void** value) noexcept = 0;
    virtual HRESULT __stdcall add_DialDeviceSelected(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DialDeviceSelected(event_token token) noexcept = 0;
    ...
    virtual HRESULT __stdcall add_DialDevicePickerDismissed(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_DialDevicePickerDismissed(event_token token) noexcept = 0;
    virtual HRESULT __stdcall Show(Windows::Foundation::Rect selection) noexcept = 0;
    virtual HRESULT __stdcall ShowWithPlacement(Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement) noexcept = 0;
    virtual HRESULT __stdcall PickSingleDialDeviceAsync(Windows::Foundation::Rect selection, void** operation) noexcept = 0;
    virtual HRESULT __stdcall PickSingleDialDeviceAsyncWithPlacement(Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** operation) noexcept = 0;
    virtual HRESULT __stdcall Hide() noexcept = 0;
    virtual HRESULT __stdcall SetDisplayStatus(void* device, Windows::Media::DialProtocol::DialDeviceDisplayStatus status) noexcept = 0;
};};

template <> struct abi<Windows::Media::DialProtocol::IDialDevicePickerFilter>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SupportedAppNames(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::DialProtocol::IDialDeviceSelectedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SelectedDialDevice(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::DialProtocol::IDialDeviceStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetDeviceSelector(HSTRING appName, HSTRING* selector) noexcept = 0;
    virtual HRESULT __stdcall FromIdAsync(HSTRING value, void** operation) noexcept = 0;
    virtual HRESULT __stdcall DeviceInfoSupportsDialAsync(void* device, void** operation) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetAdditionalDataAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall SetAdditionalDataAsync(void* additionalData, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Media::DialProtocol::IDialReceiverApp2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetUniqueDeviceNameAsync(void** operation) noexcept = 0;
};};
