...
template <> struct abi<Windows::UI::Popups::IMessageDialog>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Content(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_Content(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall ShowAsync(void** messageDialogAsyncOperation) noexcept = 0;
    virtual HRESULT __stdcall get_Options(Windows::UI::Popups::MessageDialogOptions* value) noexcept = 0;
    virtual HRESULT __stdcall put_Options(Windows::UI::Popups::MessageDialogOptions value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Popups::IMessageDialogFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(HSTRING content, void** messageDialog) noexcept = 0;
    virtual HRESULT __stdcall CreateWithTitle(HSTRING content, HSTRING title, void** messageDialog) noexcept = 0;
};};

template <> struct abi<Windows::UI::Popups::IPopupMenu>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Commands(void** value) noexcept = 0;
    virtual HRESULT __stdcall ShowAsync(Windows::Foundation::Point invocationPoint, void** asyncOperation) noexcept = 0;
    virtual HRESULT __stdcall ShowAsyncWithRect(Windows::Foundation::Rect selection, void** asyncOperation) noexcept = 0;
    virtual HRESULT __stdcall ShowAsyncWithRectAndPlacement(Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, void** asyncOperation) noexcept = 0;
};};
...
template <> struct abi<Windows::UI::Popups::IUICommand>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_Invoked(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Id(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_Id(void* value) noexcept = 0;
};};

template <> struct abi<Windows::UI::Popups::IUICommandFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(HSTRING label, void** instance) noexcept = 0;
    virtual HRESULT __stdcall CreateWithHandler(HSTRING label, void* action, void** instance) noexcept = 0;
    virtual HRESULT __stdcall CreateWithHandlerAndId(HSTRING label, void* action, void* commandId, void** instance) noexcept = 0;
};};
