...
{
    virtual HRESULT __stdcall BuildChainAsync(void* certificates, void** value) noexcept = 0;
    virtual HRESULT __stdcall BuildChainWithParametersAsync(void* certificates, void* parameters, void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SerialNumber(uint32_t* __valueSize, uint8_t** value) noexcept = 0;
    virtual HRESULT __stdcall GetHashValue(uint32_t* __valueSize, uint8_t** value) noexcept = 0;
    virtual HRESULT __stdcall GetHashValueWithAlgorithm(HSTRING hashAlgorithmName, uint32_t* __valueSize, uint8_t** value) noexcept = 0;
    virtual HRESULT __stdcall GetCertificateBlob(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Subject(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Issuer(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_HasPrivateKey(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsStronglyProtected(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_ValidFrom(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual HRESULT __stdcall get_ValidTo(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual HRESULT __stdcall get_EnhancedKeyUsages(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_FriendlyName(HSTRING value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_IsSecurityDeviceBound(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyUsages(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyAlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SignatureAlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SignatureHashAlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SubjectAlternativeName(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificate3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IsPerUser(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_StoreName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyStorageProviderName(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateChain>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Validate(Windows::Security::Cryptography::Certificates::ChainValidationResult* status) noexcept = 0;
    virtual HRESULT __stdcall ValidateWithParameters(void* parameter, Windows::Security::Cryptography::Certificates::ChainValidationResult* status) noexcept = 0;
    virtual HRESULT __stdcall GetCertificates(bool includeRoot, void** certificates) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_UserCertificateEnrollmentManager(void** value) noexcept = 0;
    virtual HRESULT __stdcall ImportPfxDataToKspAsync(HSTRING pfxData, HSTRING password, Windows::Security::Cryptography::Certificates::ExportOption exportable, Windows::Security::Cryptography::Certificates::KeyProtectionLevel keyProtectionLevel, Windows::Security::Cryptography::Certificates::InstallOptions installOption, HSTRING friendlyName, HSTRING keyStorageProvider, void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall ImportPfxDataToKspWithParametersAsync(HSTRING pfxData, HSTRING password, void* pfxImportParameters, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateExtension>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ObjectId(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ObjectId(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_IsCritical(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsCritical(bool value) noexcept = 0;
    virtual HRESULT __stdcall EncodeValue(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_Value(uint32_t* __valueSize, uint8_t** value) noexcept = 0;
    virtual HRESULT __stdcall put_Value(uint32_t __valueSize, uint8_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateCertificate(void* certBlob, void** certificate) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateKeyUsages>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EncipherOnly(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_EncipherOnly(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_CrlSign(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_CrlSign(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyCertificateSign(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyCertificateSign(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyAgreement(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyAgreement(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_DataEncipherment(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_DataEncipherment(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyEncipherment(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyEncipherment(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_NonRepudiation(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_NonRepudiation(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_DigitalSignature(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_DigitalSignature(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateQuery>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EnhancedKeyUsages(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IssuerName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_IssuerName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_FriendlyName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_FriendlyName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_Thumbprint(uint32_t* __valueSize, uint8_t** value) noexcept = 0;
    virtual HRESULT __stdcall put_Thumbprint(uint32_t __valueSize, uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_HardwareOnly(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_HardwareOnly(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateQuery2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_IncludeDuplicates(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IncludeDuplicates(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_IncludeExpiredCertificates(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IncludeExpiredCertificates(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_StoreName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_StoreName(HSTRING value) noexcept = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateRequestProperties>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_KeyAlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyAlgorithmName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_KeySize(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeySize(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_FriendlyName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_FriendlyName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_HashAlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_HashAlgorithmName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_Exportable(Windows::Security::Cryptography::Certificates::ExportOption* value) noexcept = 0;
    virtual HRESULT __stdcall put_Exportable(Windows::Security::Cryptography::Certificates::ExportOption value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyUsages(Windows::Security::Cryptography::Certificates::EnrollKeyUsages* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyUsages(Windows::Security::Cryptography::Certificates::EnrollKeyUsages value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyStorageProviderName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyStorageProviderName(HSTRING value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateRequestProperties2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SmartcardReaderName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_SmartcardReaderName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_SigningCertificate(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_SigningCertificate(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_AttestationCredentialCertificate(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_AttestationCredentialCertificate(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateRequestProperties3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CurveName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_CurveName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_CurveParameters(uint32_t* __valueSize, uint8_t** value) noexcept = 0;
    virtual HRESULT __stdcall put_CurveParameters(uint32_t __valueSize, uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_ContainerNamePrefix(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ContainerNamePrefix(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_ContainerName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ContainerName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_UseExistingKey(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_UseExistingKey(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateRequestProperties4>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SuppressedDefaults(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SubjectAlternativeName(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Extensions(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateStore>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Add(void* certificate) noexcept = 0;
    virtual HRESULT __stdcall Delete(void* certificate) noexcept = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateStoresStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall FindAllWithQueryAsync(void* query, void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TrustedRootCertificationAuthorities(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IntermediateCertificationAuthorities(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetStoreByName(HSTRING storeName, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateStoresStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetUserStoreByName(HSTRING storeName, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::IChainBuildingParameters>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EnhancedKeyUsages(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ValidationTimestamp(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual HRESULT __stdcall put_ValidationTimestamp(Windows::Foundation::DateTime value) noexcept = 0;
    virtual HRESULT __stdcall get_RevocationCheckEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_RevocationCheckEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_NetworkRetrievalEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_NetworkRetrievalEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_AuthorityInformationAccessEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_AuthorityInformationAccessEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_CurrentTimeValidationEnabled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_CurrentTimeValidationEnabled(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_ExclusiveTrustRoots(void** certificates) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::IChainValidationParameters>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CertificateChainPolicy(Windows::Security::Cryptography::Certificates::CertificateChainPolicy* value) noexcept = 0;
    virtual HRESULT __stdcall put_CertificateChainPolicy(Windows::Security::Cryptography::Certificates::CertificateChainPolicy value) noexcept = 0;
    virtual HRESULT __stdcall get_ServerDnsName(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ServerDnsName(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICmsAttachedSignature>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Certificates(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Content(uint32_t* __valueSize, uint8_t** value) noexcept = 0;
    virtual HRESULT __stdcall get_Signers(void** value) noexcept = 0;
    virtual HRESULT __stdcall VerifySignature(Windows::Security::Cryptography::Certificates::SignatureValidationResult* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICmsAttachedSignatureFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateCmsAttachedSignature(void* inputBlob, void** cmsSignedData) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICmsAttachedSignatureStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GenerateSignatureAsync(void* data, void* signers, void* certificates, void** outputBlob) noexcept = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICmsDetachedSignature>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Certificates(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Signers(void** value) noexcept = 0;
    virtual HRESULT __stdcall VerifySignatureAsync(void* data, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ICmsDetachedSignatureFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateCmsDetachedSignature(void* inputBlob, void** cmsSignedData) noexcept = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICmsSignerInfo>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_HashAlgorithmName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_HashAlgorithmName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_TimestampInfo(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Rsa(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Dsa(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ecdh256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ecdh384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ecdh521(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ecdsa256(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ecdsa384(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ecdsa521(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::IKeyAlgorithmNamesStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Ecdsa(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Ecdh(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::IKeyAttestationHelperStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall DecryptTpmAttestationCredentialAsync(HSTRING credential, void** value) noexcept = 0;
    virtual HRESULT __stdcall GetTpmAttestationCredentialId(HSTRING credential, HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::IKeyAttestationHelperStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall DecryptTpmAttestationCredentialWithContainerNameAsync(HSTRING credential, HSTRING containerName, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::IKeyStorageProviderNamesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SoftwareKeyStorageProvider(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SmartcardKeyStorageProvider(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_PlatformKeyStorageProvider(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::IKeyStorageProviderNamesStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_PassportKeyStorageProvider(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::IPfxImportParameters>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel value) noexcept = 0;
    virtual HRESULT __stdcall get_InstallOptions(Windows::Security::Cryptography::Certificates::InstallOptions* value) noexcept = 0;
    virtual HRESULT __stdcall put_InstallOptions(Windows::Security::Cryptography::Certificates::InstallOptions value) noexcept = 0;
    virtual HRESULT __stdcall get_FriendlyName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_FriendlyName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_KeyStorageProviderName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_KeyStorageProviderName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_ContainerNamePrefix(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ContainerNamePrefix(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_ReaderName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_ReaderName(HSTRING value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Personal(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_TrustedRootCertificationAuthorities(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_IntermediateCertificationAuthorities(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ISubjectAlternativeNameInfo>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EmailName(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IPAddress(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Url(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DnsName(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DistinguishedName(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PrincipalName(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Security::Cryptography::Certificates::ISubjectAlternativeNameInfo2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EmailNames(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_IPAddresses(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Urls(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DnsNames(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DistinguishedNames(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_PrincipalNames(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Extension(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall RequestAddAsync(void* certificate, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestDeleteAsync(void* certificate, void** result) noexcept = 0;
    virtual HRESULT __stdcall get_Name(HSTRING* value) noexcept = 0;
};};
