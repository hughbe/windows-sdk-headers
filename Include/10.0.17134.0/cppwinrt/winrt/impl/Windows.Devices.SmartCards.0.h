...
{
    virtual HRESULT __stdcall get_SmartCard(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Reader(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetStatusAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAnswerToResetAsync(void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardAppletIdGroup>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_AppletIds(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SmartCardEmulationCategory(Windows::Devices::SmartCards::SmartCardEmulationCategory* value) noexcept = 0;
    virtual HRESULT __stdcall put_SmartCardEmulationCategory(Windows::Devices::SmartCards::SmartCardEmulationCategory value) noexcept = 0;
    virtual HRESULT __stdcall get_SmartCardEmulationType(Windows::Devices::SmartCards::SmartCardEmulationType* value) noexcept = 0;
    virtual HRESULT __stdcall put_SmartCardEmulationType(Windows::Devices::SmartCards::SmartCardEmulationType value) noexcept = 0;
    virtual HRESULT __stdcall get_AutomaticEnablement(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_AutomaticEnablement(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAppletIdGroupFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(HSTRING displayName, void* appletIds, Windows::Devices::SmartCards::SmartCardEmulationCategory emulationCategory, Windows::Devices::SmartCards::SmartCardEmulationType emulationType, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAppletIdGroupRegistration>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ActivationPolicy(Windows::Devices::SmartCards::SmartCardAppletIdGroupActivationPolicy* value) noexcept = 0;
    virtual HRESULT __stdcall get_AppletIdGroup(void** value) noexcept = 0;
    virtual HRESULT __stdcall RequestActivationPolicyChangeAsync(Windows::Devices::SmartCards::SmartCardAppletIdGroupActivationPolicy policy, void** result) noexcept = 0;
    virtual HRESULT __stdcall get_Id(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall SetAutomaticResponseApdusAsync(void* apdus, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAppletIdGroupStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_MaxAppletIds(uint16_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAutomaticResponseApdu>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CommandApdu(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_CommandApdu(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_CommandApduBitMask(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_CommandApduBitMask(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_ShouldMatchLength(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_ShouldMatchLength(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_AppletId(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_AppletId(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_ResponseApdu(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ResponseApdu(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAutomaticResponseApdu2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InputState(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_InputState(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_OutputState(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_OutputState(void* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAutomaticResponseApdu3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_AllowWhenCryptogramGeneratorNotPrepared(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_AllowWhenCryptogramGeneratorNotPrepared(bool value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAutomaticResponseApduFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(void* commandApdu, void* responseApdu, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardChallengeContext>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Challenge(void** value) noexcept = 0;
    virtual HRESULT __stdcall VerifyResponseAsync(void* response, void** result) noexcept = 0;
    virtual HRESULT __stdcall ProvisionAsync(void* response, bool formatCard, void** result) noexcept = 0;
    virtual HRESULT __stdcall ProvisionAsyncWithNewCardId(void* response, bool formatCard, GUID newCardId, void** result) noexcept = 0;
    virtual HRESULT __stdcall ChangeAdministrativeKeyAsync(void* response, void* newAdministrativeKey, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardConnect>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ConnectAsync(void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardConnection>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TransmitAsync(void* command, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramGenerator>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SupportedCryptogramMaterialTypes(void** result) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedCryptogramAlgorithms(void** result) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedCryptogramMaterialPackageFormats(void** result) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedCryptogramMaterialPackageConfirmationResponseFormats(void** result) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedSmartCardCryptogramStorageKeyCapabilities(void** result) noexcept = 0;
    virtual HRESULT __stdcall DeleteCryptogramMaterialStorageKeyAsync(HSTRING storageKeyName, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateCryptogramMaterialStorageKeyAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, HSTRING storageKeyName, Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyAlgorithm algorithm, Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities capabilities, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestCryptogramMaterialStorageKeyInfoAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, HSTRING storageKeyName, Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType format, void** result) noexcept = 0;
    virtual HRESULT __stdcall ImportCryptogramMaterialPackageAsync(Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageFormat format, HSTRING storageKeyName, HSTRING materialPackageName, void* cryptogramMaterialPackage, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryProvePossessionOfCryptogramMaterialPackageAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageConfirmationResponseFormat responseFormat, HSTRING materialPackageName, HSTRING materialName, void* challenge, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestUnlockCryptogramMaterialForUseAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, void** result) noexcept = 0;
    virtual HRESULT __stdcall DeleteCryptogramMaterialPackageAsync(HSTRING materialPackageName, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramGenerator2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ValidateRequestApduAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, void* apduToValidate, void* cryptogramPlacementSteps, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAllCryptogramStorageKeyCharacteristicsAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAllCryptogramMaterialPackageCharacteristicsAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAllCryptogramMaterialPackageCharacteristicsWithStorageKeyAsync(HSTRING storageKeyName, void** result) noexcept = 0;
    virtual HRESULT __stdcall GetAllCryptogramMaterialCharacteristicsAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, HSTRING materialPackageName, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramGeneratorStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetSmartCardCryptogramGeneratorAsync(void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_OperationStatus(Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_Characteristics(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_MaterialName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AllowedAlgorithms(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AllowedProofOfPossessionAlgorithms(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AllowedValidations(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_MaterialType(Windows::Devices::SmartCards::SmartCardCryptogramMaterialType* value) noexcept = 0;
    virtual HRESULT __stdcall get_ProtectionMethod(Windows::Devices::SmartCards::SmartCardCryptogramMaterialProtectionMethod* value) noexcept = 0;
    virtual HRESULT __stdcall get_ProtectionVersion(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_MaterialLength(int32_t* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_PackageName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_StorageKeyName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DateImported(Windows::Foundation::DateTime* value) noexcept = 0;
    virtual HRESULT __stdcall get_PackageFormat(Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageFormat* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramMaterialPossessionProof>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_OperationStatus(Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_Proof(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramPlacementStep>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Algorithm(Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm* value) noexcept = 0;
    virtual HRESULT __stdcall put_Algorithm(Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm value) noexcept = 0;
    virtual HRESULT __stdcall get_SourceData(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_SourceData(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_CryptogramMaterialPackageName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_CryptogramMaterialPackageName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_CryptogramMaterialName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall put_CryptogramMaterialName(HSTRING value) noexcept = 0;
    virtual HRESULT __stdcall get_TemplateOffset(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_TemplateOffset(int32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CryptogramOffset(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_CryptogramOffset(int32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CryptogramLength(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_CryptogramLength(int32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_CryptogramPlacementOptions(Windows::Devices::SmartCards::SmartCardCryptogramPlacementOptions* value) noexcept = 0;
    virtual HRESULT __stdcall put_CryptogramPlacementOptions(Windows::Devices::SmartCards::SmartCardCryptogramPlacementOptions value) noexcept = 0;
    virtual HRESULT __stdcall get_ChainedOutputStep(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_ChainedOutputStep(void* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyCharacteristics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Algorithm(Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyAlgorithm* value) noexcept = 0;
    virtual HRESULT __stdcall get_Capabilities(Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyInfo>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_OperationStatus(Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_PublicKeyBlobType(Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType* value) noexcept = 0;
    virtual HRESULT __stdcall get_PublicKey(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AttestationStatus(Windows::Devices::SmartCards::SmartCardCryptographicKeyAttestationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_Attestation(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AttestationCertificateChain(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Capabilities(Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyInfo2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_OperationalRequirements(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulator>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EnablementPolicy(Windows::Devices::SmartCards::SmartCardEmulatorEnablementPolicy* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulator2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_ApduReceived(void* value, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ApduReceived(event_token value) noexcept = 0;
    virtual HRESULT __stdcall add_ConnectionDeactivated(void* value, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ConnectionDeactivated(event_token value) noexcept = 0;
    virtual HRESULT __stdcall Start() noexcept = 0;
    virtual HRESULT __stdcall IsHostCardEmulationSupported(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulatorApduReceivedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_CommandApdu(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ConnectionProperties(void** value) noexcept = 0;
    virtual HRESULT __stdcall TryRespondAsync(void* responseApdu, void** result) noexcept = 0;
    virtual HRESULT __stdcall get_AutomaticResponseStatus(Windows::Devices::SmartCards::SmartCardAutomaticResponseStatus* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulatorApduReceivedEventArgs2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_State(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall TryRespondWithStateAsync(void* responseApdu, void* nextState, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall TryRespondWithCryptogramsAsync(void* responseTemplate, void* cryptogramPlacementSteps, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryRespondWithCryptogramsAndStateAsync(void* responseTemplate, void* cryptogramPlacementSteps, void* nextState, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulatorConnectionDeactivatedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_ConnectionProperties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Reason(Windows::Devices::SmartCards::SmartCardEmulatorConnectionDeactivatedReason* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulatorConnectionProperties>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Id(GUID* value) noexcept = 0;
    virtual HRESULT __stdcall get_Source(Windows::Devices::SmartCards::SmartCardEmulatorConnectionSource* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall GetAppletIdGroupRegistrationsAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall RegisterAppletIdGroupAsync(void* appletIdGroup, void** result) noexcept = 0;
    virtual HRESULT __stdcall UnregisterAppletIdGroupAsync(void* registration, void** result) noexcept = 0;
    virtual HRESULT __stdcall get_MaxAppletIdGroupRegistrations(uint16_t* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardPinPolicy>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_MinLength(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxLength(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_MaxLength(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_UppercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) noexcept = 0;
    virtual HRESULT __stdcall put_UppercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) noexcept = 0;
    virtual HRESULT __stdcall get_LowercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) noexcept = 0;
    virtual HRESULT __stdcall put_LowercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) noexcept = 0;
    virtual HRESULT __stdcall get_Digits(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) noexcept = 0;
    virtual HRESULT __stdcall put_Digits(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) noexcept = 0;
    virtual HRESULT __stdcall get_SpecialCharacters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) noexcept = 0;
    virtual HRESULT __stdcall put_SpecialCharacters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardPinResetRequest>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall SetResponse(void* response) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardProvisioning>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SmartCard(void** value) noexcept = 0;
    virtual HRESULT __stdcall GetIdAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall GetNameAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall GetChallengeContextAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestPinChangeAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestPinResetAsync(void* handler, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardProvisioning2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetAuthorityKeyContainerNameAsync(void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardProvisioningStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall FromSmartCardAsync(void* card, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestVirtualSmartCardCreationAsync(HSTRING friendlyName, void* administrativeKey, void* pinPolicy, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestVirtualSmartCardCreationAsyncWithCardId(HSTRING friendlyName, void* administrativeKey, void* pinPolicy, GUID cardId, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestVirtualSmartCardDeletionAsync(void* card, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardProvisioningStatics2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall RequestAttestedVirtualSmartCardCreationAsync(HSTRING friendlyName, void* administrativeKey, void* pinPolicy, void** result) noexcept = 0;
    virtual HRESULT __stdcall RequestAttestedVirtualSmartCardCreationAsyncWithCardId(HSTRING friendlyName, void* administrativeKey, void* pinPolicy, GUID cardId, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardReader>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::Devices::SmartCards::SmartCardReaderKind* value) noexcept = 0;
    virtual HRESULT __stdcall GetStatusAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall FindAllCardsAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall add_CardAdded(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_CardAdded(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_CardRemoved(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_CardRemoved(event_token token) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardReaderStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall GetDeviceSelectorWithKind(Windows::Devices::SmartCards::SmartCardReaderKind kind, HSTRING* selector) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_TriggerType(Windows::Devices::SmartCards::SmartCardTriggerType* value) noexcept = 0;
    virtual HRESULT __stdcall get_SourceAppletId(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TriggerData(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardTriggerDetails2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Emulator(void** value) noexcept = 0;
    virtual HRESULT __stdcall TryLaunchCurrentAppAsync(HSTRING arguments, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryLaunchCurrentAppWithBehaviorAsync(HSTRING arguments, Windows::Devices::SmartCards::SmartCardLaunchBehavior behavior, void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Invoke(void* sender, void* request) noexcept = 0;
};};
