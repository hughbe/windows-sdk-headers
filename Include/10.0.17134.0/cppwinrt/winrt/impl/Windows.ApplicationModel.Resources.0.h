...
{
    virtual HRESULT __stdcall GetString(HSTRING resource, HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoader2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetStringForUri(void* uri, HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoaderFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateResourceLoaderByName(HSTRING name, void** loader) noexcept = 0;
};};

template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoaderStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetStringForReference(void* uri, HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoaderStatics2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall GetForCurrentViewWithName(HSTRING name, void** loader) noexcept = 0;
    virtual HRESULT __stdcall GetForViewIndependentUse(void** loader) noexcept = 0;
    virtual HRESULT __stdcall GetForViewIndependentUseWithName(HSTRING name, void** loader) noexcept = 0;
};};
