...
template <> struct abi<Windows::Media::Playlists::IPlaylist>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall SaveAsAsync(void* saveLocation, HSTRING desiredName, Windows::Storage::NameCollisionOption option, void** operation) noexcept = 0;
    virtual HRESULT __stdcall SaveAsWithFormatAsync(void* saveLocation, HSTRING desiredName, Windows::Storage::NameCollisionOption option, Windows::Media::Playlists::PlaylistFormat playlistFormat, void** operation) noexcept = 0;
};};
