...
{
    virtual HRESULT __stdcall get_Type(Windows::Devices::Enumeration::Pnp::PnpObjectType* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall CreateFromIdAsync(Windows::Devices::Enumeration::Pnp::PnpObjectType type, HSTRING id, void* requestedProperties, void** asyncOp) noexcept = 0;
    virtual HRESULT __stdcall FindAllAsync(Windows::Devices::Enumeration::Pnp::PnpObjectType type, void* requestedProperties, void** asyncOp) noexcept = 0;
    virtual HRESULT __stdcall FindAllAsyncAqsFilter(Windows::Devices::Enumeration::Pnp::PnpObjectType type, void* requestedProperties, HSTRING aqsFilter, void** asyncOp) noexcept = 0;
    virtual HRESULT __stdcall CreateWatcher(Windows::Devices::Enumeration::Pnp::PnpObjectType type, void* requestedProperties, void** watcher) noexcept = 0;
    virtual HRESULT __stdcall CreateWatcherAqsFilter(Windows::Devices::Enumeration::Pnp::PnpObjectType type, void* requestedProperties, HSTRING aqsFilter, void** watcher) noexcept = 0;
};};
