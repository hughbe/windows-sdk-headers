...
template <> struct guid<Windows::Media::Audio::IAudioGraph3>{ static constexpr GUID value{ 0xDDCD25AE,0x1185,0x42A7,{ 0x83,0x1D,0x6A,0x9B,0x0F,0xC8,0x68,0x20 } }; };
...
template <> struct guid<Windows::Media::Audio::IAudioGraphSettings2>{ static constexpr GUID value{ 0x72919787,0x4DAB,0x46E3,{ 0xB4,0xC9,0xD8,0xE1,0xA2,0x63,0x60,0x62 } }; };
...
template <> struct guid<Windows::Media::Audio::IAudioStateMonitor>{ static constexpr GUID value{ 0x1D13D136,0x0199,0x4CDC,{ 0xB8,0x4E,0xE7,0x2C,0x2B,0x58,0x1E,0xCE } }; };
template <> struct guid<Windows::Media::Audio::IAudioStateMonitorStatics>{ static constexpr GUID value{ 0x6374EA4C,0x1B3B,0x4001,{ 0x94,0xD9,0xDD,0x22,0x53,0x30,0xFA,0x40 } }; };
...
template <> struct guid<Windows::Media::Audio::ICreateMediaSourceAudioInputNodeResult>{ static constexpr GUID value{ 0x46A658A3,0x53C0,0x4D59,{ 0x9E,0x51,0xCC,0x1D,0x10,0x44,0xA4,0xC4 } }; };
...
template <> struct guid<Windows::Media::Audio::IMediaSourceAudioInputNode>{ static constexpr GUID value{ 0x99D8983B,0xA88A,0x4041,{ 0x8E,0x4F,0xDD,0xBA,0xC0,0xC9,0x1F,0xD3 } }; };
...
{
    event_token SoundLevelChanged(Windows::Foundation::TypedEventHandler<Windows::Media::Audio::AudioStateMonitor, Windows::Foundation::IInspectable> const& handler) const;
    using SoundLevelChanged_revoker = event_revoker<Windows::Media::Audio::IAudioStateMonitor>;
...
struct consume_Windows_Media_Audio_IMediaSourceAudioInputNode
{
    ...
    event_token MediaSourceCompleted(Windows::Foundation::TypedEventHandler<Windows::Media::Audio::MediaSourceAudioInputNode, Windows::Foundation::IInspectable> const& handler) const;
    using MediaSourceCompleted_revoker = event_revoker<Windows::Media::Audio::IMediaSourceAudioInputNode>;
    ...
    void MediaSourceCompleted(event_token const& token) const;
};
...
{
    virtual HRESULT __stdcall put_PlaybackSpeedFactor(double value) noexcept = 0;
    virtual HRESULT __stdcall get_PlaybackSpeedFactor(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_Position(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall Seek(Windows::Foundation::TimeSpan position) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_LoopCount(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_LoopCount(void* value) noexcept = 0;
    ...
    virtual HRESULT __stdcall add_FileCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_FileCompleted(event_token token) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Audio::IAudioFileOutputNode>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_FileEncodingProfile(void** value) noexcept = 0;
    virtual HRESULT __stdcall FinalizeAsync(void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Audio::IAudioFrameInputNode>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_PlaybackSpeedFactor(double value) noexcept = 0;
    virtual HRESULT __stdcall get_PlaybackSpeedFactor(double* value) noexcept = 0;
    virtual HRESULT __stdcall AddFrame(void* frame) noexcept = 0;
    virtual HRESULT __stdcall DiscardQueuedFrames() noexcept = 0;
    virtual HRESULT __stdcall get_QueuedSampleCount(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall add_AudioFrameCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_AudioFrameCompleted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_QuantumStarted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_QuantumStarted(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioFrameOutputNode>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetFrame(void** audioFrame) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraph>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateFrameInputNode(void** frameInputNode) noexcept = 0;
    virtual HRESULT __stdcall CreateFrameInputNodeWithFormat(void* encodingProperties, void** frameInputNode) noexcept = 0;
    virtual HRESULT __stdcall CreateDeviceInputNodeAsync(Windows::Media::Capture::MediaCategory category, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateDeviceInputNodeWithFormatAsync(Windows::Media::Capture::MediaCategory category, void* encodingProperties, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateDeviceInputNodeWithFormatOnDeviceAsync(Windows::Media::Capture::MediaCategory category, void* encodingProperties, void* device, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFrameOutputNode(void** frameOutputNode) noexcept = 0;
    virtual HRESULT __stdcall CreateFrameOutputNodeWithFormat(void* encodingProperties, void** frameOutputNode) noexcept = 0;
    virtual HRESULT __stdcall CreateDeviceOutputNodeAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFileInputNodeAsync(void* file, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFileOutputNodeAsync(void* file, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFileOutputNodeWithFileProfileAsync(void* file, void* fileEncodingProfile, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateSubmixNode(void** submixNode) noexcept = 0;
    virtual HRESULT __stdcall CreateSubmixNodeWithFormat(void* encodingProperties, void** submixNode) noexcept = 0;
    virtual HRESULT __stdcall Start() noexcept = 0;
    virtual HRESULT __stdcall Stop() noexcept = 0;
    virtual HRESULT __stdcall ResetAllNodes() noexcept = 0;
    virtual HRESULT __stdcall add_QuantumStarted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_QuantumStarted(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_QuantumProcessed(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_QuantumProcessed(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_UnrecoverableErrorOccurred(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_UnrecoverableErrorOccurred(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_CompletedQuantumCount(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_EncodingProperties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_LatencyInSamples(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_PrimaryRenderDevice(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RenderDeviceAudioProcessing(Windows::Media::AudioProcessing* value) noexcept = 0;
    virtual HRESULT __stdcall get_SamplesPerQuantum(int32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraph2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateFrameInputNodeWithFormatAndEmitter(void* encodingProperties, void* emitter, void** frameInputNode) noexcept = 0;
    virtual HRESULT __stdcall CreateDeviceInputNodeWithFormatAndEmitterOnDeviceAsync(Windows::Media::Capture::MediaCategory category, void* encodingProperties, void* device, void* emitter, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateFileInputNodeWithEmitterAsync(void* file, void* emitter, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateSubmixNodeWithFormatAndEmitter(void* encodingProperties, void* emitter, void** submixNode) noexcept = 0;
    virtual HRESULT __stdcall CreateBatchUpdater(void** updater) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraph3>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateMediaSourceAudioInputNodeAsync(void* mediaSource, void** operation) noexcept = 0;
    virtual HRESULT __stdcall CreateMediaSourceAudioInputNodeWithEmitterAsync(void* mediaSource, void* emitter, void** operation) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraphConnection>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Destination(void** value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_EncodingProperties(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_EncodingProperties(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_PrimaryRenderDevice(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_PrimaryRenderDevice(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_QuantumSizeSelectionMode(Windows::Media::Audio::QuantumSizeSelectionMode* value) noexcept = 0;
    virtual HRESULT __stdcall put_QuantumSizeSelectionMode(Windows::Media::Audio::QuantumSizeSelectionMode value) noexcept = 0;
    virtual HRESULT __stdcall get_DesiredSamplesPerQuantum(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredSamplesPerQuantum(int32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_AudioRenderCategory(Windows::Media::Render::AudioRenderCategory* value) noexcept = 0;
    virtual HRESULT __stdcall put_AudioRenderCategory(Windows::Media::Render::AudioRenderCategory value) noexcept = 0;
    virtual HRESULT __stdcall get_DesiredRenderDeviceAudioProcessing(Windows::Media::AudioProcessing* value) noexcept = 0;
    virtual HRESULT __stdcall put_DesiredRenderDeviceAudioProcessing(Windows::Media::AudioProcessing value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraphSettings2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_MaxPlaybackSpeedFactor(double value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxPlaybackSpeedFactor(double* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraphSettingsFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(Windows::Media::Render::AudioRenderCategory audioRenderCategory, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraphStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateAsync(void* settings, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioGraphUnrecoverableErrorOccurredEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Error(Windows::Media::Audio::AudioGraphUnrecoverableError* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioInputNode>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_OutgoingConnections(void** value) noexcept = 0;
    virtual HRESULT __stdcall AddOutgoingConnection(void* destination) noexcept = 0;
    virtual HRESULT __stdcall AddOutgoingConnectionWithGain(void* destination, double gain) noexcept = 0;
    virtual HRESULT __stdcall RemoveOutgoingConnection(void* destination) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioInputNode2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Emitter(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNode>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_EffectDefinitions(void** value) noexcept = 0;
    virtual HRESULT __stdcall put_OutgoingGain(double value) noexcept = 0;
    virtual HRESULT __stdcall get_OutgoingGain(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_EncodingProperties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_ConsumeInput(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_ConsumeInput(bool value) noexcept = 0;
    virtual HRESULT __stdcall Start() noexcept = 0;
    virtual HRESULT __stdcall Stop() noexcept = 0;
    virtual HRESULT __stdcall Reset() noexcept = 0;
    virtual HRESULT __stdcall DisableEffectsByDefinition(void* definition) noexcept = 0;
    virtual HRESULT __stdcall EnableEffectsByDefinition(void* definition) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitter>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Position(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall put_Position(Windows::Foundation::Numerics::float3 value) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_Shape(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_DecayModel(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_Gain(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Gain(double value) noexcept = 0;
    virtual HRESULT __stdcall get_DistanceScale(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_DistanceScale(double value) noexcept = 0;
    virtual HRESULT __stdcall get_DopplerScale(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_DopplerScale(double value) noexcept = 0;
    virtual HRESULT __stdcall get_DopplerVelocity(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall put_DopplerVelocity(Windows::Foundation::Numerics::float3 value) noexcept = 0;
    virtual HRESULT __stdcall get_IsDopplerDisabled(bool* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitter2>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_SpatialAudioModel(Windows::Media::Audio::SpatialAudioModel* value) noexcept = 0;
    virtual HRESULT __stdcall put_SpatialAudioModel(Windows::Media::Audio::SpatialAudioModel value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitterConeProperties>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_InnerAngle(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_OuterAngle(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_OuterAngleGain(double* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitterDecayModel>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Kind(Windows::Media::Audio::AudioNodeEmitterDecayKind* value) noexcept = 0;
    virtual HRESULT __stdcall get_MinGain(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxGain(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_NaturalProperties(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitterDecayModelStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateNatural(double minGain, double maxGain, double unityGainDistance, double cutoffDistance, void** decayModel) noexcept = 0;
    virtual HRESULT __stdcall CreateCustom(double minGain, double maxGain, void** decayModel) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitterFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateAudioNodeEmitter(void* shape, void* decayModel, Windows::Media::Audio::AudioNodeEmitterSettings settings, void** emitter) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitterNaturalDecayModelProperties>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_UnityGainDistance(double* value) noexcept = 0;
    virtual HRESULT __stdcall get_CutoffDistance(double* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitterShape>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Kind(Windows::Media::Audio::AudioNodeEmitterShapeKind* value) noexcept = 0;
    virtual HRESULT __stdcall get_ConeProperties(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioNodeEmitterShapeStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreateCone(double innerAngle, double outerAngle, double outerAngleGain, void** shape) noexcept = 0;
    virtual HRESULT __stdcall CreateOmnidirectional(void** shape) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Audio::IAudioNodeListener>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_SpeedOfSound(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_SpeedOfSound(double value) noexcept = 0;
    virtual HRESULT __stdcall get_DopplerVelocity(Windows::Foundation::Numerics::float3* value) noexcept = 0;
    virtual HRESULT __stdcall put_DopplerVelocity(Windows::Foundation::Numerics::float3 value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall put_Listener(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Listener(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IAudioStateMonitor>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_SoundLevelChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SoundLevelChanged(event_token token) noexcept = 0;
...
{
    virtual HRESULT __stdcall CreateForRenderMonitoring(void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateForRenderMonitoringWithCategory(Windows::Media::Render::AudioRenderCategory category, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateForRenderMonitoringWithCategoryAndDeviceRole(Windows::Media::Render::AudioRenderCategory category, Windows::Media::Devices::AudioDeviceRole role, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateForRenderMonitoringWithCategoryAndDeviceId(Windows::Media::Render::AudioRenderCategory category, HSTRING deviceId, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateForCaptureMonitoring(void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateForCaptureMonitoringWithCategory(Windows::Media::Capture::MediaCategory category, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateForCaptureMonitoringWithCategoryAndDeviceRole(Windows::Media::Capture::MediaCategory category, Windows::Media::Devices::AudioDeviceRole role, void** result) noexcept = 0;
    virtual HRESULT __stdcall CreateForCaptureMonitoringWithCategoryAndDeviceId(Windows::Media::Capture::MediaCategory category, HSTRING deviceId, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::ICreateAudioDeviceInputNodeResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Audio::AudioDeviceNodeCreationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceInputNode(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::ICreateAudioDeviceOutputNodeResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Audio::AudioDeviceNodeCreationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceOutputNode(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::ICreateAudioFileInputNodeResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Audio::AudioFileNodeCreationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_FileInputNode(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::ICreateAudioFileOutputNodeResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Audio::AudioFileNodeCreationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_FileOutputNode(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::ICreateAudioGraphResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Audio::AudioGraphCreationStatus* value) noexcept = 0;
    virtual HRESULT __stdcall get_Graph(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::ICreateMediaSourceAudioInputNodeResult>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Audio::MediaSourceAudioInputNodeCreationStatus* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall put_WetDryMix(double value) noexcept = 0;
    virtual HRESULT __stdcall get_WetDryMix(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Feedback(double value) noexcept = 0;
    virtual HRESULT __stdcall get_Feedback(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Delay(double value) noexcept = 0;
    virtual HRESULT __stdcall get_Delay(double* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IEchoEffectDefinitionFactory>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(void* audioGraph, void** value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::IEqualizerBand>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_Bandwidth(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Bandwidth(double value) noexcept = 0;
    virtual HRESULT __stdcall get_FrequencyCenter(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_FrequencyCenter(double value) noexcept = 0;
    virtual HRESULT __stdcall get_Gain(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Gain(double value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Bands(void** value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_RequiredSamples(int32_t* value) noexcept = 0;
};};

template <> struct abi<Windows::Media::Audio::ILimiterEffectDefinition>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_Release(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_Release(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_Loudness(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_Loudness(uint32_t* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Audio::IMediaSourceAudioInputNode>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall put_LoopCount(void* value) noexcept = 0;
    virtual HRESULT __stdcall get_Duration(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall get_MediaSource(void** value) noexcept = 0;
    virtual HRESULT __stdcall add_MediaSourceCompleted(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_MediaSourceCompleted(event_token token) noexcept = 0;
};};
...
template <> struct abi<Windows::Media::Audio::IReverbEffectDefinition>{ struct type : IInspectable
{
    virtual HRESULT __stdcall put_WetDryMix(double value) noexcept = 0;
    virtual HRESULT __stdcall get_WetDryMix(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_ReflectionsDelay(uint32_t value) noexcept = 0;
    virtual HRESULT __stdcall get_ReflectionsDelay(uint32_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_ReverbDelay(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_ReverbDelay(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_RearDelay(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_RearDelay(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionLeft(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionLeft(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionRight(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionRight(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionMatrixLeft(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionMatrixLeft(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_PositionMatrixRight(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_PositionMatrixRight(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_EarlyDiffusion(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_EarlyDiffusion(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_LateDiffusion(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_LateDiffusion(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_LowEQGain(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_LowEQGain(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_LowEQCutoff(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_LowEQCutoff(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_HighEQGain(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_HighEQGain(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_HighEQCutoff(uint8_t value) noexcept = 0;
    virtual HRESULT __stdcall get_HighEQCutoff(uint8_t* value) noexcept = 0;
    virtual HRESULT __stdcall put_RoomFilterFreq(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RoomFilterFreq(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RoomFilterMain(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RoomFilterMain(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RoomFilterHF(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RoomFilterHF(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_ReflectionsGain(double value) noexcept = 0;
    virtual HRESULT __stdcall get_ReflectionsGain(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_ReverbGain(double value) noexcept = 0;
    virtual HRESULT __stdcall get_ReverbGain(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_DecayTime(double value) noexcept = 0;
    virtual HRESULT __stdcall get_DecayTime(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_Density(double value) noexcept = 0;
    virtual HRESULT __stdcall get_Density(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_RoomSize(double value) noexcept = 0;
    virtual HRESULT __stdcall get_RoomSize(double* value) noexcept = 0;
    virtual HRESULT __stdcall put_DisableLateField(bool value) noexcept = 0;
    virtual HRESULT __stdcall get_DisableLateField(bool* value) noexcept = 0;
};};
