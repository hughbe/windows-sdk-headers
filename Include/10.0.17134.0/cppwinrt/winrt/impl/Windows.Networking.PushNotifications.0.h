...
template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationChannel>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_PushNotificationReceived(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_PushNotificationReceived(event_token token) noexcept = 0;
};};

template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CreatePushNotificationChannelForApplicationAsync(void** operation) noexcept = 0;
    virtual HRESULT __stdcall CreatePushNotificationChannelForApplicationAsyncWithId(HSTRING applicationId, void** operation) noexcept = 0;
    virtual HRESULT __stdcall CreatePushNotificationChannelForSecondaryTileAsync(HSTRING tileId, void** operation) noexcept = 0;
...
{
    virtual HRESULT __stdcall CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsync(void* appServerKey, HSTRING channelId, void** operation) noexcept = 0;
    virtual HRESULT __stdcall CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsyncWithId(void* appServerKey, HSTRING channelId, HSTRING appId, void** operation) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationReceivedEventArgs>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_NotificationType(Windows::Networking::PushNotifications::PushNotificationType* value) noexcept = 0;
    virtual HRESULT __stdcall get_ToastNotification(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_TileNotification(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_BadgeNotification(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_RawNotification(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Networking::PushNotifications::IRawNotification2>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_ChannelId(HSTRING* value) noexcept = 0;
};};
