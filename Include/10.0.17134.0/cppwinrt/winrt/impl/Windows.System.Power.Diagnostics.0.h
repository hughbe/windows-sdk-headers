...
{
    [[deprecated("Background Energy Diagnostics has been deprecated. For more info, see MSDN.")]] double DeviceSpecificConversionFactor() const;
    [[deprecated("Background Energy Diagnostics has been deprecated. For more info, see MSDN.")]] uint64_t ComputeTotalEnergyUsage() const;
    [[deprecated("Background Energy Diagnostics has been deprecated. For more info, see MSDN.")]] void ResetTotalEnergyUsage() const;
};
...
{
    virtual HRESULT __stdcall get_DeviceSpecificConversionFactor(double* value) noexcept = 0;
    virtual HRESULT __stdcall ComputeTotalEnergyUsage(uint64_t* value) noexcept = 0;
    virtual HRESULT __stdcall ResetTotalEnergyUsage() noexcept = 0;
};};
