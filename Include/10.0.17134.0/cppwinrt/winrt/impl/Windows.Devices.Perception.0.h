...
{
    virtual HRESULT __stdcall get_FocalLength(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_PrincipalPoint(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_RadialDistortion(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_TangentialDistortion(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_Exposure(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AutoExposureEnabled(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExposureCompensation(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_MinDepth(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_MaxDepth(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Perception::IKnownPerceptionFrameSourcePropertiesStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_PhysicalDeviceIds(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_FrameKind(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceModelVersion(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_EnclosureLocation(HSTRING* value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Perception::IKnownPerceptionInfraredFrameSourcePropertiesStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_AutoExposureEnabled(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ExposureCompensation(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_ActiveIlluminationEnabled(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AmbientSubtractionEnabled(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_StructureLightPatternEnabled(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_InterleavedIlluminationEnabled(HSTRING* value) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_VideoProfile(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedVideoProfiles(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_AvailableVideoProfiles(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsMirrored(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_CameraIntrinsics(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Perception::IKnownPerceptionVideoProfilePropertiesStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_BitmapPixelFormat(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_BitmapAlphaMode(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Width(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Height(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_FrameDuration(HSTRING* value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Perception::IPerceptionColorFrame>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_VideoFrame(void** value) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Perception::IPerceptionColorFrameArrivedEventArgs>{ struct type : IInspectable
{
    virtual HRESULT __stdcall get_RelativeTime(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall TryOpenFrame(void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Perception::IPerceptionColorFrameReader>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsPaused(bool* value) noexcept = 0;
    virtual HRESULT __stdcall put_IsPaused(bool value) noexcept = 0;
    virtual HRESULT __stdcall TryReadLatestFrame(void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Perception::IPerceptionColorFrameSource>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_AvailableChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_AvailableChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_ActiveChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ActiveChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_PropertiesChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_PropertiesChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_VideoProfileChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_VideoProfileChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_CameraIntrinsicsChanged(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_CameraIntrinsicsChanged(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_Id(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DisplayName(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_DeviceKind(HSTRING* value) noexcept = 0;
    virtual HRESULT __stdcall get_Available(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_Active(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_IsControlled(bool* value) noexcept = 0;
    virtual HRESULT __stdcall get_Properties(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_SupportedVideoProfiles(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_AvailableVideoProfiles(void** value) noexcept = 0;
    ...
    virtual HRESULT __stdcall AcquireControlSession(void** value) noexcept = 0;
    virtual HRESULT __stdcall CanControlIndependentlyFrom(HSTRING targetId, bool* result) noexcept = 0;
    virtual HRESULT __stdcall IsCorrelatedWith(HSTRING targetId, bool* result) noexcept = 0;
    virtual HRESULT __stdcall TryGetTransformTo(HSTRING targetId, Windows::Foundation::Numerics::float4x4* result, bool* hasResult) noexcept = 0;
    virtual HRESULT __stdcall TryGetDepthCorrelatedCameraIntrinsicsAsync(void* correlatedDepthFrameSource, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryGetDepthCorrelatedCoordinateMapperAsync(HSTRING targetSourceId, void* correlatedDepthFrameSource, void** result) noexcept = 0;
    virtual HRESULT __stdcall TrySetVideoProfileAsync(void* controlSession, void* profile, void** result) noexcept = 0;
    virtual HRESULT __stdcall OpenReader(void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_FrameSource(void** value) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Perception::IPerceptionColorFrameSourceStatics>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall FindAllAsync(void** result) noexcept = 0;
    virtual HRESULT __stdcall FromIdAsync(HSTRING id, void** result) noexcept = 0;
...
{
    virtual HRESULT __stdcall add_SourceAdded(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SourceAdded(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_SourceRemoved(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_SourceRemoved(event_token token) noexcept = 0;
    ...
    virtual HRESULT __stdcall get_Status(Windows::Devices::Enumeration::DeviceWatcherStatus* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall add_ControlLost(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_ControlLost(event_token token) noexcept = 0;
    virtual HRESULT __stdcall TrySetPropertyAsync(HSTRING name, void* value, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Perception::IPerceptionDepthCorrelatedCameraIntrinsics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall UnprojectPixelAtCorrelatedDepth(Windows::Foundation::Point pixelCoordinate, void* depthFrame, Windows::Foundation::Numerics::float3* result) noexcept = 0;
    virtual HRESULT __stdcall UnprojectPixelsAtCorrelatedDepth(uint32_t __sourceCoordinatesSize, Windows::Foundation::Point* sourceCoordinates, void* depthFrame, uint32_t __resultsSize, Windows::Foundation::Numerics::float3* results) noexcept = 0;
    virtual HRESULT __stdcall UnprojectRegionPixelsAtCorrelatedDepthAsync(Windows::Foundation::Rect region, void* depthFrame, uint32_t __resultsSize, Windows::Foundation::Numerics::float3* results, void** result) noexcept = 0;
    virtual HRESULT __stdcall UnprojectAllPixelsAtCorrelatedDepthAsync(void* depthFrame, uint32_t __resultsSize, Windows::Foundation::Numerics::float3* results, void** result) noexcept = 0;
};};

template <> struct abi<Windows::Devices::Perception::IPerceptionDepthCorrelatedCoordinateMapper>{ struct type : IInspectable
{
    virtual HRESULT __stdcall MapPixelToTarget(Windows::Foundation::Point sourcePixelCoordinate, void* depthFrame, Windows::Foundation::Point* result) noexcept = 0;
    virtual HRESULT __stdcall MapPixelsToTarget(uint32_t __sourceCoordinatesSize, Windows::Foundation::Point* sourceCoordinates, void* depthFrame, uint32_t __resultsSize, Windows::Foundation::Point* results) noexcept = 0;
    virtual HRESULT __stdcall MapRegionOfPixelsToTargetAsync(Windows::Foundation::Rect region, void* depthFrame, uint32_t __targetCoordinatesSize, Windows::Foundation::Point* targetCoordinates, void** result) noexcept = 0;
    virtual HRESULT __stdcall MapAllPixelsToTargetAsync(void* depthFrame, uint32_t __targetCoordinatesSize, Windows::Foundation::Point* targetCoordinates, void** result) noexcept = 0;
};};
...
template <> struct abi<Windows::Devices::Perception::IPerceptionDepthFrameSource>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall get_VideoProfile(void** value) noexcept = 0;
    virtual HRESULT __stdcall get_CameraIntrinsics(void** value) noexcept = 0;
    virtual HRESULT __stdcall AcquireControlSession(void** result) noexcept = 0;
    virtual HRESULT __stdcall CanControlIndependentlyFrom(HSTRING targetId, bool* result) noexcept = 0;
    virtual HRESULT __stdcall IsCorrelatedWith(HSTRING targetId, bool* result) noexcept = 0;
    virtual HRESULT __stdcall TryGetTransformTo(HSTRING targetId, Windows::Foundation::Numerics::float4x4* result, bool* hasResult) noexcept = 0;
    virtual HRESULT __stdcall TryGetDepthCorrelatedCameraIntrinsicsAsync(void* target, void** result) noexcept = 0;
    virtual HRESULT __stdcall TryGetDepthCorrelatedCoordinateMapperAsync(HSTRING targetId, void* depthFrameSourceToMapWith, void** result) noexcept = 0;
    virtual HRESULT __stdcall TrySetVideoProfileAsync(void* controlSession, void* profile, void** result) noexcept = 0;
    virtual HRESULT __stdcall OpenReader(void** result) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall get_CollectionChange(Windows::Foundation::Collections::CollectionChange* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Devices::Perception::PerceptionFrameSourcePropertyChangeStatus* value) noexcept = 0;
...
{
    virtual HRESULT __stdcall get_BitmapPixelFormat(Windows::Graphics::Imaging::BitmapPixelFormat* value) noexcept = 0;
    virtual HRESULT __stdcall get_BitmapAlphaMode(Windows::Graphics::Imaging::BitmapAlphaMode* value) noexcept = 0;
    virtual HRESULT __stdcall get_Width(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_Height(int32_t* value) noexcept = 0;
    virtual HRESULT __stdcall get_FrameDuration(Windows::Foundation::TimeSpan* value) noexcept = 0;
    virtual HRESULT __stdcall IsEqual(void* other, bool* result) noexcept = 0;
};};
