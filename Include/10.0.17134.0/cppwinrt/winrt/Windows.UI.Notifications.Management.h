...
struct produce<D, Windows::UI::Notifications::Management::IUserNotificationListener> : produce_base<D, Windows::UI::Notifications::Management::IUserNotificationListener>
{
    HRESULT __stdcall RequestAccessAsync(void** result) noexcept final
    {
        try
        {
            ...
            *result = detach_from<Windows::Foundation::IAsyncOperation<Windows::UI::Notifications::Management::UserNotificationListenerAccessStatus>>(this->shim().RequestAccessAsync());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall GetAccessStatus(Windows::UI::Notifications::Management::UserNotificationListenerAccessStatus* accessStatus) noexcept final
    {
        ...
        {
            typename D::abi_guard guard(this->shim());
            *accessStatus = detach_from<Windows::UI::Notifications::Management::UserNotificationListenerAccessStatus>(this->shim().GetAccessStatus());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall add_NotificationChanged(void* handler, event_token* token) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
            *token = detach_from<event_token>(this->shim().NotificationChanged(*reinterpret_cast<Windows::Foundation::TypedEventHandler<Windows::UI::Notifications::Management::UserNotificationListener, Windows::UI::Notifications::UserNotificationChangedEventArgs> const*>(&handler)));
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall GetNotificationsAsync(Windows::UI::Notifications::NotificationKinds kinds, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::UserNotification>>>(this->shim().GetNotificationsAsync(*reinterpret_cast<Windows::UI::Notifications::NotificationKinds const*>(&kinds)));
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall GetNotification(uint32_t notificationId, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
...
{
    HRESULT __stdcall get_Current(void** result) noexcept final
    {
        try
        {
            *result = nullptr;
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::UI::Notifications::Management::UserNotificationListener>(this->shim().Current());
            return S_OK;
        }
        catch (...)
        {
