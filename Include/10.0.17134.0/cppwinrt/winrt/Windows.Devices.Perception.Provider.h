...
template <> struct delegate<Windows::Devices::Perception::Provider::PerceptionStartFaceAuthenticationHandler>
{
    ...
    struct type : implements_delegate<Windows::Devices::Perception::Provider::PerceptionStartFaceAuthenticationHandler, H>
    {
        ...
        HRESULT __stdcall Invoke(void* sender, bool* result) noexcept final
        {
            try
            {
...
{
    HRESULT __stdcall get_FrameProviderIds(void** value) noexcept final
    {
        try
        {
            *value = nullptr;
...
{
    HRESULT __stdcall Create(void* ids, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
...
{
    HRESULT __stdcall Create(HSTRING targetId, Windows::Foundation::Numerics::float3 position, Windows::Foundation::Numerics::quaternion orientation, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
...
{
    HRESULT __stdcall get_RelativeLocations(void** value) noexcept final
    {
        try
        {
            *value = nullptr;
...
{
    HRESULT __stdcall Create(void* relativeLocations, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
...
{
    HRESULT __stdcall Create(void* ids, void* startHandler, void* stopHandler, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
...
struct produce<D, Windows::Devices::Perception::Provider::IPerceptionFrame> : produce_base<D, Windows::Devices::Perception::Provider::IPerceptionFrame>
{
    ...
    HRESULT __stdcall get_FrameData(void** value) noexcept final
    {
        try
        {
            *value = nullptr;
...
{
    HRESULT __stdcall get_FrameProviderInfo(void** result) noexcept final
    {
        try
        {
            *result = nullptr;
    ...
    HRESULT __stdcall SetProperty(void* value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
{
    HRESULT __stdcall GetFrameProvider(void* frameProviderInfo, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
...
{
    HRESULT __stdcall RegisterFrameProviderInfo(void* manager, void* frameProviderInfo) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall UnregisterFrameProviderInfo(void* manager, void* frameProviderInfo) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall RegisterFaceAuthenticationGroup(void* manager, void* faceAuthenticationGroup) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall UnregisterFaceAuthenticationGroup(void* manager, void* faceAuthenticationGroup) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall RegisterControlGroup(void* manager, void* controlGroup) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall UnregisterControlGroup(void* manager, void* controlGroup) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall RegisterCorrelationGroup(void* manager, void* correlationGroup) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall UnregisterCorrelationGroup(void* manager, void* correlationGroup) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall UpdateAvailabilityForProvider(void* provider, bool available) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall PublishFrameForProvider(void* provider, void* frame) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
{
    HRESULT __stdcall AllocateFrame(void** value) noexcept final
    {
        try
        {
            *value = nullptr;
    ...
    HRESULT __stdcall CopyFromVideoFrame(void* frame, void** value) noexcept final
    {
        try
        {
            *value = nullptr;
...
{
    HRESULT __stdcall Create(uint32_t maxOutstandingFrameCountForWrite, Windows::Graphics::Imaging::BitmapPixelFormat format, Windows::Foundation::Size resolution, Windows::Graphics::Imaging::BitmapAlphaMode alpha, void** result) noexcept final
    {
        try
        {
            *result = nullptr;
...
inline PerceptionFrameProviderInfo::PerceptionFrameProviderInfo() :
    PerceptionFrameProviderInfo(get_activation_factory<PerceptionFrameProviderInfo>().ActivateInstance<PerceptionFrameProviderInfo>())
{}
